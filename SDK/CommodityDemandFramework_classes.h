...
struct ACommodityDemandService : AActor {
	...
	void OnRep_ActiveCommodityDemands(); // Function CommodityDemandFramework.CommodityDemandService.OnRep_ActiveCommodityDemands // Final|RequiredAPI|Native|Private // @ game+0x428cb70
};
