...
struct ABP_HarpoonLauncher_C : AHarpoonLauncher {
	...
	void UserConstructionScript(); // Function BP_HarpoonLauncher.BP_HarpoonLauncher_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
