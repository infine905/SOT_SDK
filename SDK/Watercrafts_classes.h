...
struct AFakeShip : AActor {
	...
	void OnAttachedItemEndPlay(struct AActor* Actor); // Function Watercrafts.FakeShip.OnAttachedItemEndPlay // Final|Native|Private // @ game+0x40bfe00
};
...
struct UItemProxyWatercraftTrackerComponent : UActorComponent {
	...
	void OnRep_CurrentWatercraft(struct AActor* PreviousWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnRep_CurrentWatercraft // Final|Native|Private // @ game+0x40bff00
	void OnCurrentWatercraftDestroyed(struct AActor* DestroyedWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnCurrentWatercraftDestroyed // Final|Native|Private // @ game+0x40bfe80
};
...
struct AWatercraft : AActor {
	...
	void OnRigidBodyWake(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodyWake // Final|Native|Protected // @ game+0x40c0120
	void OnRigidBodySleep(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodySleep // Final|Native|Protected // @ game+0x40c00a0
};

// Class Watercrafts.Rowboat
// Size: 0xab8 (Inherited: 0x730)
struct ARowboat : AWatercraft {
	...
	struct FCollisionProfileName OverrideMountedCollisionProfileName; // 0x7d4(0x08)
	char UnknownData_7DC[0x4]; // 0x7dc(0x04)
	struct UTetherCustomisationComponent* TetherCustomisationComponent; // 0x7e0(0x08)
	struct UHealthComponent* HealthComponent; // 0x7e8(0x08)
	struct UActorDamageableComponent* ActorDamageableComponent; // 0x7f0(0x08)
	struct URammableComponent* RammableComponent; // 0x7f8(0x08)
	struct UScrapeableComponent* ScrapeableComponent; // 0x800(0x08)
	struct URowboatAudioComponent* RowboatAudio; // 0x808(0x08)
	struct UBaseHullDragDynamicsDesc* HullDragDynamicsDesc; // 0x810(0x08)
	struct UBowSplashContainer* OarSplashContainer; // 0x818(0x08)
	struct UMountableComponent* MountableComponent; // 0x820(0x08)
	struct UActorActivationComponent* ActorActivationComponent; // 0x828(0x08)
	struct UCurveFloat* LinearDampingOverTimeWhileBeachedScalarCurve; // 0x830(0x08)
	struct UCurveFloat* AngularDampingOverTimeWhileBeachedScalarCurve; // 0x838(0x08)
	struct FRowboatDamageEffectData DamageEffectData; // 0x840(0x18)
	struct FRowboatStrainDamageData StrainDamageData; // 0x858(0x20)
	struct TArray<struct UChildActorComponent*> AlwaysEnabledInteractables; // 0x878(0x10)
	struct UShroudBreakerTrackerComponent* ShroudBreakerTrackerComponent; // 0x888(0x08)
	bool IsBeingLaunched; // 0x890(0x01)
	bool IsSinking; // 0x891(0x01)
	char UnknownData_892[0x2]; // 0x892(0x02)
	float MaxPushingAngle; // 0x894(0x04)
	float CurrentStrainAmount; // 0x898(0x04)
	bool IsDocked; // 0x89c(0x01)
	char UnknownData_89D[0x1]; // 0x89d(0x01)
	char CoverCollisionChannel; // 0x89e(0x01)
	char UnknownData_89F[0x1]; // 0x89f(0x01)
	float UnderCoverCheckInterval; // 0x8a0(0x04)
	float UnderCoverHeight; // 0x8a4(0x04)
	struct TArray<struct FVector> RelativeUnderCoverProbeRoots; // 0x8a8(0x10)
	char TrackedActorType; // 0x8b8(0x01)
	char UnknownData_8B9[0x3]; // 0x8b9(0x03)
	float LightDamagedRepairTime; // 0x8bc(0x04)
	float ModerateDamagedRepairTime; // 0x8c0(0x04)
	float HeavyDamagedRepairTime; // 0x8c4(0x04)
	float LightDamagedHealthThreshold; // 0x8c8(0x04)
	float ModerateDamagedHealthThreshold; // 0x8cc(0x04)
	float HeavyDamagedHealthThreshold; // 0x8d0(0x04)
	struct FName PremountCollisionProfileName; // 0x8d4(0x08)
	char UnknownData_8DC[0x1dc]; // 0x8dc(0x1dc)

	void SetAlwaysEnabledInteractables(struct TArray<struct UChildActorComponent*> InAlwaysEnabledInteractables); // Function Watercrafts.Rowboat.SetAlwaysEnabledInteractables // Final|Native|Protected|HasOutParms|BlueprintCallable // @ game+0x40c0430
	void ReactToRepairableStateChanged(char InNewState, char InPreviousState, struct URepairableComponent* InRepairableComponent); // Function Watercrafts.Rowboat.ReactToRepairableStateChanged // Final|Native|Protected // @ game+0x40c0220
	void OnRep_IsSinking(); // Function Watercrafts.Rowboat.OnRep_IsSinking // Final|Native|Private // @ game+0x40bff80
};
...
struct UTaleQuestWatercraftFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct AWatercraft* GetFirstSpawnedWatercraft(); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.GetFirstSpawnedWatercraft // Final|Native|Public // @ game+0x40bfdd0
	void FilterPointsByDistanceFromWatercraft(float MinDistance, struct TArray<struct FOrientedPoint> Points); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.FilterPointsByDistanceFromWatercraft // Final|Native|Public|HasOutParms|Const // @ game+0x40bfcd0
};
...
struct UWatercraftBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AWatercraft* SpawnWatercraft(struct UObject* WorldContextObject, struct UClass* WatercraftClass, struct FVector Location, struct FRotator Rotation); // Function Watercrafts.WatercraftBlueprintFunctionLibrary.SpawnWatercraft // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x40c04e0
};
...
struct UWatercraftTrackerComponent : UActorComponent {
	...
	void OnWatercraftDestroyed(struct AActor* WatercraftActor); // Function Watercrafts.WatercraftTrackerComponent.OnWatercraftDestroyed // Final|Native|Private // @ game+0x40c01a0
};
