...
struct ABP_Placement_Garden_C : AActor {
	...
	void Set Garden Parameters(float Radius, int32_t Int, bool Instances Created); // Function BP_Placement_Garden.BP_Placement_Garden_C.Set Garden Parameters // Public|HasOutParms|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void Create Garden(); // Function BP_Placement_Garden.BP_Placement_Garden_C.Create Garden // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void Initialise Instances(); // Function BP_Placement_Garden.BP_Placement_Garden_C.Initialise Instances // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void UserConstructionScript(); // Function BP_Placement_Garden.BP_Placement_Garden_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void Force Create Garden(); // Function BP_Placement_Garden.BP_Placement_Garden_C.Force Create Garden // BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void ExecuteUbergraph_BP_Placement_Garden(int32_t EntryPoint); // Function BP_Placement_Garden.BP_Placement_Garden_C.ExecuteUbergraph_BP_Placement_Garden //  // @ game+0x18f4c40
};
