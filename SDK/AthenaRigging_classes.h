...
struct UInstancedRopeComponent : UPrimitiveComponent {
	...
	void SetUnderwater(bool Underwater); // Function AthenaRigging.InstancedRopeComponent.SetUnderwater // Final|Native|Public|BlueprintCallable // @ game+0x3ff74b0
	void SetRopes(struct TArray<struct FInstancedRopeParams> InRopes); // Function AthenaRigging.InstancedRopeComponent.SetRopes // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x3ff7380
};
...
struct URiggingSystemComponent : USceneComponent {
	...
	void SetSocketLookupSource(struct AActor* InSocketSource); // Function AthenaRigging.RiggingSystemComponent.SetSocketLookupSource // Final|Native|Public|BlueprintCallable // @ game+0x3ff7430
	int32_t ConvertLineToRopeIndex(struct FName InLineGroupName, int32_t InLineOffset); // Function AthenaRigging.RiggingSystemComponent.ConvertLineToRopeIndex // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3ff7160
};
...
struct URopeInterface : UInterface {
	...
	void SetRopeUVOffset(float InUVOffset); // Function AthenaRigging.RopeInterface.SetRopeUVOffset // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3ff7300
	void SetRopeEndpoints(struct FVector InWorldSpaceStart, struct FVector InWorldSpaceEnd); // Function AthenaRigging.RopeInterface.SetRopeEndpoints // Native|Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x3ff7220
};
