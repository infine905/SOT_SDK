...
struct ABP_ShipWeaponsChest_C : APossessionsChest {
	...
	void UserConstructionScript(); // Function BP_ShipWeaponsChest.BP_ShipWeaponsChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
