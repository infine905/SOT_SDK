...
struct UAIShipDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void RequestAIShipForCrew(struct UObject* WorldContextObject, struct FGuid CrewId); // Function AIShips.AIShipDebugFunctionLibrary.RequestAIShipForCrew // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x41d9ea0
	struct FAIShipEncounterBattleDesc GenerateAIShipBattleDesc(struct UObject* WorldContextObject, struct UAIShipServiceDataAsset* ServiceParams); // Function AIShips.AIShipDebugFunctionLibrary.GenerateAIShipBattleDesc // Final|Native|Static|Public|BlueprintCallable // @ game+0x41d9d50
};
...
struct UAIShipsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool RequestPassiveAIShipForPlayerShip(struct UObject* WorldContext, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x41da2f0
	bool RequestPassiveAIShipAtLocation(struct UObject* WorldContext, struct FVector Location, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x41da1a0
	bool RequestAggressiveAIShipForPlayerShip(struct UObject* WorldContext, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x41da0b0
	bool RequestAggressiveAIShipAtLocation(struct UObject* WorldContext, struct FVector Location, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x41d9f60
};
...
struct AAthenaAIShipController : AAthenaAIControllerBase {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AIShips.AthenaAIShipController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x41d9c80
};
...
struct UCursedCrewCustomisationInterface : UInterface {
	...
	void SetCursedCrewCustomisationProperties(struct FAIShipSailData SailData); // Function AIShips.CursedCrewCustomisationInterface.SetCursedCrewCustomisationProperties // Native|Event|Public|HasOutParms|BlueprintEvent // @ game+0x41da3e0
};
