...
struct UAthenaAIFormComponent : UActorComponent {
	...
	void OnRep_FormData(); // Function AthenaAI.AthenaAIFormComponent.OnRep_FormData // Final|Native|Private // @ game+0x4c89e90
};
...
struct UAISpawner : UDataAsset {
	...
	bool HasSpawnerLevelEncounters; // 0x48(0x01)
	char UnknownData_49[0x7]; // 0x49(0x07)
	struct FAISpawnTypeParamsCollection SpawnTypeParamsCollection; // 0x50(0x48)
	struct UAIEncounterSettings* DefaultEncounterSettings; // 0x98(0x08)
	struct UAISpawnWaveSequenceRankProgression* DefaultSpawnWaveProgression; // 0xa0(0x08)
	struct TArray<struct FAISpawnContextIdEncounterSettingsPair> SpawnContextSpecificEncounterSettings; // 0xa8(0x10)
	bool ShouldSpawnFacingRegionCentre; // 0xb8(0x01)
	char DefaultSpawnType; // 0xb9(0x01)
	char UnknownData_BA[0x6]; // 0xba(0x06)
	struct UEnvQuery* FindSpawnPosQuery; // 0xc0(0x08)
	char FindSpawnPosQueryRunMode; // 0xc8(0x01)
	char UnknownData_C9[0x3]; // 0xc9(0x03)
	struct FName SpawnLocationType; // 0xcc(0x08)
	int32_t MaxNumOfSpawnedPawns; // 0xd4(0x04)
	int32_t PriorityForSpawnedPawns; // 0xd8(0x04)
	char UnknownData_DC[0x4]; // 0xdc(0x04)
	struct TArray<struct FConditionalAISpawnOverride> SpawnOverrides; // 0xe0(0x10)
	struct TArray<struct FAdditionalSpawnerBehaviour> AdditionalBehaviours; // 0xf0(0x10)
	bool EnforceHomePosition; // 0x100(0x01)
	bool SpawnEvenIfExcluded; // 0x101(0x01)
	char UnknownData_102[0x27e]; // 0x102(0x27e)
	struct UAthenaAISettings* AthenaAISettings; // 0x380(0x08)
	char UnknownData_388[0xc0]; // 0x388(0xc0)

	int32_t GetNumOfSpawnRequests(); // Function AthenaAI.AISpawner.GetNumOfSpawnRequests // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89aa0
};

// Class AthenaAI.AIPerCrewSpawner
// Size: 0x5a8 (Inherited: 0x448)
struct UAIPerCrewSpawner : UAISpawner {
	struct UAIWeightedProbabilityRangeOfRangesRankProgression* DefaultRespawnTimerRanges; // 0x448(0x08)
	int32_t MaxNumOfCrewsToSpawnFor; // 0x450(0x04)
	bool ActivateBySettingFootOnIsland; // 0x454(0x01)
	bool UseRespawnTimerForFirstSpawn; // 0x455(0x01)
	bool AssociateSpawnsWithSpecificCrews; // 0x456(0x01)
	bool PerceiveTriggerActorOnSpawn; // 0x457(0x01)
	bool EnforceRespawnTimeAfterCrewLeaves; // 0x458(0x01)
	bool IgnoreSpawningGracePeriodForNewCrew; // 0x459(0x01)
	char UnknownData_45A[0x6]; // 0x45a(0x06)
	struct UAIPerCrewSpawnerSettingsStoryOverrideAsset* StoryOverrideRespawnSettingsAsset; // 0x460(0x08)
	char UnknownData_468[0x140]; // 0x468(0x140)
};
...
// Size: 0x580 (Inherited: 0x448)
struct UAIWaveSpawner : UAISpawner {
	char UnknownData_448[0x8]; // 0x448(0x08)
	struct FAISpawnerWave SpawnedWave; // 0x450(0x100)
	float MinRespawnTime; // 0x550(0x04)
	float MaxRespawnTime; // 0x554(0x04)
...
struct AAICreatureCharacter : ACharacter {
	...
	void SetAIStrategy(struct UClass* InStrategy); // Function AthenaAI.AICreatureCharacter.SetAIStrategy // Native|Public|BlueprintCallable // @ game+0x3b7ad50
	void OnRep_CurrentAIStrategy(struct UClass* OldAIStrategy); // Function AthenaAI.AICreatureCharacter.OnRep_CurrentAIStrategy // Final|Native|Protected // @ game+0x3b7acb0
	void Multicast_DespawnRPC(); // Function AthenaAI.AICreatureCharacter.Multicast_DespawnRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3b7ac90
	struct UClass* GetAIStrategy(); // Function AthenaAI.AICreatureCharacter.GetAIStrategy // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3b7abd0
};
...
struct AAICreatureSpline : AActor {
	...
	void OnRep_ShouldTickBeEnabled(); // Function AthenaAI.AICreatureSpline.OnRep_ShouldTickBeEnabled // Final|Native|Private // @ game+0x3b7ad30
	void OnCreatureMovementStarted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementStarted // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void OnCreatureMovementCompleted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementCompleted // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void BeginCreatureMovement(); // Function AthenaAI.AICreatureSpline.BeginCreatureMovement // Final|Native|Protected|BlueprintCallable // @ game+0x3b7abb0
};
...
struct ALimitedInteractableAICreatureSpline : AAICreatureSpline {
	...
	void OnInteractionStartedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionStartedClient // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void OnInteractionCompletedServer(struct AActor* PlayerCharacter); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedServer // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void OnInteractionCompletedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedClient // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void OnInteractionCancelledClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCancelledClient // Event|Protected|BlueprintEvent // @ game+0x18f4c40
	void InteractCountRetrieved(int32_t InInteractedCount); // Function AthenaAI.LimitedInteractableAICreatureSpline.InteractCountRetrieved // Final|Native|Protected|BlueprintCallable // @ game+0x3b7ac10
};
...
// Size: 0x608 (Inherited: 0x448)
struct UAIBountySpawner : UAISpawner {
	float MaximumDistanceToPerceiveOnSpawnsAfterFirstGroup; // 0x448(0x04)
	char UnknownData_44C[0x4]; // 0x44c(0x04)
	struct TArray<struct FAIBountySpawnerWaveGroup> WaveGroups; // 0x450(0x10)
	struct FStringAssetReference TeamColor; // 0x460(0x10)
	struct FWeightedProbabilityRange WavesPerRelocate; // 0x470(0x20)
	struct FWeightedProbabilityRange WaveSplitChance; // 0x490(0x20)
	struct TArray<float> WaveSuicideTime; // 0x4b0(0x10)
	float WaveSuicideMinDist; // 0x4c0(0x04)
	bool ImmediatelyPerceiveTargets; // 0x4c4(0x01)
	bool DynamicallyCreateWaveDelays; // 0x4c5(0x01)
	char UnknownData_4C6[0x2]; // 0x4c6(0x02)
	float DynamicMinTimeBetweenSpawns; // 0x4c8(0x04)
	float DynamicMaxTimeBetweenSpawns; // 0x4cc(0x04)
	struct UAICombatDialogue* ActiveCombatDialogue; // 0x4d0(0x08)
	char UnknownData_4D8[0x28]; // 0x4d8(0x28)
	struct TArray<struct AActor*> CrewMembers; // 0x500(0x10)
	struct TArray<struct AActor*> NonCrewMembersInRegion; // 0x510(0x10)
	struct TArray<struct APlayerController*> AllPlayersThatParticipated; // 0x520(0x10)
	struct TArray<struct AActor*> AllCurrentlyParticipatingPlayers; // 0x530(0x10)
	struct TArray<struct AActor*> AllCurrentlyParticipatingShips; // 0x540(0x10)
	struct UOverlapTriggerComponent* AudioZoneTriggerComponent; // 0x550(0x08)
	char UnknownData_558[0xb0]; // 0x558(0xb0)
};
...
struct AAIDebugSpawnActor : AActor {
	...
	void StartSpawning(); // Function AthenaAI.AIDebugSpawnActor.StartSpawning // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3c19310
};
...
struct UAthenaAIDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct TArray<struct FAIEncounterSpecification> SpawnMultipleAI(int32_t Count, struct UAIEncounterSettings* EncounterSettings, struct FVector Pos, struct FRotator Rot, float Delay, bool MakeAIPermanentlyNetRelevant, struct AActor* InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnMultipleAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c18ff0
	void SpawnAIWithSettings(struct UClass* AIType, struct UAthenaAIControllerParamsDataAsset* Skillset, struct ULoadoutAsset* Loadout, struct UAthenaAIFormDataAsset* Form, struct UClass* AIItemSpawnComponent, struct UClass* ClassId, struct UAthenaAIAmmoDataAsset* Ammo, struct FVector Pos, struct FRotator Rot, struct FName Region, struct AActor* TriggerActor, struct FName NavMeshOverride, float Delay); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAIWithSettings // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c18830
	struct FAIEncounterSpecification SpawnAI(struct UAIEncounterSettings* EncounterSettings, struct FVector Pos, struct FRotator Rot, float Delay, bool MakeAIPermanentlyNetRelevant, struct AActor* InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c18500
	void SetEnvQueryManagerMaxAllowedSeconds(float InMaxAllowedSeconds, struct UObject* QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SetEnvQueryManagerMaxAllowedSeconds // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c18440
	void KillAllDebugAISpawners(); // Function AthenaAI.AthenaAIDebugFunctionLibrary.KillAllDebugAISpawners // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c18420
	int32_t GetEnvQueryManagerNumRunningQueries(struct UObject* QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.GetEnvQueryManagerNumRunningQueries // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c183a0
	void EnableMaximumSightSettings(struct AAthenaAIController* AIController); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableMaximumSightSettings // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c18330
	void EnableBehaviorTreeLogging(struct UObject* WorldContext); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableBehaviorTreeLogging // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c182c0
	void DespawnAIPawn(struct APawn* Pawn); // Function AthenaAI.AthenaAIDebugFunctionLibrary.DespawnAIPawn // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c18250
	void CreateAISpawnerAtPosition(struct UObject* WorldContext, struct UAISpawner* SpawnerAsset, struct FVector Pos); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtPosition // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c18150
	void CreateAISpawnerAtActor(struct UObject* WorldContext, struct UAISpawner* SpawnerAsset, struct AActor* SpawnLocationActor); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c18060
	struct FVector CanProjectPointToNavigation(struct UObject* WorldContext, struct FVector Point, struct ANavigationData* NavData, struct UClass* FilterClass, struct FVector QueryExtent); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CanProjectPointToNavigation // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c17e90
};
...
// Size: 0x590 (Inherited: 0x448)
struct UAIFaunaSpawner : UAISpawner {
	struct FAIFaunaSpawnerWave FaunaWave; // 0x448(0x110)
	char UnknownData_558[0x10]; // 0x558(0x10)
	struct AActor* FaunaLeader; // 0x568(0x08)
	char UnknownData_570[0x10]; // 0x570(0x10)
	struct TArray<struct AActor*> PlayersInSpawnArea; // 0x580(0x10)

	void SpawnFaunaGroup(); // Function AthenaAI.AIFaunaSpawner.SpawnFaunaGroup // Final|Native|Public|BlueprintCallable // @ game+0x3db6000
};
...
struct AAthenaAIControllerBase : AAIController {
	...
	void SetNamedControllerParam(struct FName ParamName, float Value); // Function AthenaAI.AthenaAIControllerBase.SetNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4c8b750
	struct FWeightedProbabilityRangeOfRanges FindNamedWeightedRangesControllerParam(struct FName ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedWeightedRangesControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89820
	float FindNamedControllerParam(struct FName ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89770
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AthenaAI.AthenaAIControllerBase.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4c89240
};

// Class AthenaAI.AthenaAIController
// Size: 0x970 (Inherited: 0x610)
struct AAthenaAIController : AAthenaAIControllerBase {
	...
	struct TArray<char> HealthChangedReasonsExcludedFromKillNotifications; // 0x690(0x10)
	char UnknownData_6A0[0x48]; // 0x6a0(0x48)
	struct TArray<struct FAthenaAIControllerSenseSettingOverride> AIStrategySenseSettingOverrides; // 0x6e8(0x10)
	char UnknownData_6F8[0x248]; // 0x6f8(0x248)
	struct AActor* CurrentNotSeenPerceivedActor; // 0x940(0x08)
	struct AActor* PendingSpawnTriggerActor; // 0x948(0x08)
	char UnknownData_950[0x20]; // 0x950(0x20)

	void StopBehaviourLogic(); // Function AthenaAI.AthenaAIController.StopBehaviourLogic // Native|Public|BlueprintCallable // @ game+0x4c8bcb0
	void SetPerceptionExpirationAgeForActor(struct AActor* Actor, float ExpirationAge, struct UClass* Sense); // Function AthenaAI.AthenaAIController.SetPerceptionExpirationAgeForActor // Final|Native|Public|BlueprintCallable // @ game+0x4c8b8b0
	void RegisterSpawnTriggerActorAsStimulus(struct AActor* TriggerActor); // Function AthenaAI.AthenaAIController.RegisterSpawnTriggerActorAsStimulus // Native|Public|BlueprintCallable // @ game+0x4c8aad0
	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function AthenaAI.AthenaAIController.OnPerceptionUpdated // Native|Public // @ game+0x4c89c90
	void OnNewlySpawned(); // Function AthenaAI.AthenaAIController.OnNewlySpawned // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void OnFinishDespawn(); // Function AthenaAI.AthenaAIController.OnFinishDespawn // Event|Public|BlueprintEvent // @ game+0x18f4c40
	bool IsActorPerceived(struct AActor* TargetActor); // Function AthenaAI.AthenaAIController.IsActorPerceived // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89b30
	struct AActor* GetTargetActor(); // Function AthenaAI.AthenaAIController.GetTargetActor // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89b00
	struct UAthenaAIPerceptionComponent* GetAthenaAIPerceptionComponent(); // Function AthenaAI.AthenaAIController.GetAthenaAIPerceptionComponent // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x4c89a40
	void GetAllSeenActors(struct TArray<struct AActor*> SeenActors); // Function AthenaAI.AthenaAIController.GetAllSeenActors // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4c89980
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AthenaAI.AthenaAIController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4c89170
};

// Class AthenaAI.AthenaFaunaAIController
// Size: 0xb38 (Inherited: 0x970)
struct AAthenaFaunaAIController : AAthenaAIController {
	float MaxTimeBetweenThreatDetermination; // 0x970(0x04)
	float DefaultControlRotationInterpSpeed; // 0x974(0x04)
	struct TArray<struct FAIStategyControllerMovementMod> StrategyControllerMovementMods; // 0x978(0x10)
	float MinAgentHalfHeightPctOverride; // 0x988(0x04)
	char UnknownData_98C[0x4]; // 0x98c(0x04)
	struct UFaunaAIContollerParamsDataAsset* FaunaDataAsset; // 0x990(0x08)
	struct AActor* CarrierActor; // 0x998(0x08)
	char UnknownData_9A0[0xc8]; // 0x9a0(0xc8)
	struct AActor* HighestDangerActor; // 0xa68(0x08)
	char UnknownData_A70[0x98]; // 0xa70(0x98)
	struct UFaunaAIPlayerTracker* PlayerTracker; // 0xb08(0x08)
	char UnknownData_B10[0x28]; // 0xb10(0x28)

	void SetDormancyCheckingEnabled(bool InDormancyCheckingEnabledInAutomation); // Function AthenaAI.AthenaFaunaAIController.SetDormancyCheckingEnabled // Final|Native|Public|BlueprintCallable // @ game+0x3db5f70
	void LeaderDestroyed(struct AActor* Actor); // Function AthenaAI.AthenaFaunaAIController.LeaderDestroyed // Final|Native|Private // @ game+0x3db5c10
	struct AActor* GetLeader(); // Function AthenaAI.AthenaFaunaAIController.GetLeader // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3db5430
	float GetCourage(); // Function AthenaAI.AthenaFaunaAIController.GetCourage // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3db5130
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function AthenaAI.AthenaFaunaAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3db5100
};
...
struct AFauna : AAICreatureCharacter {
	...
	void TestingSetWaterState(char NewInState); // Function AthenaAI.Fauna.TestingSetWaterState // Final|Native|Public|BlueprintCallable // @ game+0x3db6020
	void OnRep_TargetTurnAngle(); // Function AthenaAI.Fauna.OnRep_TargetTurnAngle // Final|Native|Private // @ game+0x3db5f50
	void OnRep_IsPlayingStarvingAnim(); // Function AthenaAI.Fauna.OnRep_IsPlayingStarvingAnim // Final|Native|Private // @ game+0x3db5f30
	void OnRep_IsCalm(); // Function AthenaAI.Fauna.OnRep_IsCalm // Final|Native|Private // @ game+0x3db5f10
	void OnRep_IsAgitated(); // Function AthenaAI.Fauna.OnRep_IsAgitated // Final|Native|Private // @ game+0x3db5ef0
	void OnRep_InWaterState(); // Function AthenaAI.Fauna.OnRep_InWaterState // Final|Native|Private // @ game+0x3db5ed0
	void OnRep_CratedState(char PreviousCratedState); // Function AthenaAI.Fauna.OnRep_CratedState // Final|Native|Private|HasOutParms // @ game+0x3db5e40
	void Multicast_PlayPutInCrateEffectsRPC(struct AActor* Crate); // Function AthenaAI.Fauna.Multicast_PlayPutInCrateEffectsRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3db5db0
	void Multicast_JustBeenFedRPC(struct AActor* FedBy); // Function AthenaAI.Fauna.Multicast_JustBeenFedRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3db5d20
	void Multicast_HightlightLeader(bool bIsLeader); // Function AthenaAI.Fauna.Multicast_HightlightLeader // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3db5c90
	void GenerateNewRandomAnimationSeed(); // Function AthenaAI.Fauna.GenerateNewRandomAnimationSeed // Final|Native|Public|BlueprintCallable // @ game+0x3db4f90
	void ActivateResponseRPC(float InTargetTurnAngle); // Function AthenaAI.Fauna.ActivateResponseRPC // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x3db4ee0
};
...
// Size: 0xa70 (Inherited: 0x970)
struct AAthenaSwimmingAIController : AAthenaAIController {
	struct USwimmingPathFollowingComponent* SwimmingPathFollowingComponent; // 0x970(0x08)
	bool IgnoreTargetsOutOfWater; // 0x978(0x01)
	char UnknownData_979[0x7]; // 0x979(0x07)
	struct UCurveFloat* DistOfAttackerVsChanceToPursue; // 0x980(0x08)
	struct TArray<struct FName> TimersToZeroIfStartingRevengeAttack; // 0x988(0x10)
	struct FName DespawnRequiredBlackboardKey; // 0x998(0x08)
	struct FName DespawnRequiredReasonBlackboardKey; // 0x9a0(0x08)
	float PathingFailedWeight; // 0x9a8(0x04)
	float PathingFailedThresholdToDespawn; // 0x9ac(0x04)
	char UnknownData_9B0[0xc0]; // 0x9b0(0xc0)

	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* InControllerParametersAsset, struct APawn* InPawn); // Function AthenaAI.AthenaSwimmingAIController.ApplyControllerParams // Final|Native|Public|BlueprintCallable // @ game+0x41f6270
};
...
struct ATinySharkExperience : AActor {
	...
	void TinySharkPawnDestroyed(struct AActor* InDestroyedActor); // Function AthenaAI.TinySharkExperience.TinySharkPawnDestroyed // Final|Native|Private // @ game+0x4217ef0
	void OnRep_TinySharkPawn(struct ASharkPawn* LastTinySharkPawn); // Function AthenaAI.TinySharkExperience.OnRep_TinySharkPawn // Native|Protected // @ game+0x4217c80
	struct AShip* GetTrackedShip(); // Function AthenaAI.TinySharkExperience.GetTrackedShip // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4217c60
	char GetCurrentState(); // Function AthenaAI.TinySharkExperience.GetCurrentState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4217c40
	char GetActiveState(); // Function AthenaAI.TinySharkExperience.GetActiveState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4217c20
};
...
struct ATinySharkService : AActor {
	...
	char UnknownData_3E0[0x1b0]; // 0x3e0(0x1b0)
	struct TArray<struct ATinySharkExperience*> TinySharkExperiences; // 0x590(0x10)
	...
	bool RequestTinySharkWithShip(struct AShip* InTrackedShip, int32_t OverrideControllerParamIndex, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithShip // Native|Public|BlueprintCallable // @ game+0x4217df0
	bool RequestTinySharkWithLocation(struct FVector SpawnLocation, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4217d10
	void DismissAllTinySharks(); // Function AthenaAI.TinySharkService.DismissAllTinySharks // Native|Public|BlueprintCallable // @ game+0x4217bf0
	bool CanSpawnTinySharkExperience(); // Function AthenaAI.TinySharkService.CanSpawnTinySharkExperience // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4217bb0
};
...
struct UAINameplateComponent : UNameplateComponent {
	...
	void OnRep_Title(); // Function AthenaAI.AINameplateComponent.OnRep_Title // Final|Native|Private // @ game+0x4c89ef0
	void OnRep_DisplayNameAsString(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsString // Final|Native|Private // @ game+0x4c89e70
	void OnRep_DisplayName(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayName // Final|Native|Private // @ game+0x4c89e50
	void OnRep_DebugDisplayText(); // Function AthenaAI.AINameplateComponent.OnRep_DebugDisplayText // Final|Native|Private // @ game+0x4c89e30
};
...
struct APet : AAICreatureCharacter {
	...
	void SetExitTakeOffFlag(bool InExitTakeOffFlag); // Function AthenaAI.Pet.SetExitTakeOffFlag // Final|Native|Public|BlueprintCallable // @ game+0x4643280
	void OnShipDestroyed(struct AActor* InShip); // Function AthenaAI.Pet.OnShipDestroyed // Final|Native|Public // @ game+0x4643120
	void OnRep_RollRequest(); // Function AthenaAI.Pet.OnRep_RollRequest // Final|Native|Private // @ game+0x4643100
	void OnRep_ResetRollAndZOffset(); // Function AthenaAI.Pet.OnRep_ResetRollAndZOffset // Final|Native|Private // @ game+0x46430e0
	void OnRep_PetTurnToFaceData(); // Function AthenaAI.Pet.OnRep_PetTurnToFaceData // Final|Native|Public // @ game+0x46430c0
	void OnRep_PetOwner(); // Function AthenaAI.Pet.OnRep_PetOwner // Final|Native|Private // @ game+0x4643080
	void OnRep_PetIsSad(); // Function AthenaAI.Pet.OnRep_PetIsSad // Final|Native|Private // @ game+0x4643060
	void OnRep_PetInfo(); // Function AthenaAI.Pet.OnRep_PetInfo // Final|Native|Private // @ game+0x4643040
	void OnRep_PerchedInHangout(); // Function AthenaAI.Pet.OnRep_PerchedInHangout // Final|Native|Private // @ game+0x4643020
	void OnRep_MovementRequest(); // Function AthenaAI.Pet.OnRep_MovementRequest // Final|Native|Private // @ game+0x4643000
	void OnRep_InHangout(); // Function AthenaAI.Pet.OnRep_InHangout // Final|Native|Private // @ game+0x4642fc0
	void OnOwnerDestroyed(struct AActor* InOwner); // Function AthenaAI.Pet.OnOwnerDestroyed // Final|Native|Public // @ game+0x4642da0
	void Multicast_DitherOut(); // Function AthenaAI.Pet.Multicast_DitherOut // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x4642d80
	void Multicast_DitherIn(); // Function AthenaAI.Pet.Multicast_DitherIn // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x4642d60
	float GetFloorMeshOffsetZ(); // Function AthenaAI.Pet.GetFloorMeshOffsetZ // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4642d40
};
...
struct UAIEncounterServiceInterface : UInterface {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression* Progression); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x4c8a9c0
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset* Skillset); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4c8a7a0
	void RegisterLoadedLoadout(struct ULoadoutAsset* Loadout); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x4c8a580
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset* Form); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4c8a360
	void RegisterLoadedEncounter(struct UAIEncounterSettings* Encounter); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x4c8a140
};
...
struct UAICombatEncounterInterface : UInterface {
	...
	void OnVulnerabilityStateEntered(); // Function AthenaAI.AICombatEncounterInterface.OnVulnerabilityStateEntered // Native|Event|Public|BlueprintEvent // @ game+0x4c89f10
};
...
struct AAIEncounterService : AActor {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression* Progression); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x4c8a8b0
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset* Skillset); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4c8a690
	void RegisterLoadedLoadout(struct ULoadoutAsset* Loadout); // Function AthenaAI.AIEncounterService.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x4c8a470
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset* Form); // Function AthenaAI.AIEncounterService.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4c8a250
	void RegisterLoadedEncounter(struct UAIEncounterSettings* Encounter); // Function AthenaAI.AIEncounterService.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x4c8a020
};
...
struct UAIManagerBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AItemInfo* SpawnItemFromAI(struct APawn* Pawn, struct UClass* ItemDesc); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.SpawnItemFromAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4c8ba50
	int32_t GetFrameCounter(); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.GetFrameCounter // Final|Native|Static|Public|BlueprintCallable // @ game+0x4c89a70
	void AddNameplateToAIWithLocalisedName(struct AActor* Actor, struct FText DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAIWithLocalisedName // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x4c89090
	void AddNameplateToAI(struct AActor* Actor, struct FString DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4c88fc0
};
...
struct UAIManagerServiceInterface : UInterface {
	...
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerServiceInterface.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x4c8bbe0
	int32_t GetNumOfSpawnedPawns(); // Function AthenaAI.AIManagerServiceInterface.GetNumOfSpawnedPawns // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89ad0
};
...
struct UAISpawnWaveSequence : UDataAsset {
	char UnknownData_28[0x10]; // 0x28(0x10)
	struct TArray<struct FAISpawnerWave> Waves; // 0x38(0x10)
	struct FName FeatureName; // 0x48(0x08)
};
...
struct UAISpawnWaveSequenceRankProgression : UDataAsset {
	char UnknownData_28[0x10]; // 0x28(0x10)
	struct TArray<struct FAISpawnWaveSequenceRankMapping> RankMappings; // 0x38(0x10)
	int32_t NumberOfRanks; // 0x48(0x04)
	char UnknownData_4C[0x4]; // 0x4c(0x04)
};
...
struct UAthenaAISettings : UDeveloperSettings {
	...
	struct FStringAssetReference AIPartsServiceParamsFileLocation; // 0xa0(0x10)
	float DefaultNavAgentCapsuleRadius; // 0xb0(0x04)
	float DefaultNavAgentCapsuleHalfHeight; // 0xb4(0x04)
	float MinDelayBeforeRetryingUnsuccessfulWave; // 0xb8(0x04)
	float MaxDelayBeforeRetryingUnsuccessfulWave; // 0xbc(0x04)
	struct FStringAssetReference AIEncounterServiceAssetClassFileLocation; // 0xc0(0x10)
	struct FStringAssetReference AIEncounterGenerationServiceAssetClassFileLocation; // 0xd0(0x10)
	struct FName AICharacterWaterInteractionCollisionProfileName; // 0xe0(0x08)
	float AICountTelemetryEventFrequency; // 0xe8(0x04)
...
struct AAIManagerService : AActor {
	...
	void TickService(float DeltaSeconds); // Function AthenaAI.AIManagerService.TickService // Final|Native|Public|BlueprintCallable // @ game+0x4c8bcd0
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerService.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x4c8bb10
};
...
struct UDebugAIManagerServiceInterface : UInterface {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x4c8b6d0
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4c8b5c0
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x4c8b4b0
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerServiceInterface.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4c8b280
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerServiceInterface.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4c8b170
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4c8afe0
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4c8aee0
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4c8ade0
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerServiceInterface.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x4c893e0
};
...
struct ADebugAIManagerService : AAIManagerService {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerService.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x4c8b640
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4c8b530
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x4c8b420
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerService.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4c8b1f0
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerService.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4c8b0f0
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4c8af60
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4c8ae60
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerService.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4c8ad60
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerService.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x4c89310
};
...
struct UAIPartsService : UObject {
	char UnknownData_28[0x10]; // 0x28(0x10)
	struct UAIPartsCategoryTypeList* PartsCategoriesList; // 0x38(0x08)
	struct UAIColorVariantPool* TeamColors; // 0x40(0x08)
};
...
struct UAIPartsRetrievalComponent : UActorComponent {
	...
	void RequestNewAIParts(struct UAIPartsCategory* AssignedPartsCategory, int32_t PartsIndexToUse, int32_t TeamColorIndex); // Function AthenaAI.AIPartsRetrievalComponent.RequestNewAIParts // Final|Native|Public|BlueprintCallable // @ game+0x4c8ac60
	void OnRep_ReplicatedAIPartsData(); // Function AthenaAI.AIPartsRetrievalComponent.OnRep_ReplicatedAIPartsData // Final|Native|Private // @ game+0x4c89eb0
};

// Class AthenaAI.AIPartsServiceParams
// Size: 0x38 (Inherited: 0x28)
struct UAIPartsServiceParams : UDataAsset {
	struct UAIPartsCategoryTypeList* PartsCategoriesList; // 0x28(0x08)
	struct UAIColorVariantPool* TeamColors; // 0x30(0x08)
};
...
struct UAIFixedWavesSpawner : UAISpawner {
	struct TArray<struct FAIPersistentSpawnerWave> SpawnedWaves; // 0x448(0x10)
	int32_t NumWavesToSpawnOnSpottedNewTarget; // 0x458(0x04)
	char UnknownData_45C[0x2c]; // 0x45c(0x2c)
};

// Class AthenaAI.AIIncrementalWaveSpawner
// Size: 0x568 (Inherited: 0x448)
struct UAIIncrementalWaveSpawner : UAISpawner {
	struct FAISpawnerWave SpawnedWave; // 0x448(0x100)
	struct UNamedAIDataAsset* NamedAIDataAsset; // 0x548(0x08)
...
struct UAIInteractableSpawner : UAISpawner {
	struct UClass* AIInteractableType; // 0x448(0x08)
	float InhabitedChance; // 0x450(0x04)
	char UnknownData_454[0x4]; // 0x454(0x04)
	struct FWeightedProbabilityRangeOfRanges DelayAfterSuccessfulInhabitedCheck; // 0x458(0x30)
	struct FWeightedProbabilityRangeOfRanges DelayAfterFailedInhabitedCheck; // 0x488(0x30)
	bool BlockSubsequentSpawningAtInteractableOnceAiKilled; // 0x4b8(0x01)
	char UnknownData_4B9[0x3]; // 0x4b9(0x03)
	float SpawnForInteractableChance; // 0x4bc(0x04)
	struct FWeightedProbabilityRangeOfRanges DelayAfterSuccessfulSpawnOnInteractableCheck; // 0x4c0(0x30)
	struct FWeightedProbabilityRangeOfRanges DelayAfterFailedSpawnOnInteractableCheck; // 0x4f0(0x30)
	bool RunInhabitedSimulation; // 0x520(0x01)
	bool RunSpawnForInteractableSimulation; // 0x521(0x01)
	char UnknownData_522[0x2]; // 0x522(0x02)
	int32_t NumIterations; // 0x524(0x04)
	char UnknownData_528[0x19]; // 0x528(0x19)
	char CachedPlaymode; // 0x541(0x01)
	char UnknownData_542[0x6]; // 0x542(0x06)
};
...
// Size: 0x660 (Inherited: 0x448)
struct UAIPerPlayerSpawner : UAISpawner {
	bool CheckSpawnedActorsInRadiusBeforeSpawning; // 0x448(0x01)
	char UnknownData_449[0x3]; // 0x449(0x03)
	float RadiusToCheckForExistingPopulation; // 0x44c(0x04)
	int32_t MaxExistingPopulationInRadius; // 0x450(0x04)
	bool DespawnAllPawnsWhenAllPlayersLeave; // 0x454(0x01)
	char UnknownData_455[0x3]; // 0x455(0x03)
	int32_t MaxActorsTotalPerPlayer; // 0x458(0x04)
	bool RunSimulation; // 0x45c(0x01)
	char UnknownData_45D[0x3]; // 0x45d(0x03)
	int32_t RankForSimulation; // 0x460(0x04)
	int32_t NumIterations; // 0x464(0x04)
	bool WantsToTemporarilyRememberPlayers; // 0x468(0x01)
	char UnknownData_469[0x7]; // 0x469(0x07)
	struct FWeightedProbabilityRangeOfRanges TemporaryPlayerMemoryTimeRange; // 0x470(0x30)
	char UnknownData_4A0[0x118]; // 0x4a0(0x118)
	struct TMap<struct AActor*, struct FAIPerPlayerSpawnerPlayerDetailsUnit> PlayerDetails; // 0x5b8(0x50)
	...
	void PlayerDeath(struct AActor* Player); // Function AthenaAI.AIPerPlayerSpawner.PlayerDeath // Final|Native|Public // @ game+0x4c89f30
};
...
// Size: 0x740 (Inherited: 0x660)
struct UAIBoobyTrapSpawner : UAIPerPlayerSpawner {
	int32_t NumberOfWavesToSpawn; // 0x660(0x04)
	char UnknownData_664[0x4]; // 0x664(0x04)
	struct UWwiseEvent* NewWaveSpawnSfx; // 0x668(0x08)
	float NewWaveSpawnSfxTriggerRadius; // 0x670(0x04)
	char UnknownData_674[0x4]; // 0x674(0x04)
	struct TArray<struct UClass*> ShowNameplatesFor; // 0x678(0x10)
	struct UNamedAIDataAsset* NamedAIDataAsset; // 0x688(0x08)
	struct AActor* ActorToTrack; // 0x690(0x08)
	char UnknownData_698[0xa8]; // 0x698(0xa8)
};

// Class AthenaAI.AIProgressiveWavesSpawner
// Size: 0x480 (Inherited: 0x448)
struct UAIProgressiveWavesSpawner : UAISpawner {
	bool ApplyLocalisableNamesToNameplates; // 0x448(0x01)
	char UnknownData_449[0x7]; // 0x449(0x07)
	struct TArray<struct FAIPersistentSpawnerWave> Waves; // 0x450(0x10)
	char UnknownData_460[0x18]; // 0x460(0x18)
	struct AActor* TriggerActor; // 0x478(0x08)
};
...
struct UAIEscalatingWaveSpawner : UAIWaveSpawner {
	struct TArray<struct FEscalatingWave> EscalatingWaves; // 0x580(0x10)
...
// Class AthenaAI.AISpawnerPrerequisiteBase
// Size: 0x38 (Inherited: 0x28)
struct UAISpawnerPrerequisiteBase : UObject {
	bool Invert; // 0x28(0x01)
	char UnknownData_29[0x3]; // 0x29(0x03)
	struct FFeatureFlag FeatureFlag; // 0x2c(0x0c)
};

// Class AthenaAI.AISpawnerPrerequisiteIsDaytime
// Size: 0x38 (Inherited: 0x38)
struct UAISpawnerPrerequisiteIsDaytime : UAISpawnerPrerequisiteBase {
};

// Class AthenaAI.AISpawnerPrerequisiteIsFeatureFlagEnabled
// Size: 0x48 (Inherited: 0x38)
struct UAISpawnerPrerequisiteIsFeatureFlagEnabled : UAISpawnerPrerequisiteBase {
	struct FFeatureFlag PrerequisiteFeatureFlag; // 0x38(0x0c)
	char UnknownData_44[0x4]; // 0x44(0x04)
};

// Class AthenaAI.AISpawnerPrerequisiteIsStoryActive
// Size: 0x40 (Inherited: 0x38)
struct UAISpawnerPrerequisiteIsStoryActive : UAISpawnerPrerequisiteBase {
	struct FStoryFlag RequiredStory; // 0x38(0x08)
};
...
struct AAITargetActor : AActor {
	...
	void SetTargetEnabled(bool InEnabled); // Function AthenaAI.AITargetActor.SetTargetEnabled // Final|Native|Public|BlueprintCallable // @ game+0x4c8b9c0
};
...
struct UAITargetWeaponInterface : UInterface {
	...
	bool FindAimConfigToHitTarget(struct FVector Target, bool CheckYaw, struct FRotator OutAimConfig); // Function AthenaAI.AITargetWeaponInterface.FindAimConfigToHitTarget // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89630
};
...
struct AAmbientWaterSpawnerManager : AActor {
	...
	void OnPlayerDeath(struct AActor* InActorDying); // Function AthenaAI.AmbientWaterSpawnerManager.OnPlayerDeath // Final|Native|Private // @ game+0x4c89d90
};
...
struct ABurrowCrack : AActor {
	...
	void OnRep_StartFadeAndLifeSpan(); // Function AthenaAI.BurrowCrack.OnRep_StartFadeAndLifeSpan // Final|Native|Public // @ game+0x4c89ed0
	void OnLifeSpanPercentLeft(float PercentLeft); // Function AthenaAI.BurrowCrack.OnLifeSpanPercentLeft // Event|Public|BlueprintEvent // @ game+0x18f4c40
};
...
// Size: 0xbd0 (Inherited: 0x970)
struct AAthenaAICharacterController : AAthenaAIController {
	char UnknownData_970[0x8]; // 0x970(0x08)
	struct UAthenaAIItemParamsDataAsset* ItemParamsDataAsset; // 0x978(0x08)
	struct ULoadoutAsset* FallbackLoadoutIfAllEngageItemsDropped; // 0x980(0x08)
	float ControlRotationInterpSpeed; // 0x988(0x04)
	bool ControlRotationUseConstantInterp; // 0x98c(0x01)
	bool FaceTargetDisabled; // 0x98d(0x01)
	char UnknownData_98E[0x2]; // 0x98e(0x02)
	float MinTurnAngleToPlayTurnAnim; // 0x990(0x04)
	char UnknownData_994[0x14]; // 0x994(0x14)
	struct UAthenaAICharacterControllerParamsDataAsset* CharacterParamsDataAsset; // 0x9a8(0x08)
	char UnknownData_9B0[0x90]; // 0x9b0(0x90)
	struct TArray<struct FAthenaAICharacterControllerSpawnItemDescForItemCategory> SpawnItemDescForItemCategories; // 0xa40(0x10)
	struct TArray<struct UAthenaAIAbilityParams*> AIAbilityParams; // 0xa50(0x10)
	struct TArray<struct FAthenaAIAbilityDamageStage> AIAbilityStageParams; // 0xa60(0x10)
	struct TArray<struct FAthenaAIEngageEnemyData> NonItemEngageOptions; // 0xa70(0x10)
	struct UCurveFloat* DistanceInMToCannonShotHitChanceCurve; // 0xa80(0x08)
	char UnknownData_A88[0x148]; // 0xa88(0x148)

	void SetOverridePrioritiseInteractablesBeforeEnemies(bool InPrioritiseInteractablesBeforeEnemies); // Function AthenaAI.AthenaAICharacterController.SetOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x4c8b820
	void SetItemSpecificNamedControllerParam(struct UClass* InItemCategory, struct FName ParamName, float Value); // Function AthenaAI.AthenaAICharacterController.SetItemSpecificNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4c8b310
	void SetDisableTurningForTest(bool InDisableTurningForTest); // Function AthenaAI.AthenaAICharacterController.SetDisableTurningForTest // Final|Native|Public|BlueprintCallable // @ game+0x4c8b060
	void ClearOverridePrioritiseInteractablesBeforeEnemies(); // Function AthenaAI.AthenaAICharacterController.ClearOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x4c894b0
};
...
struct UAthenaAIPerceptionComponent : UAIPerceptionComponent {
	...
	bool IsPerceptionSenseEnabled(struct UClass* Sense); // Function AthenaAI.AthenaAIPerceptionComponent.IsPerceptionSenseEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89c00
	bool IsAnyPerceptionEnabled(); // Function AthenaAI.AthenaAIPerceptionComponent.IsAnyPerceptionEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c89bd0
	void EnablePerceptionSense(struct UClass* Sense, bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnablePerceptionSense // Final|Native|Public|BlueprintCallable // @ game+0x4c89560
	void EnableAllPerception(bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnableAllPerception // Final|Native|Public|BlueprintCallable // @ game+0x4c894d0
};
...
// Class AthenaAI.BTTask_CopyAIHomeToBlackboard
// Size: 0xd8 (Inherited: 0x60)
struct UBTTask_CopyAIHomeToBlackboard : UBTTaskNode {
	struct FBlackboardKeySelector HomeProviderActor; // 0x60(0x28)
	struct FBlackboardKeySelector HomeActor; // 0x88(0x28)
	struct FBlackboardKeySelector HomeLocation; // 0xb0(0x28)
};
...
struct UCoralShieldVFXComponent : UActorComponent {
	...
	void OnRep_CurrentCoralShieldRole(); // Function AthenaAI.CoralShieldVFXComponent.OnRep_CurrentCoralShieldRole // Final|Native|Private // @ game+0x4c89e10
};
...
struct UEnvQueryGenerator_WaterDonut : UEnvQueryGenerator_ProjectedPoints {
	...
	char UnknownData_1F1[0x17]; // 0x1f1(0x17)
};
...
struct ASpawnContextProviderZone : AActor {
	...
	void RemoveContextsFromTarget(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex); // Function AthenaAI.SpawnContextProviderZone.RemoveContextsFromTarget // Final|Native|Private // @ game+0x4c8ab60
	void AddContextsToTarget(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex, bool InFromSweep, struct FHitResult InSweepResult); // Function AthenaAI.SpawnContextProviderZone.AddContextsToTarget // Final|Native|Private|HasOutParms // @ game+0x4c88df0
};
...
struct UTinySharkLootSpawnParamsDataAsset : UDataAsset {
	...
	char UnknownData_49[0x7]; // 0x49(0x07)
	struct FItemSpawnParams SpawnParams; // 0x50(0x38)
	struct UWeightedItemDescSpawnDataAsset* ReferencedSpawnDistributionAsset; // 0x88(0x08)
	struct TArray<struct FItemSpawnTransform> SpawnTransforms; // 0x90(0x10)
	struct TArray<struct FItemSpawnTransformWithRandomQuantity> SpawnTransformsWithRandomQuantities; // 0xa0(0x10)
	char SpawnSource; // 0xb0(0x01)
	char UnknownData_B1[0x3]; // 0xb1(0x03)
	float SpawnRate; // 0xb4(0x04)
	bool DestroyProxiesOnEndPlay; // 0xb8(0x01)
	bool SpawnWithPhysicsEnabled; // 0xb9(0x01)
	bool DoNotAttachToOwnerWhenSpawned; // 0xba(0x01)
	bool DropItemsOnSpawn; // 0xbb(0x01)
	bool DropItemsUsingPriorityAIDropParams; // 0xbc(0x01)
