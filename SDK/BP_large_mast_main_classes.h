...
struct ABP_large_mast_main_C : ABP_Mast_C {
	...
	struct UChildActorComponent* BP_ShipFlagCustomizationChest; // 0xa88(0x08)
	struct UChildActorComponent* BP_Bell; // 0xa90(0x08)
	struct UStaticMeshComponent* shp_flag_jolly_roger_01_a; // 0xa98(0x08)
	...
	void UserConstructionScript(); // Function BP_large_mast_main.BP_large_mast_main_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void OnMastDescLoaded(struct UMastDescAsset* MastDesc); // Function BP_large_mast_main.BP_large_mast_main_C.OnMastDescLoaded // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void ExecuteUbergraph_BP_large_mast_main(int32_t EntryPoint); // Function BP_large_mast_main.BP_large_mast_main_C.ExecuteUbergraph_BP_large_mast_main //  // @ game+0x18f4c40
};
