...
struct ABP_ShipAmmoChest_C : ABP_AmmoChest_C {
	...
	void UserConstructionScript(); // Function BP_ShipAmmoChest.BP_ShipAmmoChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
