...
struct UTaleQuestCustomMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void UpdateStrikeThoughTextElement(struct FGuid MapGuid, struct FGuid ElementGuid, bool StrikeThroughEnabled); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.UpdateStrikeThoughTextElement // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x475fb20
	void AddCustomMap(struct UCustomMapData* Data, struct FGuid MapGuid); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.AddCustomMap // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x475f540
};
...
struct UTaleQuestTornMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void AddTornMap(struct FName IslandName, int32_t NumPieces, struct UTornMapParams* MapParams, float MaskRotation, struct FGuid OutMapId); // Function TaleMaps.TaleQuestTornMapFunctionLibrary.AddTornMap // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x475f670
};
...
struct UTaleQuestTriggerNamedChecklistEventStepDesc : UTaleQuestStepDesc {
	...
	struct TArray<struct FString> EventsSource(); // Function TaleMaps.TaleQuestTriggerNamedChecklistEventStepDesc.EventsSource // Final|Native|Private|Const // @ game+0x475f8b0
};
