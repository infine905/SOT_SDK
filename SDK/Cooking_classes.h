...
struct UCookerComponent : UActorComponent {
	...
	void OnRep_CookingState(struct FCookingClientRepresentation OldRepresentation); // Function Cooking.CookerComponent.OnRep_CookingState // Final|Native|Private|HasOutParms // @ game+0x3d0e450
};
...
// Size: 0x30 (Inherited: 0x30)
struct UCookItemFromRawConditionalStatTrigger : UConditionalStatsTriggerType {
};
