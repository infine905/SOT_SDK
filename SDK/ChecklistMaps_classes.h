...
struct UNamedChecklistEventActionData : UChecklistActionData {
	...
	struct TArray<struct FString> EventsSource(); // Function ChecklistMaps.NamedChecklistEventActionData.EventsSource // Final|Native|Public|Const // @ game+0x3d35420
};
...
struct AChecklistMap : ATreasureMap {
	...
	void RefreshContents(); // Function ChecklistMaps.ChecklistMap.RefreshContents // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x3d356f0
	void OnTextCanvasUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function ChecklistMaps.ChecklistMap.OnTextCanvasUpdate // Final|Native|Private // @ game+0x3d355f0
	void OnRep_Contents(struct FChecklistMapContents InPreviousContents); // Function ChecklistMaps.ChecklistMap.OnRep_Contents // Final|Native|Private|HasOutParms // @ game+0x3d35530
};
