...
struct UStoryDrivenBlendedLightingZoneComponent : UBlendedLightingZoneComponent {
	...
	void OnRep_CurrentStoryResponse(); // Function StoryFramework.StoryDrivenBlendedLightingZoneComponent.OnRep_CurrentStoryResponse // Final|Native|Private // @ game+0x17153f0
};
...
struct UStoryDrivenSalvageItemSpawnComponent : USalvageItemSpawnComponent {
	struct FStoryFlag Story; // 0x5c8(0x08)
...
struct AStoryService : AActor {
	...
	void OnRep_ActiveStories(); // Function StoryFramework.StoryService.OnRep_ActiveStories // Final|Native|Private // @ game+0x372e830
};
