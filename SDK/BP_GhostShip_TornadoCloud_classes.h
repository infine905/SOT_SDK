...
struct ABP_GhostShip_TornadoCloud_C : ABP_NonRotatableSignalCloud_C {
	...
	void IntializeGhostMaterials(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.IntializeGhostMaterials // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void CheckShowLightning(float Alpha); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.CheckShowLightning // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void UpdateTornadoMaterials(float CloudAlpha, float Alpha); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.UpdateTornadoMaterials // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void HideTornadoMeshParts(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.HideTornadoMeshParts // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void IntializeTornadoMaterials(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.IntializeTornadoMaterials // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void CollectMaterials(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.CollectMaterials // Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void UserConstructionScript(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void ReceiveBeginPlay(); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void UpdateMaterialVisibility(struct FLinearColor* SignalVisibilityLerpValue); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.UpdateMaterialVisibility // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void ExecuteUbergraph_BP_GhostShip_TornadoCloud(int32_t EntryPoint); // Function BP_GhostShip_TornadoCloud.BP_GhostShip_TornadoCloud_C.ExecuteUbergraph_BP_GhostShip_TornadoCloud //  // @ game+0x18f4c40
};
