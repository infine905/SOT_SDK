...
struct UShipDamagerComponent : UActorComponent {
	...
	void SetShape(struct UPrimitiveComponent* InShape); // Function Damagers.ShipDamagerComponent.SetShape // Final|Native|Public|BlueprintCallable // @ game+0x4384e40
	void EndDamage(); // Function Damagers.ShipDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x4384b60
	void BeginDamage(); // Function Damagers.ShipDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x4384b40
};
...
struct URadialDamagerComponent : UActorComponent {
	...
	void SetDamageRadius(float Radius); // Function Damagers.RadialDamagerComponent.SetDamageRadius // Final|Native|Public|BlueprintCallable // @ game+0x47cde70
	void EndDamage(); // Function Damagers.RadialDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x47cdce0
	void BeginDamage(); // Function Damagers.RadialDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x47cdcc0
};
...
struct UShockwaveDamagerInterface : UInterface {
	...
	void StartShockwaveAtLocation(struct FVector StartLocation); // Function Damagers.ShockwaveDamagerInterface.StartShockwaveAtLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x47cdf10
	void StartShockwave(); // Function Damagers.ShockwaveDamagerInterface.StartShockwave // Native|Public|BlueprintCallable // @ game+0x47cdef0
	void IgnoreGhostShip(struct AAggressiveGhostShip* Ship); // Function Damagers.ShockwaveDamagerInterface.IgnoreGhostShip // Native|Public|BlueprintCallable // @ game+0x47cdd60
	float GetShockwaveRadius(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveRadius // Native|Public|BlueprintCallable // @ game+0x47cdd30
	float GetShockwaveDuration(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveDuration // Native|Public|BlueprintCallable // @ game+0x47cdd00
};
...
struct UShockwaveDamagerComponent : UActorComponent {
	...
	void Multi_StartShockwave(struct FVector InStartLocation); // Function Damagers.ShockwaveDamagerComponent.Multi_StartShockwave // Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults // @ game+0x47cddf0
};
