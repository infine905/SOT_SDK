...
struct ABreakableActorBase : AActor {
	...
	void Multicast_WasDefeated(struct AActor* InInstigator, struct AActor* InDirectInstigator); // Function BreakableActorFramework.BreakableActorBase.Multicast_WasDefeated // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x4415690
};
