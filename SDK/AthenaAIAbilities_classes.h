...
struct UBurrowHealVFXComponent : UActorComponent {
	...
	void OnRep_IsVFXActive(); // Function AthenaAIAbilities.BurrowHealVFXComponent.OnRep_IsVFXActive // Final|Native|Private // @ game+0x43f7cb0
};
...
struct UElectricShieldBuffComponent : UActorComponent {
	...
	void OnRep_IsShieldActive(); // Function AthenaAIAbilities.ElectricShieldBuffComponent.OnRep_IsShieldActive // Final|Native|Public // @ game+0x43f7c90
	void DeactivateShield(); // Function AthenaAIAbilities.ElectricShieldBuffComponent.DeactivateShield // Native|Public // @ game+0x43f7c60
};
