...
struct ABP_Orderofsouls_TallTales_C : ACompanyShopkeeper {
	...
	void UserConstructionScript(); // Function BP_Orderofsouls_TallTales.BP_Orderofsouls_TallTales_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
