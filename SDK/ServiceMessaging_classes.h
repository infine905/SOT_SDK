...
struct UServiceMessagingFunctions : UBlueprintFunctionLibrary {
	...
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcherFromActor(struct UObject* Object); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcherFromActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x3362d00
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcher(TScriptInterface<struct UServiceMessagingDispatcherInterface> ServiceMessagingDispatcher); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcher // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3362c60
};
...
struct UServiceMessagingListenerTestObject : UObject {
	...
	void TestFunctionWithMessage(struct FServiceMessagingTestMessage InMessage); // Function ServiceMessaging.ServiceMessagingListenerTestObject.TestFunctionWithMessage // Final|Native|Public|HasOutParms // @ game+0x3362d90
};
