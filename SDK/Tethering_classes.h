...
struct UDynamicCordRenderComponent : UCordRenderComponent {
	...
	void SetCordEndPointB(struct USceneComponent* EndPointB); // Function Tethering.DynamicCordRenderComponent.SetCordEndPointB // Final|Native|Public|BlueprintCallable // @ game+0x37e2b10
	void SetCordEndPointA(struct USceneComponent* EndPointA); // Function Tethering.DynamicCordRenderComponent.SetCordEndPointA // Final|Native|Public|BlueprintCallable // @ game+0x37e2a90
};
