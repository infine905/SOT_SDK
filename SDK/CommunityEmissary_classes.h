...
struct UCommunityEmissaryFlagComponent : UStaticMeshComponent {
	...
	void Multicast_UpdateCommunityEmissaryFlag(int32_t FlagDataIndex); // Function CommunityEmissary.CommunityEmissaryFlagComponent.Multicast_UpdateCommunityEmissaryFlag // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x4431cd0
};
