...
struct APetAIController : AAthenaAIController {
	...
	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function Pets.PetAIController.OnPerceptionUpdated // Native|Public // @ game+0x4642e20
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function Pets.PetAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4642d10
};
...
struct UPetHangoutSpotComponent : USceneComponent {
	...
	void OnRep_IsOwnerSinking(); // Function Pets.PetHangoutSpotComponent.OnRep_IsOwnerSinking // Final|Native|Private // @ game+0x4642fe0
};
...
struct APetItemInfo : ANonStorableItemInfo {
	...
	struct AActor* SpawnedForShip; // 0x548(0x08)
	float DropTraceDistance; // 0x550(0x04)
	float PointSearchRadius; // 0x554(0x04)
	char DropChannel; // 0x558(0x01)
	char UnknownData_559[0x7]; // 0x559(0x07)
	struct AActor* PetOwner; // 0x560(0x08)
	struct FPetCustomisation PetCustomisation; // 0x568(0x28)
	struct UPetUGCNameComponent* PetUGCNameComponent; // 0x590(0x08)
	char UnknownData_598[0x10]; // 0x598(0x10)

	void OnRep_PetOwner(); // Function Pets.PetItemInfo.OnRep_PetOwner // Final|Native|Private // @ game+0x46430a0
};
...
struct UPetOwnerComponent : UActorComponent {
	...
	void Server_RequestDismissal(); // Function Pets.PetOwnerComponent.Server_RequestDismissal // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x4643230
};
...
struct UPetsService : UObject {
	...
	void RemovePetFromActor(struct AActor* InOwner); // Function Pets.PetsService.RemovePetFromActor // Final|Native|Public|BlueprintCallable // @ game+0x46431a0
	void AddPetForActorAndWield(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner, bool IsWielded); // Function Pets.PetsService.AddPetForActorAndWield // Native|Public|BlueprintCallable // @ game+0x4642b70
	void AddPetForActor(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner); // Function Pets.PetsService.AddPetForActor // Final|Native|Public|BlueprintCallable // @ game+0x4642a00
};
...
struct AWieldablePet : ASkeletalMeshWieldableItem {
	...
	void OnRep_HungerReactAnimationState(); // Function Pets.WieldablePet.OnRep_HungerReactAnimationState // Final|Native|Private // @ game+0x4642fa0
	void OnRep_DropRequest(char PriorDropRequest); // Function Pets.WieldablePet.OnRep_DropRequest // Final|Native|Private // @ game+0x4642f20
};
