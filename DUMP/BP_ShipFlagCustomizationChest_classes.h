...
struct ABP_ShipFlagCustomizationChest_C : AShipFlagCustomizationChest {
	...
	void UserConstructionScript(); // Function BP_ShipFlagCustomizationChest.BP_ShipFlagCustomizationChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
