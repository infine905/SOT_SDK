...
struct ABP_FishingFish_Base_C : AFishingFish {
	...
	void UserConstructionScript(); // Function BP_FishingFish_Base.BP_FishingFish_Base_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
