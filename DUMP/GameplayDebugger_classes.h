...
struct UGameplayDebuggingComponent : UPrimitiveComponent {
	...
	void ServerReplicateData(uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingComponent.ServerReplicateData // Final|Exec|Native|Public // @ game+0x45e94f0
	void ServerDiscardNavmeshData(); // Function GameplayDebugger.GameplayDebuggingComponent.ServerDiscardNavmeshData // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45e94a0
	void ServerCollectNavmeshData(struct FVector_NetQuantize10 TargetLocation); // Function GameplayDebugger.GameplayDebuggingComponent.ServerCollectNavmeshData // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45e93d0
	void OnRep_UpdateNavmesh(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateNavmesh // Native|Public // @ game+0x45e93b0
	void OnRep_UpdateEQS(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateEQS // Native|Public // @ game+0x45e9390
	void OnRep_UpdateBlackboard(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateBlackboard // Native|Public // @ game+0x45e9370
	void OnRep_PathCorridorData(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_PathCorridorData // Native|Public // @ game+0x45e9350
	void OnCycleDetailsView(); // Function GameplayDebugger.GameplayDebuggingComponent.OnCycleDetailsView // Native|Public // @ game+0x45e9310
	void ClientEnableTargetSelection(bool bEnable); // Function GameplayDebugger.GameplayDebuggingComponent.ClientEnableTargetSelection // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45e9120
};
...
struct AGameplayDebuggingReplicator : AActor {
	...
	void ServerSetActorToDebug(struct AActor* InActor); // Function GameplayDebugger.GameplayDebuggingReplicator.ServerSetActorToDebug // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45e96e0
	void ServerReplicateMessage(struct AActor* Actor, uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingReplicator.ServerReplicateMessage // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45e95b0
	void OnRep_AutoActivate(); // Function GameplayDebugger.GameplayDebuggingReplicator.OnRep_AutoActivate // Native|Public // @ game+0x45e9330
	void ClientReplicateMessage(struct AActor* Actor, uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientReplicateMessage // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45e91e0
	void ClientEnableTargetSelection(bool bEnable, struct APlayerController* Context); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientEnableTargetSelection // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45e9020
	void ClientAutoActivate(); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientAutoActivate // Net|NetReliableNative|Event|Public|NetClient // @ game+0x45e9000
};
