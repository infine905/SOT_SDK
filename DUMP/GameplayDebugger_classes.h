...
struct UGameplayDebuggingComponent : UPrimitiveComponent {
	...
	void ServerReplicateData(uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingComponent.ServerReplicateData // Final|Exec|Native|Public // @ game+0x45ae5b0
	void ServerDiscardNavmeshData(); // Function GameplayDebugger.GameplayDebuggingComponent.ServerDiscardNavmeshData // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45ae560
	void ServerCollectNavmeshData(struct FVector_NetQuantize10 TargetLocation); // Function GameplayDebugger.GameplayDebuggingComponent.ServerCollectNavmeshData // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45ae490
	void OnRep_UpdateNavmesh(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateNavmesh // Native|Public // @ game+0x45ae470
	void OnRep_UpdateEQS(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateEQS // Native|Public // @ game+0x45ae450
	void OnRep_UpdateBlackboard(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_UpdateBlackboard // Native|Public // @ game+0x45ae430
	void OnRep_PathCorridorData(); // Function GameplayDebugger.GameplayDebuggingComponent.OnRep_PathCorridorData // Native|Public // @ game+0x45ae410
	void OnCycleDetailsView(); // Function GameplayDebugger.GameplayDebuggingComponent.OnCycleDetailsView // Native|Public // @ game+0x45ae3d0
	void ClientEnableTargetSelection(bool bEnable); // Function GameplayDebugger.GameplayDebuggingComponent.ClientEnableTargetSelection // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45ae1e0
};
...
struct AGameplayDebuggingReplicator : AActor {
	...
	void ServerSetActorToDebug(struct AActor* InActor); // Function GameplayDebugger.GameplayDebuggingReplicator.ServerSetActorToDebug // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45ae7a0
	void ServerReplicateMessage(struct AActor* Actor, uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingReplicator.ServerReplicateMessage // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x45ae670
	void OnRep_AutoActivate(); // Function GameplayDebugger.GameplayDebuggingReplicator.OnRep_AutoActivate // Native|Public // @ game+0x45ae3f0
	void ClientReplicateMessage(struct AActor* Actor, uint32_t InMessage, uint32_t DataView); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientReplicateMessage // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45ae2a0
	void ClientEnableTargetSelection(bool bEnable, struct APlayerController* Context); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientEnableTargetSelection // Net|NetReliableNative|Event|Public|NetClient|NetValidate // @ game+0x45ae0e0
	void ClientAutoActivate(); // Function GameplayDebugger.GameplayDebuggingReplicator.ClientAutoActivate // Net|NetReliableNative|Event|Public|NetClient // @ game+0x45ae0c0
};
