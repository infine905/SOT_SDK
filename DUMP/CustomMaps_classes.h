...
struct ACustomMap : ARenderToTextureMapBase {
	...
	void OnRep_FontUpdated(); // Function CustomMaps.CustomMap.OnRep_FontUpdated // Final|Native|Private // @ game+0x44a5fe0
	void OnRep_DisplayItem(); // Function CustomMaps.CustomMap.OnRep_DisplayItem // Final|Native|Private // @ game+0x44a5fc0
	void OnMapItemsUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function CustomMaps.CustomMap.OnMapItemsUpdate // Final|Native|Private // @ game+0x44a5ec0
};
