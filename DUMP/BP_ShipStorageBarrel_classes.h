...
struct ABP_ShipStorageBarrel_C : AActor {
	...
	void UserConstructionScript(); // Function BP_ShipStorageBarrel.BP_ShipStorageBarrel_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
