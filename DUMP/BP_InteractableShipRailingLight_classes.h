...
struct ABP_InteractableShipRailingLight_C : AShipInteractableLight {
	...
	void UserConstructionScript(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void LightStateChanged(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.LightStateChanged // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void ReceiveBeginPlay(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void ExecuteUbergraph_BP_InteractableShipRailingLight(int32_t EntryPoint); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.ExecuteUbergraph_BP_InteractableShipRailingLight //  // @ game+0x18f4c40
};
