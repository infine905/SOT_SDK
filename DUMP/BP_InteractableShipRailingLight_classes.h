...
struct ABP_InteractableShipRailingLight_C : AShipInteractableLight {
	...
	void UserConstructionScript(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void LightStateChanged(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.LightStateChanged // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ReceiveBeginPlay(); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_InteractableShipRailingLight(int32_t EntryPoint); // Function BP_InteractableShipRailingLight.BP_InteractableShipRailingLight_C.ExecuteUbergraph_BP_InteractableShipRailingLight //  // @ game+0x190d0a0
};
