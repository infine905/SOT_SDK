...
struct UFactionFlipMeshComponent : UStaticMeshComponent {
	...
	void OnRep_Streak(); // Function Factions.FactionFlipMeshComponent.OnRep_Streak // Final|Native|Public // @ game+0x483a020
	void OnRep_ServerTargetFlipped(); // Function Factions.FactionFlipMeshComponent.OnRep_ServerTargetFlipped // Final|Native|Public // @ game+0x483a000
};
...
struct UFactionInteractionVoteComponent : UInlineVotingInteractionComponent {
	float TurnHourglassInteractionHoldTime; // 0x160(0x04)
	int32_t WaitTimeSimilarityThresholdSeconds; // 0x164(0x04)
};
...
struct UFactionParticleComponent : UParticleSystemComponent {
	...
	void OnRep_Streak(); // Function Factions.FactionParticleComponent.OnRep_Streak // Final|Native|Public // @ game+0x483a040
	void OnRep_ServerMigrationEnded(); // Function Factions.FactionParticleComponent.OnRep_ServerMigrationEnded // Final|Native|Public // @ game+0x4839fe0
};
...
struct AFactionService : AActor {
	...
	void OnRep_FactionAlignedCrews(struct TArray<struct FCrewFactionEntry> PreviousCrews); // Function Factions.FactionService.OnRep_FactionAlignedCrews // Final|Native|Public|HasOutParms // @ game+0x4839f10
};
...
struct UFactionVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(struct TArray<struct FCrewMemberVotes> PreviousVotes); // Function Factions.FactionVoteConsumerBase.OnRep_Votes // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x483a060
};

// Class Factions.StartFactionVoyageVoteConsumer
// Size: 0x430 (Inherited: 0xd0)
...
struct AFactionVoteInteractionActor : AActor {
	...
	struct TArray<struct FFactionDisplayInfo> SaferSeasDisplayInfos; // 0x400(0x10)
	struct TArray<struct FFactionRequest> NoFactionInfoPtrs; // 0x410(0x10)
	struct TArray<struct FFactionRequest> FactionInfoPtrs; // 0x420(0x10)
	struct TArray<struct FFactionRequest> SaferSeasDisplayInfoPtrs; // 0x430(0x10)
	char UnknownData_440[0xa0]; // 0x440(0xa0)
};
...
struct UFactionVoteValidatorBase : UVoteValidatorInlineBase {
	...
	char UnknownData_44[0xa4]; // 0x44(0xa4)
	struct UFactionVoteConsumerBase* Consumer; // 0xe8(0x08)
	int32_t CurrentCompany; // 0xf0(0x04)
	float FlipTime; // 0xf4(0x04)
	char UnknownData_F8[0x8]; // 0xf8(0x08)
	struct AActor* OwningActor; // 0x100(0x08)

	void OnRep_CurrentCompany(); // Function Factions.FactionVoteValidatorBase.OnRep_CurrentCompany // Final|Native|Protected // @ game+0x4839ef0
};
...
struct UIsWearingCursePrerequisite : UInteractionPrerequisiteBase {
	bool AnyCurse; // 0x90(0x01)
	bool SkeletonCurse; // 0x91(0x01)
	bool GhostCurse; // 0x92(0x01)
...
struct UShipFactionCustomisation : UActorComponent {
	...
	void OnRep_FactionStreakData(); // Function Factions.ShipFactionCustomisation.OnRep_FactionStreakData // Final|Native|Private // @ game+0x4839fc0
};
