...
struct UFactionFlipMeshComponent : UStaticMeshComponent {
	...
	void OnRep_Streak(); // Function Factions.FactionFlipMeshComponent.OnRep_Streak // Final|Native|Public // @ game+0x47fd690
	void OnRep_ServerTargetFlipped(); // Function Factions.FactionFlipMeshComponent.OnRep_ServerTargetFlipped // Final|Native|Public // @ game+0x47fd670
};
...
struct UFactionParticleComponent : UParticleSystemComponent {
	...
	void OnRep_Streak(); // Function Factions.FactionParticleComponent.OnRep_Streak // Final|Native|Public // @ game+0x47fd6b0
	void OnRep_ServerMigrationEnded(); // Function Factions.FactionParticleComponent.OnRep_ServerMigrationEnded // Final|Native|Public // @ game+0x47fd650
};
...
struct AFactionService : AActor {
	...
	void OnRep_FactionAlignedCrews(struct TArray<struct FCrewFactionEntry> PreviousCrews); // Function Factions.FactionService.OnRep_FactionAlignedCrews // Final|Native|Public|HasOutParms // @ game+0x47fd580
};
...
struct UFactionVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(struct TArray<struct FCrewMemberVotes> PreviousVotes); // Function Factions.FactionVoteConsumerBase.OnRep_Votes // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x47fd6d0
};
...
struct UFactionVoteValidatorBase : UVoteValidatorInlineBase {
	...
	void OnRep_CurrentCompany(); // Function Factions.FactionVoteValidatorBase.OnRep_CurrentCompany // Final|Native|Protected // @ game+0x47fd560
};
...
struct UShipFactionCustomisation : UActorComponent {
	...
	void OnRep_FactionStreakData(); // Function Factions.ShipFactionCustomisation.OnRep_FactionStreakData // Final|Native|Private // @ game+0x47fd630
};
