...
struct ABP_Firework_Wieldable_C : AStaticMeshWieldableItem {
	...
	void UserConstructionScript(); // Function BP_Firework_Wieldable.BP_Firework_Wieldable_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
