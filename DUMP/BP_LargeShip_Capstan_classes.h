...
struct ABP_LargeShip_Capstan_C : ABP_Base_Capstan_C {
	...
	void UserConstructionScript(); // Function BP_LargeShip_Capstan.BP_LargeShip_Capstan_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
