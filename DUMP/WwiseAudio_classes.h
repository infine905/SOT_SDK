...
struct UWwiseEvent : UObject {
	...
	bool IsAudible(struct FVector SoundPosition, struct FVector ListenerPos, float AttenuationScaler); // Function WwiseAudio.WwiseEvent.IsAudible // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x5506a10
	float GetMaxAttenuation(); // Function WwiseAudio.WwiseEvent.GetMaxAttenuation // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x55069e0
	char GetDurationType(); // Function WwiseAudio.WwiseEvent.GetDurationType // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x55069a0
	float GetDurationMin(); // Function WwiseAudio.WwiseEvent.GetDurationMin // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5506970
	float GetDurationMax(); // Function WwiseAudio.WwiseEvent.GetDurationMax // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5506940
};
