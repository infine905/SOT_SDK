...
struct ABP_ShipClothingChest_C : APossessionsChest {
	...
	void UserConstructionScript(); // Function BP_ShipClothingChest.BP_ShipClothingChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
