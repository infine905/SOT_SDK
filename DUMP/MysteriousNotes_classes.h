...
struct UPlayerMysteriousNoteComponent : UActorComponent {
	...
	void TriggerNotesReceivedPopup(bool InCinematicSkipped); // Function MysteriousNotes.PlayerMysteriousNoteComponent.TriggerNotesReceivedPopup // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42b3740
	void Server_NoteCompletionStepReceived(struct APlayerController* InPlayerController, struct FName InCompletionID); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_NoteCompletionStepReceived // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x42b3640
	void Server_MarkNoteAsRead(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsRead // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x42b3540
	void Server_MarkNoteAsDeleted(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsDeleted // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x42b3440
	void OnRep_NoteData(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_NoteData // Final|RequiredAPI|Native|Private // @ game+0x42b3300
	void OnRep_BeenPossessed(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_BeenPossessed // Final|RequiredAPI|Native|Private // @ game+0x42b32e0
	void CustomServerUpdateDetailNotes(struct TArray<struct FNotesRemoteServiceNoteDetailModel> InNotes); // Function MysteriousNotes.PlayerMysteriousNoteComponent.CustomServerUpdateDetailNotes // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42b3240
	void AddFakeNote(struct FString NoteType, struct FString NoteTitle, struct FString NoteBody, struct TArray<struct FString> CompletionStrings); // Function MysteriousNotes.PlayerMysteriousNoteComponent.AddFakeNote // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42b3060
};
...
struct AWieldableMysteriousNote : ASkeletalMeshWieldableItem {
	...
	void OnTextCanvasUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function MysteriousNotes.WieldableMysteriousNote.OnTextCanvasUpdate // Final|Native|Private // @ game+0x42b3340
	void OnRep_NoteLayout(); // Function MysteriousNotes.WieldableMysteriousNote.OnRep_NoteLayout // Final|RequiredAPI|Native|Private // @ game+0x42b3320
};
