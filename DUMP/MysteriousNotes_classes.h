...
struct UPlayerMysteriousNoteComponent : UActorComponent {
	...
	void TriggerNotesReceivedPopup(bool InCinematicSkipped); // Function MysteriousNotes.PlayerMysteriousNoteComponent.TriggerNotesReceivedPopup // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42dd9c0
	void Server_NoteCompletionStepReceived(struct APlayerController* InPlayerController, struct FName InCompletionID); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_NoteCompletionStepReceived // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x42dd8c0
	void Server_MarkNoteAsRead(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsRead // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x42dd7c0
	void Server_MarkNoteAsDeleted(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsDeleted // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x42dd6c0
	void OnRep_NoteData(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_NoteData // Final|RequiredAPI|Native|Private // @ game+0x42dd580
	void OnRep_BeenPossessed(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_BeenPossessed // Final|RequiredAPI|Native|Private // @ game+0x42dd560
	void CustomServerUpdateDetailNotes(struct TArray<struct FNotesRemoteServiceNoteDetailModel> InNotes); // Function MysteriousNotes.PlayerMysteriousNoteComponent.CustomServerUpdateDetailNotes // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42dd4c0
	void AddFakeNote(struct FString NoteType, struct FString NoteTitle, struct FString NoteBody, struct TArray<struct FString> CompletionStrings); // Function MysteriousNotes.PlayerMysteriousNoteComponent.AddFakeNote // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x42dd2e0
};
...
struct AWieldableMysteriousNote : ASkeletalMeshWieldableItem {
	...
	void OnTextCanvasUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function MysteriousNotes.WieldableMysteriousNote.OnTextCanvasUpdate // Final|Native|Private // @ game+0x42dd5c0
	void OnRep_NoteLayout(); // Function MysteriousNotes.WieldableMysteriousNote.OnRep_NoteLayout // Final|RequiredAPI|Native|Private // @ game+0x42dd5a0
};
