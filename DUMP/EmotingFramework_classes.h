...
struct AEmoteDice : AActor {
	...
	void SetDiceMesh(char DiceType); // Function EmotingFramework.EmoteDice.SetDiceMesh // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
	void SendTelemetryData(struct FTransform OrientationUsed, int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.SendTelemetryData // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3674f40
	void RollDice(int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.RollDice // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3674e70
};
