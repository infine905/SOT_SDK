...
struct AEmoteDice : AActor {
	...
	void SetDiceMesh(char DiceType); // Function EmotingFramework.EmoteDice.SetDiceMesh // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void SendTelemetryData(struct FTransform OrientationUsed, int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.SendTelemetryData // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x36947d0
	void RollDice(int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.RollDice // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3694700
};
