...
struct UInvasionServiceInterface : UInterface {
	...
	struct FName GetCachedFactionIdentifierForMatchmakingCrew(struct FGuid InCrewId); // Function InvasionFramework.InvasionServiceInterface.GetCachedFactionIdentifierForMatchmakingCrew // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3c8aa70
	struct FName GetCachedFactionIdentifierForInvadingCrew(struct FGuid InCrewId); // Function InvasionFramework.InvasionServiceInterface.GetCachedFactionIdentifierForInvadingCrew // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3c8a9c0
	bool GetAggressivePassiveInvasionTargetLocationOffset(struct FGuid InCrewId, struct FVector OutTargetLocation); // Function InvasionFramework.InvasionServiceInterface.GetAggressivePassiveInvasionTargetLocationOffset // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3c8a8c0
	bool GetAggressivePassiveInvasionResurfaceDistanceForCrewId(struct FGuid InCrewId, float OutMinDistance, float OutMaxDistance); // Function InvasionFramework.InvasionServiceInterface.GetAggressivePassiveInvasionResurfaceDistanceForCrewId // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3c8a780
};
...
struct AInvasionBattleBounds : AActor {
	...
	void OnRep_InnerRadius(); // Function InvasionFramework.InvasionBattleBounds.OnRep_InnerRadius // Final|Native|Private // @ game+0x43a05c0
	void Multicast_ExplodeShip(struct AActor* Ship); // Function InvasionFramework.InvasionBattleBounds.Multicast_ExplodeShip // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x43a0540
};
...
struct UInvasionBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool ShouldAggressivePassiveTeleportUseEQS(); // Function InvasionFramework.InvasionBlueprintFunctionLibrary.ShouldAggressivePassiveTeleportUseEQS // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x43a0690
	float GetAggressivePassiveTeleportOffsetDistance(); // Function InvasionFramework.InvasionBlueprintFunctionLibrary.GetAggressivePassiveTeleportOffsetDistance // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x43a0510
};
...
struct AInvasionService : AActor {
	...
	void OnRep_ReplicatedInvasionCrewMusicStates(struct TArray<struct FReplicatedInvasionCrewMusicState> StaleMusicStates); // Function InvasionFramework.InvasionService.OnRep_ReplicatedInvasionCrewMusicStates // Final|Native|Private|HasOutParms // @ game+0x43a05e0
};
