...
struct ABP_StepsTrigger_C : ATavernStepsTrigger {
	...
	void UserConstructionScript(); // Function BP_StepsTrigger.BP_StepsTrigger_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void ReceiveBeginPlay(); // Function BP_StepsTrigger.BP_StepsTrigger_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_StepsTrigger(int32_t EntryPoint); // Function BP_StepsTrigger.BP_StepsTrigger_C.ExecuteUbergraph_BP_StepsTrigger //  // @ game+0x190d0a0
};
