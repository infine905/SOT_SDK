...
struct ABP_ArmoryChestInteraction_C : AArmoryChestInteraction {
	...
	void UserConstructionScript(); // Function BP_ArmoryChestInteraction.BP_ArmoryChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
