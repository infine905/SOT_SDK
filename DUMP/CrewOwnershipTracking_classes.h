...
struct UCrewOwnershipTrackingComponent : UActorComponent {
	...
	struct FGuid GetSpawningCrewIdByCopy(); // Function CrewOwnershipTracking.CrewOwnershipTrackingComponent.GetSpawningCrewIdByCopy // Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x373ef70
};
