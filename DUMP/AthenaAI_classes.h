...
struct UAthenaAIFormComponent : UActorComponent {
	...
	void OnRep_FormData(); // Function AthenaAI.AthenaAIFormComponent.OnRep_FormData // Final|Native|Private // @ game+0x4ccca10
};
...
struct UAISpawner : UDataAsset {
	...
	int32_t GetNumOfSpawnRequests(); // Function AthenaAI.AISpawner.GetNumOfSpawnRequests // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc620
};
...
struct AAICreatureCharacter : ACharacter {
	...
	void SetAIStrategy(struct UClass* InStrategy); // Function AthenaAI.AICreatureCharacter.SetAIStrategy // Native|Public|BlueprintCallable // @ game+0x3b9fbd0
	void OnRep_CurrentAIStrategy(struct UClass* OldAIStrategy); // Function AthenaAI.AICreatureCharacter.OnRep_CurrentAIStrategy // Final|Native|Protected // @ game+0x3b9fb30
	void Multicast_DespawnRPC(); // Function AthenaAI.AICreatureCharacter.Multicast_DespawnRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3b9fb10
	struct UClass* GetAIStrategy(); // Function AthenaAI.AICreatureCharacter.GetAIStrategy // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3b9fa50
};
...
struct AAICreatureSpline : AActor {
	...
	void OnRep_ShouldTickBeEnabled(); // Function AthenaAI.AICreatureSpline.OnRep_ShouldTickBeEnabled // Final|Native|Private // @ game+0x3b9fbb0
	void OnCreatureMovementStarted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementStarted // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void OnCreatureMovementCompleted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementCompleted // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void BeginCreatureMovement(); // Function AthenaAI.AICreatureSpline.BeginCreatureMovement // Final|Native|Protected|BlueprintCallable // @ game+0x3b9fa30
};
...
struct ALimitedInteractableAICreatureSpline : AAICreatureSpline {
	...
	void OnInteractionStartedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionStartedClient // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void OnInteractionCompletedServer(struct AActor* PlayerCharacter); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedServer // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void OnInteractionCompletedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedClient // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void OnInteractionCancelledClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCancelledClient // Event|Protected|BlueprintEvent // @ game+0x190d0a0
	void InteractCountRetrieved(int32_t InInteractedCount); // Function AthenaAI.LimitedInteractableAICreatureSpline.InteractCountRetrieved // Final|Native|Protected|BlueprintCallable // @ game+0x3b9fa90
};
...
struct AAIDebugSpawnActor : AActor {
	...
	void StartSpawning(); // Function AthenaAI.AIDebugSpawnActor.StartSpawning // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3c39960
};
...
struct UAthenaAIDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct TArray<struct FAIEncounterSpecification> SpawnMultipleAI(int32_t Count, struct UAIEncounterSettings* EncounterSettings, struct FVector Pos, struct FRotator Rot, float Delay, bool MakeAIPermanentlyNetRelevant, struct AActor* InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnMultipleAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c39640
	void SpawnAIWithSettings(struct UClass* AIType, struct UAthenaAIControllerParamsDataAsset* Skillset, struct ULoadoutAsset* Loadout, struct UAthenaAIFormDataAsset* Form, struct UClass* AIItemSpawnComponent, struct UClass* ClassId, struct UAthenaAIAmmoDataAsset* Ammo, struct FVector Pos, struct FRotator Rot, struct FName Region, struct AActor* TriggerActor, struct FName NavMeshOverride, float Delay); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAIWithSettings // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c38e80
	struct FAIEncounterSpecification SpawnAI(struct UAIEncounterSettings* EncounterSettings, struct FVector Pos, struct FRotator Rot, float Delay, bool MakeAIPermanentlyNetRelevant, struct AActor* InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c38b50
	void SetEnvQueryManagerMaxAllowedSeconds(float InMaxAllowedSeconds, struct UObject* QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SetEnvQueryManagerMaxAllowedSeconds // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c38a90
	void KillAllDebugAISpawners(); // Function AthenaAI.AthenaAIDebugFunctionLibrary.KillAllDebugAISpawners // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c38a70
	int32_t GetEnvQueryManagerNumRunningQueries(struct UObject* QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.GetEnvQueryManagerNumRunningQueries // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c389f0
	void EnableMaximumSightSettings(struct AAthenaAIController* AIController); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableMaximumSightSettings // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c38980
	void EnableBehaviorTreeLogging(struct UObject* WorldContext); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableBehaviorTreeLogging // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c38910
	void DespawnAIPawn(struct APawn* Pawn); // Function AthenaAI.AthenaAIDebugFunctionLibrary.DespawnAIPawn // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c388a0
	void CreateAISpawnerAtPosition(struct UObject* WorldContext, struct UAISpawner* SpawnerAsset, struct FVector Pos); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtPosition // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c387a0
	void CreateAISpawnerAtActor(struct UObject* WorldContext, struct UAISpawner* SpawnerAsset, struct AActor* SpawnLocationActor); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x3c386b0
	struct FVector CanProjectPointToNavigation(struct UObject* WorldContext, struct FVector Point, struct ANavigationData* NavData, struct UClass* FilterClass, struct FVector QueryExtent); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CanProjectPointToNavigation // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3c384e0
};
...
struct UAIFaunaSpawner : UAISpawner {
	...
	void SpawnFaunaGroup(); // Function AthenaAI.AIFaunaSpawner.SpawnFaunaGroup // Final|Native|Public|BlueprintCallable // @ game+0x3dd5f90
};
...
struct AAthenaAIControllerBase : AAIController {
	...
	void SetNamedControllerParam(struct FName ParamName, float Value); // Function AthenaAI.AthenaAIControllerBase.SetNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4cce2d0
	struct FWeightedProbabilityRangeOfRanges FindNamedWeightedRangesControllerParam(struct FName ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedWeightedRangesControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc3a0
	float FindNamedControllerParam(struct FName ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc2f0
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AthenaAI.AthenaAIControllerBase.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4ccbdc0
};
...
struct AAthenaAIController : AAthenaAIControllerBase {
	...
	void StopBehaviourLogic(); // Function AthenaAI.AthenaAIController.StopBehaviourLogic // Native|Public|BlueprintCallable // @ game+0x4cce830
	void SetPerceptionExpirationAgeForActor(struct AActor* Actor, float ExpirationAge, struct UClass* Sense); // Function AthenaAI.AthenaAIController.SetPerceptionExpirationAgeForActor // Final|Native|Public|BlueprintCallable // @ game+0x4cce430
	void RegisterSpawnTriggerActorAsStimulus(struct AActor* TriggerActor); // Function AthenaAI.AthenaAIController.RegisterSpawnTriggerActorAsStimulus // Native|Public|BlueprintCallable // @ game+0x4ccd650
	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function AthenaAI.AthenaAIController.OnPerceptionUpdated // Native|Public // @ game+0x4ccc810
	void OnNewlySpawned(); // Function AthenaAI.AthenaAIController.OnNewlySpawned // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void OnFinishDespawn(); // Function AthenaAI.AthenaAIController.OnFinishDespawn // Event|Public|BlueprintEvent // @ game+0x190d0a0
	bool IsActorPerceived(struct AActor* TargetActor); // Function AthenaAI.AthenaAIController.IsActorPerceived // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc6b0
	struct AActor* GetTargetActor(); // Function AthenaAI.AthenaAIController.GetTargetActor // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc680
	struct UAthenaAIPerceptionComponent* GetAthenaAIPerceptionComponent(); // Function AthenaAI.AthenaAIController.GetAthenaAIPerceptionComponent // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x4ccc5c0
	void GetAllSeenActors(struct TArray<struct AActor*> SeenActors); // Function AthenaAI.AthenaAIController.GetAllSeenActors // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4ccc500
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AthenaAI.AthenaAIController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4ccbcf0
};
...
struct AAthenaFaunaAIController : AAthenaAIController {
	...
	void SetDormancyCheckingEnabled(bool InDormancyCheckingEnabledInAutomation); // Function AthenaAI.AthenaFaunaAIController.SetDormancyCheckingEnabled // Final|Native|Public|BlueprintCallable // @ game+0x3dd5f00
	void LeaderDestroyed(struct AActor* Actor); // Function AthenaAI.AthenaFaunaAIController.LeaderDestroyed // Final|Native|Private // @ game+0x3dd5ba0
	struct AActor* GetLeader(); // Function AthenaAI.AthenaFaunaAIController.GetLeader // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3dd53c0
	float GetCourage(); // Function AthenaAI.AthenaFaunaAIController.GetCourage // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3dd50c0
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function AthenaAI.AthenaFaunaAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3dd5090
};
...
struct AFauna : AAICreatureCharacter {
	...
	void TestingSetWaterState(char NewInState); // Function AthenaAI.Fauna.TestingSetWaterState // Final|Native|Public|BlueprintCallable // @ game+0x3dd5fb0
	void OnRep_TargetTurnAngle(); // Function AthenaAI.Fauna.OnRep_TargetTurnAngle // Final|Native|Private // @ game+0x3dd5ee0
	void OnRep_IsPlayingStarvingAnim(); // Function AthenaAI.Fauna.OnRep_IsPlayingStarvingAnim // Final|Native|Private // @ game+0x3dd5ec0
	void OnRep_IsCalm(); // Function AthenaAI.Fauna.OnRep_IsCalm // Final|Native|Private // @ game+0x3dd5ea0
	void OnRep_IsAgitated(); // Function AthenaAI.Fauna.OnRep_IsAgitated // Final|Native|Private // @ game+0x3dd5e80
	void OnRep_InWaterState(); // Function AthenaAI.Fauna.OnRep_InWaterState // Final|Native|Private // @ game+0x3dd5e60
	void OnRep_CratedState(char PreviousCratedState); // Function AthenaAI.Fauna.OnRep_CratedState // Final|Native|Private|HasOutParms // @ game+0x3dd5dd0
	void Multicast_PlayPutInCrateEffectsRPC(struct AActor* Crate); // Function AthenaAI.Fauna.Multicast_PlayPutInCrateEffectsRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3dd5d40
	void Multicast_JustBeenFedRPC(struct AActor* FedBy); // Function AthenaAI.Fauna.Multicast_JustBeenFedRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3dd5cb0
	void Multicast_HightlightLeader(bool bIsLeader); // Function AthenaAI.Fauna.Multicast_HightlightLeader // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3dd5c20
	void GenerateNewRandomAnimationSeed(); // Function AthenaAI.Fauna.GenerateNewRandomAnimationSeed // Final|Native|Public|BlueprintCallable // @ game+0x3dd4f20
	void ActivateResponseRPC(float InTargetTurnAngle); // Function AthenaAI.Fauna.ActivateResponseRPC // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x3dd4e70
};
...
struct AAthenaSwimmingAIController : AAthenaAIController {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* InControllerParametersAsset, struct APawn* InPawn); // Function AthenaAI.AthenaSwimmingAIController.ApplyControllerParams // Final|Native|Public|BlueprintCallable // @ game+0x421fc10
};
...
struct ATinySharkExperience : AActor {
	...
	void TinySharkPawnDestroyed(struct AActor* InDestroyedActor); // Function AthenaAI.TinySharkExperience.TinySharkPawnDestroyed // Final|Native|Private // @ game+0x4241890
	void OnRep_TinySharkPawn(struct ASharkPawn* LastTinySharkPawn); // Function AthenaAI.TinySharkExperience.OnRep_TinySharkPawn // Native|Protected // @ game+0x4241620
	struct AShip* GetTrackedShip(); // Function AthenaAI.TinySharkExperience.GetTrackedShip // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4241600
	char GetCurrentState(); // Function AthenaAI.TinySharkExperience.GetCurrentState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x42415e0
	char GetActiveState(); // Function AthenaAI.TinySharkExperience.GetActiveState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x42415c0
};
...
struct ATinySharkService : AActor {
	...
	bool RequestTinySharkWithShip(struct AShip* InTrackedShip, int32_t OverrideControllerParamIndex, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithShip // Native|Public|BlueprintCallable // @ game+0x4241790
	bool RequestTinySharkWithLocation(struct FVector SpawnLocation, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x42416b0
	void DismissAllTinySharks(); // Function AthenaAI.TinySharkService.DismissAllTinySharks // Native|Public|BlueprintCallable // @ game+0x4241590
	bool CanSpawnTinySharkExperience(); // Function AthenaAI.TinySharkService.CanSpawnTinySharkExperience // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4241550
};
...
struct UAINameplateComponent : UNameplateComponent {
	...
	void OnRep_Title(); // Function AthenaAI.AINameplateComponent.OnRep_Title // Final|Native|Private // @ game+0x4ccca70
	void OnRep_DisplayNameAsString(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsString // Final|Native|Private // @ game+0x4ccc9f0
	void OnRep_DisplayName(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayName // Final|Native|Private // @ game+0x4ccc9d0
	void OnRep_DebugDisplayText(); // Function AthenaAI.AINameplateComponent.OnRep_DebugDisplayText // Final|Native|Private // @ game+0x4ccc9b0
};
...
struct APet : AAICreatureCharacter {
	...
	void SetExitTakeOffFlag(bool InExitTakeOffFlag); // Function AthenaAI.Pet.SetExitTakeOffFlag // Final|Native|Public|BlueprintCallable // @ game+0x467e600
	void OnShipDestroyed(struct AActor* InShip); // Function AthenaAI.Pet.OnShipDestroyed // Final|Native|Public // @ game+0x467e4a0
	void OnRep_RollRequest(); // Function AthenaAI.Pet.OnRep_RollRequest // Final|Native|Private // @ game+0x467e480
	void OnRep_ResetRollAndZOffset(); // Function AthenaAI.Pet.OnRep_ResetRollAndZOffset // Final|Native|Private // @ game+0x467e460
	void OnRep_PetTurnToFaceData(); // Function AthenaAI.Pet.OnRep_PetTurnToFaceData // Final|Native|Public // @ game+0x467e440
	void OnRep_PetOwner(); // Function AthenaAI.Pet.OnRep_PetOwner // Final|Native|Private // @ game+0x467e400
	void OnRep_PetIsSad(); // Function AthenaAI.Pet.OnRep_PetIsSad // Final|Native|Private // @ game+0x467e3e0
	void OnRep_PetInfo(); // Function AthenaAI.Pet.OnRep_PetInfo // Final|Native|Private // @ game+0x467e3c0
	void OnRep_PerchedInHangout(); // Function AthenaAI.Pet.OnRep_PerchedInHangout // Final|Native|Private // @ game+0x467e3a0
	void OnRep_MovementRequest(); // Function AthenaAI.Pet.OnRep_MovementRequest // Final|Native|Private // @ game+0x467e380
	void OnRep_InHangout(); // Function AthenaAI.Pet.OnRep_InHangout // Final|Native|Private // @ game+0x467e340
	void OnOwnerDestroyed(struct AActor* InOwner); // Function AthenaAI.Pet.OnOwnerDestroyed // Final|Native|Public // @ game+0x467e120
	void Multicast_DitherOut(); // Function AthenaAI.Pet.Multicast_DitherOut // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x467e100
	void Multicast_DitherIn(); // Function AthenaAI.Pet.Multicast_DitherIn // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x467e0e0
	float GetFloorMeshOffsetZ(); // Function AthenaAI.Pet.GetFloorMeshOffsetZ // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x467e0c0
};
...
struct UAIEncounterServiceInterface : UInterface {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression* Progression); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x4ccd540
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset* Skillset); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4ccd320
	void RegisterLoadedLoadout(struct ULoadoutAsset* Loadout); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x4ccd100
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset* Form); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4cccee0
	void RegisterLoadedEncounter(struct UAIEncounterSettings* Encounter); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x4ccccc0
};
...
struct UAICombatEncounterInterface : UInterface {
	...
	void OnVulnerabilityStateEntered(); // Function AthenaAI.AICombatEncounterInterface.OnVulnerabilityStateEntered // Native|Event|Public|BlueprintEvent // @ game+0x4ccca90
};
...
struct AAIEncounterService : AActor {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression* Progression); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x4ccd430
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset* Skillset); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4ccd210
	void RegisterLoadedLoadout(struct ULoadoutAsset* Loadout); // Function AthenaAI.AIEncounterService.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x4cccff0
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset* Form); // Function AthenaAI.AIEncounterService.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4cccdd0
	void RegisterLoadedEncounter(struct UAIEncounterSettings* Encounter); // Function AthenaAI.AIEncounterService.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x4cccba0
};
...
struct UAIManagerBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AItemInfo* SpawnItemFromAI(struct APawn* Pawn, struct UClass* ItemDesc); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.SpawnItemFromAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4cce5d0
	int32_t GetFrameCounter(); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.GetFrameCounter // Final|Native|Static|Public|BlueprintCallable // @ game+0x4ccc5f0
	void AddNameplateToAIWithLocalisedName(struct AActor* Actor, struct FText DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAIWithLocalisedName // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x4ccbc10
	void AddNameplateToAI(struct AActor* Actor, struct FString DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4ccbb40
};
...
struct UAIManagerServiceInterface : UInterface {
	...
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerServiceInterface.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x4cce760
	int32_t GetNumOfSpawnedPawns(); // Function AthenaAI.AIManagerServiceInterface.GetNumOfSpawnedPawns // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc650
};
...
struct AAIManagerService : AActor {
	...
	void TickService(float DeltaSeconds); // Function AthenaAI.AIManagerService.TickService // Final|Native|Public|BlueprintCallable // @ game+0x4cce850
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerService.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x4cce690
};
...
struct UDebugAIManagerServiceInterface : UInterface {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x4cce250
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4cce140
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x4cce030
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerServiceInterface.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4ccde00
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerServiceInterface.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4ccdcf0
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4ccdb60
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4ccda60
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4ccd960
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerServiceInterface.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x4ccbf60
};
...
struct ADebugAIManagerService : AAIManagerService {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerService.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x4cce1c0
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4cce0b0
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x4ccdfa0
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerService.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4ccdd70
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerService.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4ccdc70
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4ccdae0
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4ccd9e0
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerService.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4ccd8e0
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerService.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x4ccbe90
};
...
struct UAIPartsRetrievalComponent : UActorComponent {
	...
	void RequestNewAIParts(struct UAIPartsCategory* AssignedPartsCategory, int32_t PartsIndexToUse, int32_t TeamColorIndex); // Function AthenaAI.AIPartsRetrievalComponent.RequestNewAIParts // Final|Native|Public|BlueprintCallable // @ game+0x4ccd7e0
	void OnRep_ReplicatedAIPartsData(); // Function AthenaAI.AIPartsRetrievalComponent.OnRep_ReplicatedAIPartsData // Final|Native|Private // @ game+0x4ccca30
};
...
struct UAIPerPlayerSpawner : UAISpawner {
	...
	void PlayerDeath(struct AActor* Player); // Function AthenaAI.AIPerPlayerSpawner.PlayerDeath // Final|Native|Public // @ game+0x4cccab0
};
...
struct AAITargetActor : AActor {
	...
	void SetTargetEnabled(bool InEnabled); // Function AthenaAI.AITargetActor.SetTargetEnabled // Final|Native|Public|BlueprintCallable // @ game+0x4cce540
};
...
struct UAITargetWeaponInterface : UInterface {
	...
	bool FindAimConfigToHitTarget(struct FVector Target, bool CheckYaw, struct FRotator OutAimConfig); // Function AthenaAI.AITargetWeaponInterface.FindAimConfigToHitTarget // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc1b0
};
...
struct AAmbientWaterSpawnerManager : AActor {
	...
	void OnPlayerDeath(struct AActor* InActorDying); // Function AthenaAI.AmbientWaterSpawnerManager.OnPlayerDeath // Final|Native|Private // @ game+0x4ccc910
};
...
struct ABurrowCrack : AActor {
	...
	void OnRep_StartFadeAndLifeSpan(); // Function AthenaAI.BurrowCrack.OnRep_StartFadeAndLifeSpan // Final|Native|Public // @ game+0x4ccca50
	void OnLifeSpanPercentLeft(float PercentLeft); // Function AthenaAI.BurrowCrack.OnLifeSpanPercentLeft // Event|Public|BlueprintEvent // @ game+0x190d0a0
};
...
struct AAthenaAICharacterController : AAthenaAIController {
	...
	void SetOverridePrioritiseInteractablesBeforeEnemies(bool InPrioritiseInteractablesBeforeEnemies); // Function AthenaAI.AthenaAICharacterController.SetOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x4cce3a0
	void SetItemSpecificNamedControllerParam(struct UClass* InItemCategory, struct FName ParamName, float Value); // Function AthenaAI.AthenaAICharacterController.SetItemSpecificNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4ccde90
	void SetDisableTurningForTest(bool InDisableTurningForTest); // Function AthenaAI.AthenaAICharacterController.SetDisableTurningForTest // Final|Native|Public|BlueprintCallable // @ game+0x4ccdbe0
	void ClearOverridePrioritiseInteractablesBeforeEnemies(); // Function AthenaAI.AthenaAICharacterController.ClearOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x4ccc030
};
...
struct UAthenaAIPerceptionComponent : UAIPerceptionComponent {
	...
	bool IsPerceptionSenseEnabled(struct UClass* Sense); // Function AthenaAI.AthenaAIPerceptionComponent.IsPerceptionSenseEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc780
	bool IsAnyPerceptionEnabled(); // Function AthenaAI.AthenaAIPerceptionComponent.IsAnyPerceptionEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ccc750
	void EnablePerceptionSense(struct UClass* Sense, bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnablePerceptionSense // Final|Native|Public|BlueprintCallable // @ game+0x4ccc0e0
	void EnableAllPerception(bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnableAllPerception // Final|Native|Public|BlueprintCallable // @ game+0x4ccc050
};
...
struct UCoralShieldVFXComponent : UActorComponent {
	...
	void OnRep_CurrentCoralShieldRole(); // Function AthenaAI.CoralShieldVFXComponent.OnRep_CurrentCoralShieldRole // Final|Native|Private // @ game+0x4ccc990
};
...
struct ASpawnContextProviderZone : AActor {
	...
	void RemoveContextsFromTarget(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex); // Function AthenaAI.SpawnContextProviderZone.RemoveContextsFromTarget // Final|Native|Private // @ game+0x4ccd6e0
	void AddContextsToTarget(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex, bool InFromSweep, struct FHitResult InSweepResult); // Function AthenaAI.SpawnContextProviderZone.AddContextsToTarget // Final|Native|Private|HasOutParms // @ game+0x4ccb970
};
