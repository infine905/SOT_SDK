...
struct ABP_EquipmentChestInteraction_C : AEquipmentChestInteraction {
	...
	void UserConstructionScript(); // Function BP_EquipmentChestInteraction.BP_EquipmentChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
