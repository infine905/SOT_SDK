...
struct ABP_EquipmentChestInteraction_C : AEquipmentChestInteraction {
	...
	void UserConstructionScript(); // Function BP_EquipmentChestInteraction.BP_EquipmentChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
