...
struct UDeathSelfInteractionComponent : UInteractableComponent {
	...
	void SetGiveUpAvaliable(); // Function Reviving.DeathSelfInteractionComponent.SetGiveUpAvaliable // Final|Native|Private // @ game+0x3a4ee10
	void OnRep_HasGivenUp(); // Function Reviving.DeathSelfInteractionComponent.OnRep_HasGivenUp // Final|Native|Private // @ game+0x3a4ed70
};
...
struct UReviveComponent : UInteractableComponent {
	...
	void OnRep_ReviveState(char PreviousReviveState); // Function Reviving.ReviveComponent.OnRep_ReviveState // Final|Native|Private // @ game+0x3a4ed90
	void HandleOwningCharacterEndPlay(); // Function Reviving.ReviveComponent.HandleOwningCharacterEndPlay // Final|Native|Public // @ game+0x3a4ed50
};
