...
struct USirenAnimationInstance : UAnimInstance {
	...
	void ClearActiveAttack(); // Function SirensAnimation.SirenAnimationInstance.ClearActiveAttack // Final|Native|Public|BlueprintCallable // @ game+0x171e810
	void BeginNewAttack(); // Function SirensAnimation.SirenAnimationInstance.BeginNewAttack // Final|Native|Public|BlueprintCallable // @ game+0x171e7f0
};
