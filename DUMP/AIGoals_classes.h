...
struct UWhileBlackboardKeySetAIGoal : UAIGoal {
	...
	struct TArray<struct FString> GetAllowedBlackboardKeys(); // Function AIGoals.WhileBlackboardKeySetAIGoal.GetAllowedBlackboardKeys // Final|Native|Private|Const // @ game+0x2cf1a0
};
