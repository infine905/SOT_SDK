...
struct ABP_LargeShip_MapDeck_Dressing_01_a_C : ATrinketReplacementActor {
	...
	void UserConstructionScript(); // Function BP_LargeShip_MapDeck_Dressing_01_a.BP_LargeShip_MapDeck_Dressing_01_a_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void ReceiveBeginPlay(); // Function BP_LargeShip_MapDeck_Dressing_01_a.BP_LargeShip_MapDeck_Dressing_01_a_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_LargeShip_MapDeck_Dressing_01_a(int32_t EntryPoint); // Function BP_LargeShip_MapDeck_Dressing_01_a.BP_LargeShip_MapDeck_Dressing_01_a_C.ExecuteUbergraph_BP_LargeShip_MapDeck_Dressing_01_a //  // @ game+0x190d0a0
};
