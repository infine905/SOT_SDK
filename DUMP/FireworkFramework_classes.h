...
// Class FireworkFramework.FireworkSequentialDataAsset
// Size: 0x160 (Inherited: 0x150)
struct UFireworkSequentialDataAsset : UFireworkDataAsset {
	struct TArray<struct FFireworkSequentialSelectionType> FireworkSequentialSelections; // 0x150(0x10)
};
...
struct AFireworkItemInfo : AItemInfo {
	struct ULoadableFireworkComponent* LoadableProjectileComponent; // 0x530(0x08)
	struct FStringAssetReference FireworkDataAsset; // 0x538(0x10)
	int32_t GeneratedDataRNGSeed; // 0x548(0x04)
