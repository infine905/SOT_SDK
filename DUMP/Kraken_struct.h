...
struct FKrakenServiceParams {
	int32_t SaferSeasRollChance; // 0x00(0x04)
	char UnknownData_4[0x4]; // 0x04(0x04)
	struct UClass* KrakenType; // 0x08(0x08)
	struct FKrakenServiceSpawnParams SpawnParams; // 0x10(0x18)
	struct UKrakenParamsDataAsset* DefaultKrakenParams; // 0x28(0x08)
	struct TArray<struct FKrakenServiceShipParams> KrakenParams; // 0x30(0x10)
};
