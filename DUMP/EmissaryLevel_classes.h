...
struct UEmissaryActiveTableVisualiserComponent : UActorComponent {
	...
	void OnControllerEndPlay(char EndPlayReason); // Function EmissaryLevel.EmissaryActiveTableVisualiserComponent.OnControllerEndPlay // Final|Native|Private // @ game+0x42ff0a0
};
...
// Size: 0x788 (Inherited: 0x740)
struct AEmissaryFlotsamItemInfo : ABootyItemInfo {
	char UnknownData_740[0x8]; // 0x740(0x08)
	struct FCompanySpecificBootyReward HandInOwnFlotsamReward; // 0x748(0x18)
	struct FCompanySpecificBootyReward AlternateHandInOwnFlotsamReward; // 0x760(0x18)
	struct UClass* PermittedFlotsamPurchaseCompany; // 0x778(0x08)
	bool FlotsamCanBeDuplicated; // 0x780(0x01)
	char UnknownData_781[0x7]; // 0x781(0x07)
};
...
struct UEmissaryParticipantComponent : UActorComponent {
	...
	void OnRep_EmissaryLevel(); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_EmissaryLevel // Final|Native|Private // @ game+0x42ff1d0
	void OnRep_AffiliatedCompany(struct FName PreviousId); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_AffiliatedCompany // Final|Native|Private|HasOutParms // @ game+0x42ff120
};
...
struct UEmissaryShipAffiliationTrackerComponent : USceneComponent {
	...
	void OnRep_EmissaryCount(); // Function EmissaryLevel.EmissaryShipAffiliationTrackerComponent.OnRep_EmissaryCount // Final|Native|Private // @ game+0x42ff1b0
};
...
struct UEmissaryVoyageInlineVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(); // Function EmissaryLevel.EmissaryVoyageInlineVoteConsumerBase.OnRep_Votes // Final|Native|Private // @ game+0x42ff1f0
};
