...
struct UEmissaryActiveTableVisualiserComponent : UActorComponent {
	...
	void OnControllerEndPlay(char EndPlayReason); // Function EmissaryLevel.EmissaryActiveTableVisualiserComponent.OnControllerEndPlay // Final|Native|Private // @ game+0x43296b0
};
...
struct AEmissaryFlotsamItemInfo : ABootyItemInfo {
	char UnknownData_748[0x8]; // 0x748(0x08)
	struct FCompanySpecificBootyReward HandInOwnFlotsamReward; // 0x750(0x18)
	struct FCompanySpecificBootyReward AlternateHandInOwnFlotsamReward; // 0x768(0x18)
	struct UClass* PermittedFlotsamPurchaseCompany; // 0x780(0x08)
	bool FlotsamCanBeDuplicated; // 0x788(0x01)
	char UnknownData_789[0x7]; // 0x789(0x07)
};
...
struct UEmissaryFlotsamItemSpawnComponent : UItemSpawnComponent {
	...
	struct FVector GuildSessionEndedFlotsamOffset; // 0x518(0x0c)
	char UnknownData_524[0x3c]; // 0x524(0x3c)
};
...
struct UEmissaryParticipantComponent : UActorComponent {
	...
	void OnRep_EmissaryLevel(); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_EmissaryLevel // Final|Native|Private // @ game+0x43297e0
	void OnRep_AffiliatedCompany(struct FName PreviousId); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_AffiliatedCompany // Final|Native|Private|HasOutParms // @ game+0x4329730
};
...
struct UEmissaryShipAffiliationTrackerComponent : USceneComponent {
	...
	void OnRep_EmissaryCount(); // Function EmissaryLevel.EmissaryShipAffiliationTrackerComponent.OnRep_EmissaryCount // Final|Native|Private // @ game+0x43297c0
};
...
struct UEmissaryVoyageInlineVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(); // Function EmissaryLevel.EmissaryVoyageInlineVoteConsumerBase.OnRep_Votes // Final|Native|Private // @ game+0x4329800
};
