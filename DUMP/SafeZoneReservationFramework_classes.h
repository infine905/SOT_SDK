...
struct USafeZoneComponent : UCapsuleComponent {
	...
	void SafeZoneIsEmpty__DelegateSignature(); // DelegateFunction SafeZoneReservationFramework.SafeZoneComponent.SafeZoneIsEmpty__DelegateSignature // MulticastDelegate|Public|Delegate // @ game+0x18f4c40
	void OnRep_UpdateCollisionProfile(); // Function SafeZoneReservationFramework.SafeZoneComponent.OnRep_UpdateCollisionProfile // Final|Native|Private // @ game+0x471ad20
	void OnRep_EmptyStateChanged(); // Function SafeZoneReservationFramework.SafeZoneComponent.OnRep_EmptyStateChanged // Final|Native|Private // @ game+0x471ad00
	void DeactivateSafeZone(); // Function SafeZoneReservationFramework.SafeZoneComponent.DeactivateSafeZone // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x471ace0
	void DeactivateCollider(); // Function SafeZoneReservationFramework.SafeZoneComponent.DeactivateCollider // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x471acc0
	void ActivateSafeZone(); // Function SafeZoneReservationFramework.SafeZoneComponent.ActivateSafeZone // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x471aca0
};
