...
struct USafeZoneComponent : UCapsuleComponent {
	...
	void SafeZoneIsEmpty__DelegateSignature(); // DelegateFunction SafeZoneReservationFramework.SafeZoneComponent.SafeZoneIsEmpty__DelegateSignature // MulticastDelegate|Public|Delegate // @ game+0x190d0a0
	void OnRep_UpdateCollisionProfile(); // Function SafeZoneReservationFramework.SafeZoneComponent.OnRep_UpdateCollisionProfile // Final|Native|Private // @ game+0x4757710
	void OnRep_EmptyStateChanged(); // Function SafeZoneReservationFramework.SafeZoneComponent.OnRep_EmptyStateChanged // Final|Native|Private // @ game+0x47576f0
	void DeactivateSafeZone(); // Function SafeZoneReservationFramework.SafeZoneComponent.DeactivateSafeZone // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x47576d0
	void DeactivateCollider(); // Function SafeZoneReservationFramework.SafeZoneComponent.DeactivateCollider // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x47576b0
	void ActivateSafeZone(); // Function SafeZoneReservationFramework.SafeZoneComponent.ActivateSafeZone // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x4757690
};
