...
struct UAdventureOnDemandTaleFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool CompareOnDemandQuestResumeConditionMetReason(char Left, char Right); // Function AdventureOnDemandFramework.AdventureOnDemandTaleFunctionLibrary.CompareOnDemandQuestResumeConditionMetReason // Final|Native|Static|Public // @ game+0x4ac2ca0
};
...
struct UQuestTableAdventureOnDemandParams : UDataAsset {
	...
	struct UClass* InfoDiscoverTileCategory; // 0x140(0x08)
	struct TArray<struct FQuestTableBakedQuestDiscoverTile> BakedQuestDiscoverTiles; // 0x148(0x10)
};
