...
struct UAdventureOnDemandServiceParams : UDataAsset {
	...
	struct UGameEventsOnDemandBannerDataAsset* GameEventsOnDemandBannerDataAsset; // 0x60(0x08)
	struct UGameEventsOnDemandStatDataAsset* GameEventsOnDemandStatDataAsset; // 0x68(0x08)
	struct UClass* HuntersCallCompany; // 0x70(0x08)
};
...
struct UAdventureOnDemandTaleFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool CompareOnDemandQuestResumeConditionMetReason(char Left, char Right); // Function AdventureOnDemandFramework.AdventureOnDemandTaleFunctionLibrary.CompareOnDemandQuestResumeConditionMetReason // Final|Native|Static|Public // @ game+0x4b03470
};
...
struct UGameEventsOnDemandBannerDataAsset : UDataAsset {
	...
	struct TArray<struct FGameEventOnDemandCompanyBannerData> BannerTagsPerCompany; // 0x188(0x10)
};
...
struct UQuestTableAdventureOnDemandParams : UDataAsset {
	struct TArray<struct UInteractionPrerequisiteBase*> NewPlayerTutorialPrerequisites; // 0x28(0x10)
	struct TArray<struct FQuestTableCompanyTutorialPrerequisites> NewPlayerCompanyTutorialPrerequisites; // 0x38(0x10)
	...
	struct UClass* InfoDiscoverTileCategory; // 0x160(0x08)
	struct TArray<struct FQuestTableBakedQuestDiscoverTile> BakedQuestDiscoverTiles; // 0x168(0x10)
};
