...
struct ABP_LargeShip_StandardHull_Art_Doors_C : AActor {
	...
	void UserConstructionScript(); // Function BP_LargeShip_StandardHull_Art_Doors.BP_LargeShip_StandardHull_Art_Doors_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
