...
struct ATaleNote : ASkeletalMeshWieldableItem {
	...
	void OnTextCanvasUpdate(struct UCanvas* InCanvas, int32_t InWidth, int32_t InHeight); // Function TaleNotes.TaleNote.OnTextCanvasUpdate // Final|Native|Protected // @ game+0x4764300
};
