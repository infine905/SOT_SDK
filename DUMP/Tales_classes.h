...
struct UTaleQuestStepInterface : UInterface {
	...
	void Signal(); // Function Tales.TaleQuestStepInterface.Signal // Native|Public // @ game+0x3f6dfd0
};
...
struct UTaleQuestCargoRunContractsService : UTaleQuestService {
	...
	struct UTaleQuestCargoRunContract* GetContract(struct FGuid Guid); // Function Tales.TaleQuestCargoRunContractsService.GetContract // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x3f69490
	struct FGuid AddContract(struct TArray<struct UClass*> InItems, struct AActor* InCollectFromNPC, struct AActor* InDeliverToNPC, int32_t InTimeLimitInMinutes, struct FText InDeliveryHintLocationText); // Function Tales.TaleQuestCargoRunContractsService.AddContract // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x3f66c90
};
...
struct UTaleQuestMerchantContractsService : UTaleQuestService {
	...
	struct UTaleQuestMerchantContract* GetContract(struct FGuid Guid); // Function Tales.TaleQuestMerchantContractsService.GetContract // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x3f69530
	struct FGuid AddContract(struct TArray<struct FTaleQuestDeliveryRequest> Requests, struct FName InDeliveryDestination, float InTimeLimit); // Function Tales.TaleQuestMerchantContractsService.AddContract // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3f66ec0
};
...
struct UTaleQuestQueryableStatesReadInterface : UInterface {
	...
	bool ReadDataInt(struct UClass* DataID, int32_t OutDataContent); // Function Tales.TaleQuestQueryableStatesReadInterface.ReadDataInt // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3f6ced0
	bool ReadDataBool(struct UClass* DataID, bool OutDataContent); // Function Tales.TaleQuestQueryableStatesReadInterface.ReadDataBool // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3f6cde0
	bool CanDataBeRead(struct UClass* DataID); // Function Tales.TaleQuestQueryableStatesReadInterface.CanDataBeRead // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3f67b80
};
...
struct UTaleQuestSelectorServiceBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void SetDebugVoyageSeed(int32_t Seed); // Function Tales.TaleQuestSelectorServiceBlueprintFunctionLibrary.SetDebugVoyageSeed // Final|Native|Static|Public|BlueprintCallable // @ game+0x3f6d450
	void ResetVoyageDebugSeed(); // Function Tales.TaleQuestSelectorServiceBlueprintFunctionLibrary.ResetVoyageDebugSeed // Final|Native|Static|Public|BlueprintCallable // @ game+0x3f6d280
};
...
struct UCutsceneResponsesTaleService : UTaleQuestService {
	...
	void TrackResponseCoordinator(struct UCutsceneResponseCoordinator* Coordinator); // Function Tales.CutsceneResponsesTaleService.TrackResponseCoordinator // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3f6f4c0
	struct UCutsceneResponseSheet* StartCutsceneResponseSheet(struct AActor* TargetActor, TScriptInterface<struct UCutsceneResponsePlayerInterface> CutsceneResponsePlayer, struct UClass* ResponseSheetClass); // Function Tales.CutsceneResponsesTaleService.StartCutsceneResponseSheet // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3f6e660
	void ClearAllActiveResponseSheets(); // Function Tales.CutsceneResponsesTaleService.ClearAllActiveResponseSheets // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3f67d40
	void AddResponseSheetRelevantActor(struct AActor* Actor); // Function Tales.CutsceneResponsesTaleService.AddResponseSheetRelevantActor // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3f672f0
};
...
struct UTaleQuestEQSService : UTaleQuestService {
	...
	void AddVectorParam(struct FName ParamName, struct FVector VectorParam); // Function Tales.TaleQuestEQSService.AddVectorParam // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3f67430
	void AddFloatParam(struct FName ParamName, float FloatParam); // Function Tales.TaleQuestEQSService.AddFloatParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x3f67140
	void AddActorParam(struct FName ParamName, struct AActor* ActorParam); // Function Tales.TaleQuestEQSService.AddActorParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x3f66bc0
};
...
struct UTaleQuestInteractionPreventionService : UTaleQuestService {
	...
	void PreventInteractionWithTargetActor(struct AActor* Actor); // Function Tales.TaleQuestInteractionPreventionService.PreventInteractionWithTargetActor // Final|Native|Public // @ game+0x3f6c4a0
	void EnableInteractionWithTargetActor(struct AActor* Actor); // Function Tales.TaleQuestInteractionPreventionService.EnableInteractionWithTargetActor // Final|Native|Public // @ game+0x3f68400
};
...
struct UTaleQuestSelectorService : UTaleQuestService {
	...
	int32_t GetRandomIntegerInRange(int32_t Minimum, int32_t Maximum); // Function Tales.TaleQuestSelectorService.GetRandomIntegerInRange // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x3f6a040
	float GetRandomFloatInRange(float Minimum, float Maximum); // Function Tales.TaleQuestSelectorService.GetRandomFloatInRange // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x3f69f70
};
...
struct UTaleQuestToggleInteractionDescriptionService : UTaleQuestService {
	...
	void TargetActorInteractionToEnable(struct AActor* Actor); // Function Tales.TaleQuestToggleInteractionDescriptionService.TargetActorInteractionToEnable // Final|Native|Public // @ game+0x3f6edf0
	void TargetActorInteractionToDisable(struct AActor* Actor); // Function Tales.TaleQuestToggleInteractionDescriptionService.TargetActorInteractionToDisable // Final|Native|Public // @ game+0x3f6ed70
};
...
struct USelectNamedPointStepDesc : UTaleQuestStepDesc {
	...
	struct TArray<struct FString> GetNamedPointsGroups(); // Function Tales.SelectNamedPointStepDesc.GetNamedPointsGroups // Final|Native|Public|Const // @ game+0x3f69be0
};
...
struct UActorOfInterestTaleFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void GetActorsOfInterestForId(struct UClass* ActorsOfInterestId, struct TArray<struct AActor*> Actors); // Function Tales.ActorOfInterestTaleFunctionLibrary.GetActorsOfInterestForId // Final|Native|Public|HasOutParms|Const // @ game+0x3f692b0
	struct TArray<struct AActor*> GetActorsOfInterest(struct TArray<struct UClass*> ActorsOfInterestId); // Function Tales.ActorOfInterestTaleFunctionLibrary.GetActorsOfInterest // Final|Native|Public|HasOutParms|Const // @ game+0x3f691a0
	struct AActor* GetActorOfInterest(struct UClass* ActorOfInterestId); // Function Tales.ActorOfInterestTaleFunctionLibrary.GetActorOfInterest // Final|Native|Public|HasOutParms|Const // @ game+0x3f69040
};
...
struct UTaleQuestActorFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct AActor* SpawnActor(struct UClass* What, struct FTransform Where, bool TrackActor, bool AutomaticallyGatherForMigration); // Function Tales.TaleQuestActorFunctionLibrary.SpawnActor // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults // @ game+0x3f6dff0
	struct AActor* ResolveActor(struct AActor* ActorReference); // Function Tales.TaleQuestActorFunctionLibrary.ResolveActor // Final|RequiredAPI|Native|Public|HasOutParms|Const // @ game+0x3f6d2a0
	TScriptInterface<struct UInterface> GetInterface(struct AActor* Actor, struct UClass* InterfaceClass); // Function Tales.TaleQuestActorFunctionLibrary.GetInterface // Final|RequiredAPI|Native|Static|Public|HasOutParms // @ game+0x3f697c0
	struct UActorComponent* GetComponentByClass(struct AActor* Actor, struct UClass* ComponentClass); // Function Tales.TaleQuestActorFunctionLibrary.GetComponentByClass // Final|RequiredAPI|Native|Public|HasOutParms|Const // @ game+0x3f693c0
	struct FTransform GetActorTransform(struct AActor* Actor); // Function Tales.TaleQuestActorFunctionLibrary.GetActorTransform // Final|RequiredAPI|Native|Static|Public|HasDefaults // @ game+0x3f690e0
};
...
struct UTaleQuestAnimationStepFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FPossessableSequence MakePosseableSequence(struct AActor* ActorToPossess, struct FString TrackNameToPossess); // Function Tales.TaleQuestAnimationStepFunctionLibrary.MakePosseableSequence // Final|Native|Static|Public // @ game+0x3f6b4b0
	float GetPlayLength(struct UAnimSequenceBase* Anim); // Function Tales.TaleQuestAnimationStepFunctionLibrary.GetPlayLength // Final|Native|Public|Const // @ game+0x3f69ed0
};
...
struct UTaleQuestAudioFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void StopMusic(TScriptInterface<struct UMusicZoneInterface> MusicZone); // Function Tales.TaleQuestAudioFunctionLibrary.StopMusic // Final|Native|Public|Const // @ game+0x3f6e8a0
	void StartMusic(TScriptInterface<struct UMusicZoneInterface> MusicZone); // Function Tales.TaleQuestAudioFunctionLibrary.StartMusic // Final|Native|Public|Const // @ game+0x3f6e780
	void SetEmitterSwitch(TScriptInterface<struct UEmitterManipulatorInterface> MusicZone, struct FName SwitchGroup, struct FName Value); // Function Tales.TaleQuestAudioFunctionLibrary.SetEmitterSwitch // Final|Native|Public|HasOutParms|Const // @ game+0x3f6d8f0
	void SetEmitterRTPC(TScriptInterface<struct UEmitterManipulatorInterface> MusicZone, struct FName RTPC, float Value); // Function Tales.TaleQuestAudioFunctionLibrary.SetEmitterRTPC // Final|Native|Public|HasOutParms|Const // @ game+0x3f6d7c0
	void PlayOneShot(TScriptInterface<struct UMusicZoneInterface> MusicZone, int32_t OneShotIndex); // Function Tales.TaleQuestAudioFunctionLibrary.PlayOneShot // Final|Native|Public|Const // @ game+0x3f6c3c0
};
...
struct UTaleQuestCharacterFunctionStepLibrary : UTaleQuestFunctionStepLibrary {
	...
	void EnableCharacterInput(struct AActor* Character); // Function Tales.TaleQuestCharacterFunctionStepLibrary.EnableCharacterInput // Final|Native|Static|Public // @ game+0x3f68390
	void DisableCharacterInput(struct AActor* Character); // Function Tales.TaleQuestCharacterFunctionStepLibrary.DisableCharacterInput // Final|Native|Static|Public // @ game+0x3f67eb0
};
...
struct UTaleQuestClassFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool IsChildOf(struct UClass* Class, struct UClass* BaseClass); // Function Tales.TaleQuestClassFunctionLibrary.IsChildOf // Final|Native|Public|Const // @ game+0x3f6aa70
	bool Equals_Class(struct UClass* Left, struct UClass* Right); // Function Tales.TaleQuestClassFunctionLibrary.Equals_Class // Final|Native|Public|Const // @ game+0x3f68770
};
...
struct UTaleQuestClientCommandFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void PushStopMontageAnimationCommand(struct AClientCommandHandler* CommandHandler, struct AActor* TargetActor, struct UAnimMontage* Montage, float BlendOutTime); // Function Tales.TaleQuestClientCommandFunctionLibrary.PushStopMontageAnimationCommand // Final|Native|Public|Const // @ game+0x3f6cad0
	float PushPlayMontageAnimationCommand(struct AClientCommandHandler* CommandHandler, struct AActor* TargetActor, struct UAnimMontage* Montage, float PlayRate, float Position); // Function Tales.TaleQuestClientCommandFunctionLibrary.PushPlayMontageAnimationCommand // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3f6c790
	struct AClientCommandHandler* CreateCommandHandler(); // Function Tales.TaleQuestClientCommandFunctionLibrary.CreateCommandHandler // Final|Native|Public|Const // @ game+0x3f67e00
};
...
struct UTaleQuestConversionFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FString TextToString(struct FText Text); // Function Tales.TaleQuestConversionFunctionLibrary.TextToString // Final|Native|Public|HasOutParms|Const // @ game+0x3f6ef50
	struct FName TextToName(struct FText Text); // Function Tales.TaleQuestConversionFunctionLibrary.TextToName // Final|Native|Public|HasOutParms|Const // @ game+0x3f6ee70
	struct FText StringToText(struct FString String); // Function Tales.TaleQuestConversionFunctionLibrary.StringToText // Final|Native|Public|Const // @ game+0x3f6eb20
	struct FName StringToName(struct FString String); // Function Tales.TaleQuestConversionFunctionLibrary.StringToName // Final|Native|Public|Const // @ game+0x3f6ea60
	struct FText NameToText(struct FName Name); // Function Tales.TaleQuestConversionFunctionLibrary.NameToText // Final|Native|Public|HasOutParms|Const // @ game+0x3f6bf70
	struct FString NameToString(struct FName Name); // Function Tales.TaleQuestConversionFunctionLibrary.NameToString // Final|Native|Public|HasOutParms|Const // @ game+0x3f6be80
	struct FString IntToString(int32_t Int); // Function Tales.TaleQuestConversionFunctionLibrary.IntToString // Final|Native|Public|Const // @ game+0x3f6a7f0
	float IntToFloat(int32_t Int); // Function Tales.TaleQuestConversionFunctionLibrary.IntToFloat // Final|Native|Public|Const // @ game+0x3f6a770
	struct FString FloatToString(float Float); // Function Tales.TaleQuestConversionFunctionLibrary.FloatToString // Final|Native|Public|Const // @ game+0x3f68d00
	int32_t FloatToInt(float Float); // Function Tales.TaleQuestConversionFunctionLibrary.FloatToInt // Final|Native|Public|Const // @ game+0x3f68c80
	struct FString BoolToString(bool Bool); // Function Tales.TaleQuestConversionFunctionLibrary.BoolToString // Final|Native|Public|Const // @ game+0x3f679c0
};
...
struct UTaleQuestCoreFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct AGameState* GetGameState(); // Function Tales.TaleQuestCoreFunctionLibrary.GetGameState // Final|Native|Public|Const // @ game+0x3f69630
};
...
struct UTaleQuestCrewFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void ClearOverrideSpawnTeleportLocationActor(struct FGuid CrewId); // Function Tales.TaleQuestCrewFunctionLibrary.ClearOverrideSpawnTeleportLocationActor // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults // @ game+0x3f67d60
	void AddOverrideSpawnTeleportLocationActor(struct FGuid CrewId, struct AActor* InActor); // Function Tales.TaleQuestCrewFunctionLibrary.AddOverrideSpawnTeleportLocationActor // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults // @ game+0x3f67210
	void AddCrewShipToCrew(struct FGuid CrewId, struct AShip* Ship); // Function Tales.TaleQuestCrewFunctionLibrary.AddCrewShipToCrew // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults // @ game+0x3f67060
};
...
struct UTaleQuestCurveFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	float SampleCurve_Float(struct UCurveFloat* Curve, float Time); // Function Tales.TaleQuestCurveFunctionLibrary.SampleCurve_Float // Final|Native|Public|Const // @ game+0x3f6d380
};
...
struct UTaleQuestCutscenesFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void FireEventCutsceneTargetReady(struct AActor* TargetRetrievalActor, struct AActor* TargetActor); // Function Tales.TaleQuestCutscenesFunctionLibrary.FireEventCutsceneTargetReady // Final|RequiredAPI|Native|Static|Public // @ game+0x3f68ab0
};
...
struct UTaleQuestDamageableInterfaceFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void SetVulnerability(TScriptInterface<struct UDamageableVulnerabilityInterface> DamageableVulnerabilityInterface, struct UClass* DamagerType, float DamageMultipler); // Function Tales.TaleQuestDamageableInterfaceFunctionLibrary.SetVulnerability // Final|Native|Public // @ game+0x3f6dea0
	void SetDefaultVulnerability(TScriptInterface<struct UDamageableVulnerabilityInterface> DamageableVulnerabilityInterface, float DefaultVulnerability); // Function Tales.TaleQuestDamageableInterfaceFunctionLibrary.SetDefaultVulnerability // Final|Native|Public // @ game+0x3f6d4c0
};
...
struct UTaleQuestDeathFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WaitForParticipantDeath(struct ACharacter* DyingParticipant, struct FDamageInstance FinalBlow, char DeathType); // Function Tales.TaleQuestDeathFunctionLibrary.WaitForParticipantDeath // Final|Native|Public|HasOutParms // @ game+0x3f6f860
	void Kill(TScriptInterface<struct UKillableCharacterInterface> KillableCharacter, char DeathType); // Function Tales.TaleQuestDeathFunctionLibrary.Kill // Final|Native|Public|HasOutParms|Const // @ game+0x3f6adf0
};
...
struct UTaleQuestDialogueFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WatchForNPCDialogueInteractionWithQueryableState(struct AActor* DialogueActor, struct ACharacter* InteractingCharacter, struct UClass* DataID); // Function Tales.TaleQuestDialogueFunctionLibrary.WatchForNPCDialogueInteractionWithQueryableState // Final|Native|Public|HasOutParms // @ game+0x3f6fba0
	void WatchForNPCDialogueInteraction(struct AActor* DialogueActor, struct ACharacter* InteractingCharacter, struct FName DialogueEvent); // Function Tales.TaleQuestDialogueFunctionLibrary.WatchForNPCDialogueInteraction // Final|Native|Public|HasOutParms // @ game+0x3f6fa80
	void WaitForNPCDialogueInteractionWithQueryableState(struct AActor* DialogueActor, struct UClass* ExpectedDataID, struct ACharacter* InteractingCharacter); // Function Tales.TaleQuestDialogueFunctionLibrary.WaitForNPCDialogueInteractionWithQueryableState // Final|Native|Public|HasOutParms // @ game+0x3f6f750
	void SetDialogueInteractionPrompt(struct AClientCommandHandler* CommandHandler, struct UNPCDialogComponent* DialogueComponent, struct FText Prompt); // Function Tales.TaleQuestDialogueFunctionLibrary.SetDialogueInteractionPrompt // Final|Native|Public|HasOutParms|Const // @ game+0x3f6d690
	void SetDialogueInteractionEnabled(TScriptInterface<struct UNPCDialogComponentInterface> DialogueComponent, bool Enabled); // Function Tales.TaleQuestDialogueFunctionLibrary.SetDialogueInteractionEnabled // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3f6d5a0
};
...
struct UTaleQuestEmoteFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void PushIntoEmoteActionState(struct AActor* Target, struct UEmoteInfo* EmoteInfo, bool ForcedEmote); // Function Tales.TaleQuestEmoteFunctionLibrary.PushIntoEmoteActionState // Final|Native|Public|Const // @ game+0x3f6c520
};
...
struct UTaleQuestFloatMathsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	float Subtract_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Subtract_Float // Final|Native|Public|Const // @ game+0x3f6ebf0
	float RandRange(float Min, float Max); // Function Tales.TaleQuestFloatMathsFunctionLibrary.RandRange // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3f6cc20
	bool NotEquals_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.NotEquals_Float // Final|Native|Public|Const // @ game+0x3f6c0f0
	float Multiply_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Multiply_Float // Final|Native|Public|Const // @ game+0x3f6bd00
	float Modulus_Float(float Left, float Right, float Reminder); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Modulus_Float // Final|Native|Public|HasOutParms|Const // @ game+0x3f6baf0
	bool LessThanOrEqual_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.LessThanOrEqual_Float // Final|Native|Public|Const // @ game+0x3f6b110
	bool LessThan(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.LessThan // Final|Native|Public|Const // @ game+0x3f6aed0
	bool GreaterThanOrEqual_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.GreaterThanOrEqual_Float // Final|Native|Public|Const // @ game+0x3f6a4e0
	bool GreaterThan(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.GreaterThan // Final|Native|Public|Const // @ game+0x3f6a2a0
	bool Equals_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Equals_Float // Final|Native|Public|Const // @ game+0x3f68830
	float Divide_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Divide_Float // Final|Native|Public|Const // @ game+0x3f68150
	float Add_Float(float Left, float Right); // Function Tales.TaleQuestFloatMathsFunctionLibrary.Add_Float // Final|Native|Public|Const // @ game+0x3f67620
};
...
struct UTaleQuestHealthFunctionStepLibrary : UTaleQuestFunctionStepLibrary {
	...
	void SetMaxHealth(TScriptInterface<struct UHealthInterface> HealthInterface, float Health); // Function Tales.TaleQuestHealthFunctionStepLibrary.SetMaxHealth // Final|Native|Public|Const // @ game+0x3f6ddc0
	void SetHealthChangeEnabled(TScriptInterface<struct UHealthInterface> HealthInterface, bool Enabled); // Function Tales.TaleQuestHealthFunctionStepLibrary.SetHealthChangeEnabled // Final|Native|Public|Const // @ game+0x3f6dc10
	void SetHealth(TScriptInterface<struct UHealthInterface> HealthInterface, float Health, char Reason); // Function Tales.TaleQuestHealthFunctionStepLibrary.SetHealth // Final|Native|Static|Public // @ game+0x3f6db00
	void ResetToMaxHealth(TScriptInterface<struct UHealthInterface> HealthInterface); // Function Tales.TaleQuestHealthFunctionStepLibrary.ResetToMaxHealth // Final|Native|Public|Const // @ game+0x3f6d1e0
	float GetMaxHealth(TScriptInterface<struct UHealthInterface> HealthInterface); // Function Tales.TaleQuestHealthFunctionStepLibrary.GetMaxHealth // Final|Native|Public|Const // @ game+0x3f698a0
	float GetHealth(TScriptInterface<struct UHealthInterface> HealthInterface); // Function Tales.TaleQuestHealthFunctionStepLibrary.GetHealth // Final|Native|Static|Public // @ game+0x3f69720
};
...
struct UTaleQuestIntMathsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	int32_t Subtract_Int(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Subtract_Int // Final|Native|Static|Public // @ game+0x3f6ecb0
	bool NotEquals(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.NotEquals // Final|Native|Static|Public // @ game+0x3f6c030
	int32_t Multiply_Int(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Multiply_Int // Final|Native|Static|Public // @ game+0x3f6bdc0
	int32_t Modulus_Int(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Modulus_Int // Final|Native|Static|Public // @ game+0x3f6bc30
	bool LessThanOrEqual(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.LessThanOrEqual // Final|Native|Static|Public // @ game+0x3f6b050
	bool LessThan(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.LessThan // Final|Native|Static|Public // @ game+0x3f6af90
	void Increment_Int(int32_t Value); // Function Tales.TaleQuestIntMathsFunctionLibrary.Increment_Int // Final|Native|Static|Public|HasOutParms // @ game+0x3f6a5a0
	bool GreaterThanOrEqual(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.GreaterThanOrEqual // Final|Native|Static|Public // @ game+0x3f6a420
	bool GreaterThan(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.GreaterThan // Final|Native|Static|Public // @ game+0x3f6a360
	bool Equals(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Equals // Final|Native|Static|Public // @ game+0x3f685b0
	int32_t Divide_Int(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Divide_Int // Final|Native|Static|Public // @ game+0x3f68230
	void Decrement_Int(int32_t Value); // Function Tales.TaleQuestIntMathsFunctionLibrary.Decrement_Int // Final|Native|Static|Public|HasOutParms // @ game+0x3f67e30
	int32_t Add_Int(int32_t Left, int32_t Right); // Function Tales.TaleQuestIntMathsFunctionLibrary.Add_Int // Final|Native|Static|Public // @ game+0x3f676e0
};
...
struct UTaleQuestItemFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WaitForItemHandIn(TScriptInterface<struct UNPCCustomItemPurchaseInterface> NPC, struct UClass* Item, TScriptInterface<struct UVoyageParticipantInterface> HandInParticipant); // Function Tales.TaleQuestItemFunctionLibrary.WaitForItemHandIn // Final|Native|Public|HasOutParms // @ game+0x3f6f620
	struct AItemInfo* SpawnAndWieldItem(struct AActor* Wielder, struct UClass* Item, bool TrackItem, bool MarkItemAsCritical, struct FText CritialItemLostMessage); // Function Tales.TaleQuestItemFunctionLibrary.SpawnAndWieldItem // Final|RequiredAPI|Native|Public|HasOutParms // @ game+0x3f6e1b0
};
...
struct UTaleQuestLogicFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool Logic_XOr(bool Left, bool Right); // Function Tales.TaleQuestLogicFunctionLibrary.Logic_XOr // Final|Native|Static|Public // @ game+0x3f6b3f0
	bool Logic_Or(bool Left, bool Right); // Function Tales.TaleQuestLogicFunctionLibrary.Logic_Or // Final|Native|Static|Public // @ game+0x3f6b320
	bool Logic_Not(bool Value); // Function Tales.TaleQuestLogicFunctionLibrary.Logic_Not // Final|Native|Static|Public // @ game+0x3f6b2a0
	bool Logic_And(bool Left, bool Right); // Function Tales.TaleQuestLogicFunctionLibrary.Logic_And // Final|Native|Static|Public // @ game+0x3f6b1d0
};
...
struct UTaleQuestModifyPagesFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void ReplacePages(struct TArray<struct UQuestBookPageBundle*> Pages, struct TArray<struct UQuestBookPageBundle*> PagesToReplace); // Function Tales.TaleQuestModifyPagesFunctionLibrary.ReplacePages // Final|Native|Public|HasOutParms|Const // @ game+0x3f6d0b0
	void ModifyPagesAtIndex(struct TArray<struct UQuestBookPageBundle*> Pages, int32_t BookPageIndex, char ModifyTypeEnum); // Function Tales.TaleQuestModifyPagesFunctionLibrary.ModifyPagesAtIndex // Final|Native|Public|HasOutParms|Const // @ game+0x3f6b9c0
};
...
struct UTaleQuestNamedPointsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void GetNamedPointsFromGroup(struct AActor* PointsContainer, struct FName GroupName, char ReturnSpace, struct TArray<struct FOrientedPoint> Points); // Function Tales.TaleQuestNamedPointsFunctionLibrary.GetNamedPointsFromGroup // Final|Native|Static|Public|HasOutParms // @ game+0x3f69a20
};
...
struct UTaleQuestNameFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool IsNone(struct FName Name); // Function Tales.TaleQuestNameFunctionLibrary.IsNone // Final|Native|Static|Public // @ game+0x3f6ab70
	bool Equals(struct FName Left, struct FName Right); // Function Tales.TaleQuestNameFunctionLibrary.Equals // Final|Native|Public|HasOutParms|Const // @ game+0x3f68670
};
...
struct UTaleQuestNotificationFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void FireSeasonNotification(struct UTaleQuestSeasonNotificationDataAsset* InTaleQuestSeasonNotificationDataAsset); // Function Tales.TaleQuestNotificationFunctionLibrary.FireSeasonNotification // Final|Native|Public // @ game+0x3f68b60
};
...
struct UTaleQuestNPCHideFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void FadeOut(struct AActor* InActor); // Function Tales.TaleQuestNPCHideFunctionLibrary.FadeOut // Final|Native|Public // @ game+0x3f68980
	void FadeIn(struct AActor* InActor); // Function Tales.TaleQuestNPCHideFunctionLibrary.FadeIn // Final|Native|Public // @ game+0x3f68900
};
...
struct UTaleQuestOfferingNPCFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void StopOfferItem(TScriptInterface<struct UOfferingNPCInterface> OfferingNPC); // Function Tales.TaleQuestOfferingNPCFunctionLibrary.StopOfferItem // Final|Native|Public // @ game+0x3f6e940
	void OfferItemAndWaitForPickup(TScriptInterface<struct UOfferingNPCInterface> OfferingNPC, struct UClass* ItemToShow, struct FText PickupItemTooltip, struct FText CannotPickupItemTooltip, struct AActor* InteractingActor); // Function Tales.TaleQuestOfferingNPCFunctionLibrary.OfferItemAndWaitForPickup // Final|Native|Public|HasOutParms // @ game+0x3f6c1c0
};
...
struct UTaleQuestParticipantFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct TArray<TScriptInterface<struct UVoyageParticipantInterface>> GetParticipants(); // Function Tales.TaleQuestParticipantFunctionLibrary.GetParticipants // Final|Native|Public|Const // @ game+0x3f69da0
	struct ACharacter* GetParticipantCharacter(TScriptInterface<struct UVoyageParticipantInterface> Participant); // Function Tales.TaleQuestParticipantFunctionLibrary.GetParticipantCharacter // Final|Native|Public|Const // @ game+0x3f69cf0
};
...
struct UTaleQuestPredicatedBranchPhasingFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct APhasedClusterRoot* GetPhaseClusterBranchByIndex(int32_t CutsceneIndex); // Function Tales.TaleQuestPredicatedBranchPhasingFunctionLibrary.GetPhaseClusterBranchByIndex // Final|Native|Public|Const // @ game+0x3f69e40
};
...
struct UTaleQuestQueryableStateAddToIntFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void AddToIntQueryableState(struct UClass* DataID, int32_t DataToAdd); // Function Tales.TaleQuestQueryableStateAddToIntFunctionLibrary.AddToIntQueryableState // Final|Native|Public // @ game+0x3f67370
};
...
struct UTaleQuestQueryableStateReadBoolFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool ReadBoolQueryableState(struct UClass* DataID, bool DataValue); // Function Tales.TaleQuestQueryableStateReadBoolFunctionLibrary.ReadBoolQueryableState // Final|Native|Public|HasOutParms // @ game+0x3f6cd10
};
...
struct UTaleQuestQueryableStateReadIntFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool ReadIntQueryableState(struct UClass* DataID, int32_t DataValue); // Function Tales.TaleQuestQueryableStateReadIntFunctionLibrary.ReadIntQueryableState // Final|Native|Public|HasOutParms // @ game+0x3f6cfc0
};
...
struct UTaleQuestQueryableStateWriteBoolFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WriteBoolQueryableState(struct UClass* DataID, bool DataValue); // Function Tales.TaleQuestQueryableStateWriteBoolFunctionLibrary.WriteBoolQueryableState // Final|Native|Public // @ game+0x3f6fcc0
};
...
struct UTaleQuestQueryableStateWriteIntFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WriteIntQueryableState(struct UClass* DataID, int32_t DataValue); // Function Tales.TaleQuestQueryableStateWriteIntFunctionLibrary.WriteIntQueryableState // Final|Native|Public // @ game+0x3f6fd90
};
...
struct UTaleQuestRandomFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FGrabBag InitialiseGrabBag(int32_t Min, int32_t Max); // Function Tales.TaleQuestRandomFunctionLibrary.InitialiseGrabBag // Final|RequiredAPI|Native|Public|Const // @ game+0x3f6a620
	int32_t GetGrabBagElement(struct FGrabBag GrabBag); // Function Tales.TaleQuestRandomFunctionLibrary.GetGrabBagElement // Final|RequiredAPI|Native|Public|HasOutParms|Const // @ game+0x3f69660
};
...
struct UTaleQuestShantyFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void StopShantyMusic(struct AShantyPlayer* InShantyPlayer); // Function Tales.TaleQuestShantyFunctionLibrary.StopShantyMusic // Final|Native|Public|Const // @ game+0x3f6e9e0
	void StartShantyMusic(struct AShantyPlayer* InShantyPlayer); // Function Tales.TaleQuestShantyFunctionLibrary.StartShantyMusic // Final|Native|Public|Const // @ game+0x3f6e820
};
...
struct UTaleQuestShipInteractionHandlerFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void SetInteractionState(struct AActor* Ship, bool Enabled); // Function Tales.TaleQuestShipInteractionHandlerFunctionLibrary.SetInteractionState // Final|Native|Public // @ game+0x3f6dcf0
};
...
struct UTaleQuestStatFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void FireStatToPlayer(TScriptInterface<struct UVoyageParticipantInterface> PlayerToFireStatOn); // Function Tales.TaleQuestStatFunctionLibrary.FireStatToPlayer // Final|Native|Public|Const // @ game+0x3f68be0
};
...
struct UTaleQuestStatusEffectsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void TriggerOnScreenParticles(TScriptInterface<struct UVoyageParticipantInterface> Participant, struct UParticleSystem* ParticleSystem); // Function Tales.TaleQuestStatusEffectsFunctionLibrary.TriggerOnScreenParticles // Final|Native|Public|Const // @ game+0x3f6f540
	void EndOnScreenParticles(TScriptInterface<struct UVoyageParticipantInterface> Participant, struct UParticleSystem* ParticleSystem, float Delay); // Function Tales.TaleQuestStatusEffectsFunctionLibrary.EndOnScreenParticles // Final|Native|Public|Const // @ game+0x3f68480
};
...
struct UTaleQuestStoryFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WaitForStory(struct FName StoryName, bool ShouldBeActive); // Function Tales.TaleQuestStoryFunctionLibrary.WaitForStory // Final|RequiredAPI|Native|Public|HasOutParms // @ game+0x3f6f9b0
	bool IsStoryActive(struct FName StoryName); // Function Tales.TaleQuestStoryFunctionLibrary.IsStoryActive // Final|RequiredAPI|Native|Public|HasOutParms|Const // @ game+0x3f6ac10
};
...
struct UTaleQuestStoryBranchFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void BranchOnStory(struct FName StoryName); // Function Tales.TaleQuestStoryBranchFunctionLibrary.BranchOnStory // Final|Native|Public|HasOutParms // @ game+0x3f67af0
};
...
struct UTaleQuestTransformMathsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FTransform ToWorld_Transform(struct FTransform RootTransform, struct FTransform RelativeTransform); // Function Tales.TaleQuestTransformMathsFunctionLibrary.ToWorld_Transform // Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults // @ game+0x3f6f340
};
...
struct UTaleQuestTransfromConversionFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FVector ToVector(struct FTransform InTransform); // Function Tales.TaleQuestTransfromConversionFunctionLibrary.ToVector // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x3f6f240
	struct FRotator ToRotator(struct FTransform InTransform); // Function Tales.TaleQuestTransfromConversionFunctionLibrary.ToRotator // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x3f6f140
	struct FTransform FromVector(struct FVector InTranslation); // Function Tales.TaleQuestTransfromConversionFunctionLibrary.FromVector // Final|Native|Static|Public|HasOutParms|HasDefaults // @ game+0x3f68f70
	struct FTransform FromOrientedPoint(struct FOrientedPoint InOrientedPoint); // Function Tales.TaleQuestTransfromConversionFunctionLibrary.FromOrientedPoint // Final|Native|Static|Public|HasOutParms|HasDefaults // @ game+0x3f68df0
};
...
struct UTaleQuestUObjectFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	bool IsValid(struct UObject* Object); // Function Tales.TaleQuestUObjectFunctionLibrary.IsValid // Final|Native|Static|Public // @ game+0x3f6acb0
	struct UObject* CastTo(struct UObject* Object, struct UClass* CastToClass); // Function Tales.TaleQuestUObjectFunctionLibrary.CastTo // Final|Native|Public|Const // @ game+0x3f67c30
};
...
struct UTaleQuestUtilityFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void FailTale(struct FText FailureMessage); // Function Tales.TaleQuestUtilityFunctionLibrary.FailTale // Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3f68a00
};
...
struct UTaleQuestValueFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct FText Make_Text(struct FText Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_Text // Final|Native|Public|HasOutParms|Const // @ game+0x3f6b8f0
	struct FString Make_String(struct FString Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_String // Final|Native|Public|Const // @ game+0x3f6b800
	struct FName Make_Name(struct FName Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_Name // Final|Native|Public|HasOutParms|Const // @ game+0x3f6b770
	int32_t Make_Int32(int32_t Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_Int32 // Final|Native|Public|Const // @ game+0x3f6b6f0
	float Make_Float(float Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_Float // Final|Native|Public|Const // @ game+0x3f6b670
	bool Make_Bool(bool Value); // Function Tales.TaleQuestValueFunctionLibrary.Make_Bool // Final|Native|Public|Const // @ game+0x3f6b5f0
	struct FString Append_String(struct FString Prefix, struct FString Value, struct FString Suffix); // Function Tales.TaleQuestValueFunctionLibrary.Append_String // Final|Native|Public|Const // @ game+0x3f677a0
};
...
struct UTaleQuestVectorMathsFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	float DistanceSquared(struct FVector From, struct FVector To); // Function Tales.TaleQuestVectorMathsFunctionLibrary.DistanceSquared // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x3f68040
	float Distance(struct FVector From, struct FVector To); // Function Tales.TaleQuestVectorMathsFunctionLibrary.Distance // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x3f67f20
};
...
struct UTaleQuestWaterVolumeFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void SetExactWaterLevel(struct AWaterVolume* WaterVolume, float WaterLevel); // Function Tales.TaleQuestWaterVolumeFunctionLibrary.SetExactWaterLevel // Final|Native|Public // @ game+0x3f6da30
	bool IsWaterVolumeFull(struct AWaterVolume* WaterVolume); // Function Tales.TaleQuestWaterVolumeFunctionLibrary.IsWaterVolumeFull // Final|Native|Public // @ game+0x3f6ad60
	void EmptyWaterVolume(struct AWaterVolume* WaterVolume); // Function Tales.TaleQuestWaterVolumeFunctionLibrary.EmptyWaterVolume // Final|Native|Public // @ game+0x3f68310
	void AddWaterAmount(struct AWaterVolume* WaterVolume, float AmountToAdd, float LerpRate); // Function Tales.TaleQuestWaterVolumeFunctionLibrary.AddWaterAmount // Final|Native|Public // @ game+0x3f67520
};
...
struct UTaleQuestMapService : UTaleQuestService {
	...
	void UpdateMerchantMap(struct FName MapID, int32_t Index, struct FTaleQuestDeliverableItem Deliverable); // Function Tales.TaleQuestMapService.UpdateMerchantMap // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x479d270
	void AdvanceRiddleMap(struct FName MapID); // Function Tales.TaleQuestMapService.AdvanceRiddleMap // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x479d0d0
};
