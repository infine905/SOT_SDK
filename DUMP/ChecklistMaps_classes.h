...
struct UNamedChecklistEventActionData : UChecklistActionData {
	...
	struct TArray<struct FString> EventsSource(); // Function ChecklistMaps.NamedChecklistEventActionData.EventsSource // Final|Native|Public|Const // @ game+0x3d552e0
};
...
struct AChecklistMap : ATreasureMap {
	...
	void RefreshContents(); // Function ChecklistMaps.ChecklistMap.RefreshContents // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x3d555b0
	void OnTextCanvasUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function ChecklistMaps.ChecklistMap.OnTextCanvasUpdate // Final|Native|Private // @ game+0x3d554b0
	void OnRep_Contents(struct FChecklistMapContents InPreviousContents); // Function ChecklistMaps.ChecklistMap.OnRep_Contents // Final|Native|Private|HasOutParms // @ game+0x3d553f0
};
