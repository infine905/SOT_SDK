...
// ScriptStruct Tales.PhaseBranchIndexPlayerAssignment
// Size: 0x0c (Inherited: 0x00)
struct FPhaseBranchIndexPlayerAssignment {
	struct AController* Player; // 0x00(0x08)
	int32_t AssignedPhaseBranchIndex; // 0x08(0x04)
};

// ScriptStruct Tales.TaleQuestQueryableStateDataInfoId
// Size: 0x20 (Inherited: 0x00)
struct FTaleQuestQueryableStateDataInfoId {
	struct FGuid MyTaleId; // 0x00(0x10)
	struct FGuid MyScopeId; // 0x10(0x10)
};

// ScriptStruct Tales.TaleQuestQueryableStateDataInfo
// Size: 0x30 (Inherited: 0x00)
struct FTaleQuestQueryableStateDataInfo {
	struct FTaleQuestQueryableStateDataInfoId InfoId; // 0x00(0x20)
	struct UClass* DataID; // 0x20(0x08)
	bool DataBool; // 0x28(0x01)
	char UnknownData_29[0x3]; // 0x29(0x03)
	int32_t DataInt; // 0x2c(0x04)
};
...
// ScriptStruct Tales.TaleQuestPhaseClusterRootActor
// Size: 0x30 (Inherited: 0x30)
struct FTaleQuestPhaseClusterRootActor : FQuestVariable {
};
...
// ScriptStruct Tales.DebugOnTalePhaseBranchAssignedForPlayerNetworkEvent
// Size: 0x20 (Inherited: 0x10)
struct FDebugOnTalePhaseBranchAssignedForPlayerNetworkEvent : FBoxedRpc {
	struct FPhaseBranchIndexPlayerAssignment Assignment; // 0x10(0x0c)
	char UnknownData_1C[0x4]; // 0x1c(0x04)
};

// ScriptStruct Tales.DebugTalePhaseBranchAssignedForPlayerEvent
// Size: 0x18 (Inherited: 0x00)
struct FDebugTalePhaseBranchAssignedForPlayerEvent {
	struct FGuid CrewId; // 0x00(0x10)
	struct AController* Player; // 0x10(0x08)
};

// ScriptStruct Tales.QueryableStateChangedEvent
// Size: 0x30 (Inherited: 0x00)
struct FQueryableStateChangedEvent {
	struct FTaleQuestQueryableStateDataInfo DataValue; // 0x00(0x30)
};
