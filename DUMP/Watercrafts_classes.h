...
struct AFakeShip : AActor {
	...
	void OnAttachedItemEndPlay(struct AActor* Actor); // Function Watercrafts.FakeShip.OnAttachedItemEndPlay // Final|Native|Private // @ game+0x40e8220
};
...
struct UItemProxyWatercraftTrackerComponent : UActorComponent {
	...
	void OnRep_CurrentWatercraft(struct AActor* PreviousWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnRep_CurrentWatercraft // Final|Native|Private // @ game+0x40e8320
	void OnCurrentWatercraftDestroyed(struct AActor* DestroyedWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnCurrentWatercraftDestroyed // Final|Native|Private // @ game+0x40e82a0
};
...
struct AWatercraft : AActor {
	...
	void OnRigidBodyWake(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodyWake // Final|Native|Protected // @ game+0x40e8540
	void OnRigidBodySleep(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodySleep // Final|Native|Protected // @ game+0x40e84c0
};
...
struct ARowboat : AWatercraft {
	...
	void SetAlwaysEnabledInteractables(struct TArray<struct UChildActorComponent*> InAlwaysEnabledInteractables); // Function Watercrafts.Rowboat.SetAlwaysEnabledInteractables // Final|Native|Protected|HasOutParms|BlueprintCallable // @ game+0x40e8850
	void ReactToRepairableStateChanged(char InNewState, char InPreviousState, struct URepairableComponent* InRepairableComponent); // Function Watercrafts.Rowboat.ReactToRepairableStateChanged // Final|Native|Protected // @ game+0x40e8640
	void OnRep_IsSinking(); // Function Watercrafts.Rowboat.OnRep_IsSinking // Final|Native|Private // @ game+0x40e83a0
};
...
struct UTaleQuestWatercraftFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct AWatercraft* GetFirstSpawnedWatercraft(); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.GetFirstSpawnedWatercraft // Final|Native|Public // @ game+0x40e81f0
	void FilterPointsByDistanceFromWatercraft(float MinDistance, struct TArray<struct FOrientedPoint> Points); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.FilterPointsByDistanceFromWatercraft // Final|Native|Public|HasOutParms|Const // @ game+0x40e80f0
};
...
struct UWatercraftBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AWatercraft* SpawnWatercraft(struct UObject* WorldContextObject, struct UClass* WatercraftClass, struct FVector Location, struct FRotator Rotation); // Function Watercrafts.WatercraftBlueprintFunctionLibrary.SpawnWatercraft // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x40e8900
};
...
struct UWatercraftTrackerComponent : UActorComponent {
	...
	void OnWatercraftDestroyed(struct AActor* WatercraftActor); // Function Watercrafts.WatercraftTrackerComponent.OnWatercraftDestroyed // Final|Native|Private // @ game+0x40e85c0
};
