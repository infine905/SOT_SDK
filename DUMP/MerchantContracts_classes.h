...
struct UMerchantContractsBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FText GetDateFromTimeLimit(TScriptInterface<struct UGameServiceProviderInterface> ServiceProviderInterface, float TimeLimit); // Function MerchantContracts.MerchantContractsBlueprintLibrary.GetDateFromTimeLimit // Final|Native|Static|Public|BlueprintCallable // @ game+0x3de1870
};
