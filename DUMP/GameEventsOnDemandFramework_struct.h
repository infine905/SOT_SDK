...
// ScriptStruct GameEventsOnDemandFramework.GameEventOnDemandCompleteBannerNetworkEvent
// Size: 0x50 (Inherited: 0x10)
struct FGameEventOnDemandCompleteBannerNetworkEvent : FNetworkEventStruct {
	struct FText Title; // 0x10(0x38)
	struct FName Company; // 0x48(0x08)
};
...
// ScriptStruct GameEventsOnDemandFramework.GameEventOnDemandCompletedTelemetryEvent
// Size: 0x30 (Inherited: 0x00)
struct FGameEventOnDemandCompletedTelemetryEvent {
	struct FString Company; // 0x00(0x10)
