...
struct UForceFeedbackCondition : UObject {
	...
	bool CanPlayForceFeedback(struct AActor* InOwner); // Function AthenaEngine.ForceFeedbackCondition.CanPlayForceFeedback // Native|Event|Public|BlueprintEvent|Const // @ game+0x32fd4a0
};
...
struct UBoxedRpcDispatcherComponent : UActorComponent {
	...
	void Server_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Server_SendRpc // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x32fda20
	void NetMulticastExcludeServer_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.NetMulticastExcludeServer_SendRpc // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x32fd8f0
	void Client_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Client_SendRpc // Net|NetReliableNative|Event|Protected|NetClient // @ game+0x32fd580
};
...
struct UDynamicColourPointLightComponent : UPointLightComponent {
	...
	void DeactivateLight(bool Blend); // Function AthenaEngine.DynamicColourPointLightComponent.DeactivateLight // Final|Native|Public|BlueprintCallable // @ game+0x32fd620
	void ActivateLight(bool Blend); // Function AthenaEngine.DynamicColourPointLightComponent.ActivateLight // Final|Native|Public|BlueprintCallable // @ game+0x32fd3e0
};
...
struct UPlayModeHelpers : UBlueprintFunctionLibrary {
	...
	void SetPlayModeVariantOverride(char NewPlayModeVariantOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fdb50
	void SetPlayModeOverride(char NewPlayModeOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fdae0
	bool HasPlayModeVariantBeenSet(struct UObject* WorldContext); // Function AthenaEngine.PlayModeHelpers.HasPlayModeVariantBeenSet // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fd7b0
	char GetPlayModeVariant(struct UObject* WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayModeVariant // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fd730
	char GetPlayMode(struct UObject* WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayMode // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fd6b0
	void ClearPlayModeVariantOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fd560
	void ClearPlayModeOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x32fd540
};
...
struct URotateMeshToActorComponent : UActorComponent {
	...
	void SnapMeshToLookAtActor(); // Function AthenaEngine.RotateMeshToActorComponent.SnapMeshToLookAtActor // Final|Native|Public|BlueprintCallable // @ game+0x32fdbf0
	void Initialise(struct UMeshComponent* InMeshToRotate, struct AActor* InActorToRotateTo); // Function AthenaEngine.RotateMeshToActorComponent.Initialise // Final|Native|Public|BlueprintCallable // @ game+0x32fd830
};
