...
struct AKrakenTentacle : AActor {
	...
	void OnDamageToTentacle(struct FImpactDamageEvent ImpactDamageEvent); // Function Kraken.KrakenTentacle.OnDamageToTentacle // Final|Native|Public|HasOutParms // @ game+0x4175fd0
};
...
struct AMurk : AActor {
	...
	void DeactivateMurkBP(); // Function Kraken.Murk.DeactivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4175db0
	void ActivateMurkBP(); // Function Kraken.Murk.ActivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4175d10
};
...
struct AKrakenShipWrappingTentacle : AKrakenTentacle {
	...
	void OnRep_CurrentServerAnimationState(); // Function Kraken.KrakenShipWrappingTentacle.OnRep_CurrentServerAnimationState // Final|Native|Private // @ game+0x41760d0
};
...
struct AKraken : AActor {
	...
	void Multicast_OnTentacleTakenDamage(); // Function Kraken.Kraken.Multicast_OnTentacleTakenDamage // Final|Net|Native|Event|NetMulticast|Private // @ game+0x4175f30
	void AddActorToKnownTargets(struct AActor* Target); // Function Kraken.Kraken.AddActorToKnownTargets // Final|Native|Public|BlueprintCallable // @ game+0x4175d30
};
...
struct AKrakenHead : AActor {
	...
	void TestSetDamageEnabled(bool InEnabled); // Function Kraken.KrakenHead.TestSetDamageEnabled // Final|Native|Public|BlueprintCallable // @ game+0x41762b0
	void RequestState(struct UClass* NewState); // Function Kraken.KrakenHead.RequestState // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4176210
	void OnRep_IsDamageEnabled(); // Function Kraken.KrakenHead.OnRep_IsDamageEnabled // Final|Native|Protected // @ game+0x4176110
	void OnRep_HeadStateRequest(); // Function Kraken.KrakenHead.OnRep_HeadStateRequest // Final|Native|Protected // @ game+0x41760f0
	void OnCoordinatedKrakenSpecialEvent(char InEventType); // Function Kraken.KrakenHead.OnCoordinatedKrakenSpecialEvent // Final|Native|Private // @ game+0x4175f50
};
...
struct AKrakenService : AActor {
	...
	void Test_TrySpawningKraken(); // Function Kraken.KrakenService.Test_TrySpawningKraken // Final|Native|Public|BlueprintCallable // @ game+0x4176410
	void Test_SetTargetShip(struct AShip* InShip); // Function Kraken.KrakenService.Test_SetTargetShip // Final|Native|Public|BlueprintCallable // @ game+0x4176390
	bool Test_IsCurrentStateInactive(); // Function Kraken.KrakenService.Test_IsCurrentStateInactive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4176360
	bool Test_IsCurrentStateActive(); // Function Kraken.KrakenService.Test_IsCurrentStateActive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4176330
	void RequestKrakenWithLocation(struct FVector SpawnLocation, struct AActor* SpawnedForActor); // Function Kraken.KrakenService.RequestKrakenWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4176130
	bool IsServiceInitialized(); // Function Kraken.KrakenService.IsServiceInitialized // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4175f00
	bool IsKrakenActive(); // Function Kraken.KrakenService.IsKrakenActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4175ec0
	bool DismissOrRemoveCrewFromKraken(struct FGuid InCrewId); // Function Kraken.KrakenService.DismissOrRemoveCrewFromKraken // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4175e10
	bool DismissKraken(); // Function Kraken.KrakenService.DismissKraken // Native|Public|BlueprintCallable // @ game+0x4175dd0
};
