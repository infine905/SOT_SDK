...
struct AKrakenTentacle : AActor {
	...
	void OnDamageToTentacle(struct FImpactDamageEvent ImpactDamageEvent); // Function Kraken.KrakenTentacle.OnDamageToTentacle // Final|Native|Public|HasOutParms // @ game+0x419f0d0
};
...
struct AMurk : AActor {
	...
	void DeactivateMurkBP(); // Function Kraken.Murk.DeactivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x419eeb0
	void ActivateMurkBP(); // Function Kraken.Murk.ActivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x419ee10
};
...
struct AKrakenShipWrappingTentacle : AKrakenTentacle {
	...
	void OnRep_CurrentServerAnimationState(); // Function Kraken.KrakenShipWrappingTentacle.OnRep_CurrentServerAnimationState // Final|Native|Private // @ game+0x419f1d0
};
...
struct AKraken : AActor {
	...
	void Multicast_OnTentacleTakenDamage(); // Function Kraken.Kraken.Multicast_OnTentacleTakenDamage // Final|Net|Native|Event|NetMulticast|Private // @ game+0x419f030
	void AddActorToKnownTargets(struct AActor* Target); // Function Kraken.Kraken.AddActorToKnownTargets // Final|Native|Public|BlueprintCallable // @ game+0x419ee30
};
...
struct AKrakenHead : AActor {
	...
	void TestSetDamageEnabled(bool InEnabled); // Function Kraken.KrakenHead.TestSetDamageEnabled // Final|Native|Public|BlueprintCallable // @ game+0x419f3b0
	void RequestState(struct UClass* NewState); // Function Kraken.KrakenHead.RequestState // Native|Public|HasOutParms|BlueprintCallable // @ game+0x419f310
	void OnRep_IsDamageEnabled(); // Function Kraken.KrakenHead.OnRep_IsDamageEnabled // Final|Native|Protected // @ game+0x419f210
	void OnRep_HeadStateRequest(); // Function Kraken.KrakenHead.OnRep_HeadStateRequest // Final|Native|Protected // @ game+0x419f1f0
	void OnCoordinatedKrakenSpecialEvent(char InEventType); // Function Kraken.KrakenHead.OnCoordinatedKrakenSpecialEvent // Final|Native|Private // @ game+0x419f050
};
...
// Size: 0x700 (Inherited: 0x3c8)
struct AKrakenService : AActor {
	char UnknownData_3C8[0x8]; // 0x3c8(0x08)
	struct FKrakenServiceParams KrakenServiceParams; // 0x3d0(0x40)
	char UnknownData_410[0xa0]; // 0x410(0xa0)
	struct AKraken* Kraken; // 0x4b0(0x08)
	char UnknownData_4B8[0x248]; // 0x4b8(0x248)

	void Test_TrySpawningKraken(); // Function Kraken.KrakenService.Test_TrySpawningKraken // Final|Native|Public|BlueprintCallable // @ game+0x419f510
	void Test_SetTargetShip(struct AShip* InShip); // Function Kraken.KrakenService.Test_SetTargetShip // Final|Native|Public|BlueprintCallable // @ game+0x419f490
	bool Test_IsCurrentStateInactive(); // Function Kraken.KrakenService.Test_IsCurrentStateInactive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x419f460
	bool Test_IsCurrentStateActive(); // Function Kraken.KrakenService.Test_IsCurrentStateActive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x419f430
	void RequestKrakenWithLocation(struct FVector SpawnLocation, struct AActor* SpawnedForActor); // Function Kraken.KrakenService.RequestKrakenWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x419f230
	bool IsServiceInitialized(); // Function Kraken.KrakenService.IsServiceInitialized // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x419f000
	bool IsKrakenActive(); // Function Kraken.KrakenService.IsKrakenActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x419efc0
	bool DismissOrRemoveCrewFromKraken(struct FGuid InCrewId); // Function Kraken.KrakenService.DismissOrRemoveCrewFromKraken // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x419ef10
	bool DismissKraken(); // Function Kraken.KrakenService.DismissKraken // Native|Public|BlueprintCallable // @ game+0x419eed0
};

// Class Kraken.KrakenServiceParamsDataAsset
// Size: 0x68 (Inherited: 0x28)
struct UKrakenServiceParamsDataAsset : UDataAsset {
	struct FKrakenServiceParams Params; // 0x28(0x40)
};
