...
struct ABP_AggressiveShipPawn_C : AShipProxyPawn {
	...
	void UserConstructionScript(); // Function BP_AggressiveShipPawn.BP_AggressiveShipPawn_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
