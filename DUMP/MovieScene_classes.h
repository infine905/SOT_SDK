...
struct UMovieSceneSequencePlayer : UObject {
	...
	void Stop(); // Function MovieScene.MovieSceneSequencePlayer.Stop // Final|Native|Public|BlueprintCallable // @ game+0x2179de0
	void StartPlayingNextTick(); // Function MovieScene.MovieSceneSequencePlayer.StartPlayingNextTick // Final|Native|Public|BlueprintCallable // @ game+0x2179dc0
	void SetPlayRate(float PlayRate); // Function MovieScene.MovieSceneSequencePlayer.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x2179c00
	void SetPlaybackRange(float NewStartTime, float NewEndTime); // Function MovieScene.MovieSceneSequencePlayer.SetPlaybackRange // Final|Native|Public|BlueprintCallable // @ game+0x2179d00
	void SetPlaybackPosition(float NewPlaybackPosition); // Function MovieScene.MovieSceneSequencePlayer.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x2179c80
	void SetOverridePlaybackSettings(struct FMovieSceneSequencePlaybackSettings InSettings); // Function MovieScene.MovieSceneSequencePlayer.SetOverridePlaybackSettings // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x2179b40
	void PlayReverse(); // Function MovieScene.MovieSceneSequencePlayer.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x2179b20
	void PlayLooping(int32_t NumLoops); // Function MovieScene.MovieSceneSequencePlayer.PlayLooping // Final|Native|Public|BlueprintCallable // @ game+0x2179aa0
	void Play(struct ACharacter* OptionalInteractingCharacter); // Function MovieScene.MovieSceneSequencePlayer.Play // Final|Native|Public|BlueprintCallable // @ game+0x2179a20
	void Pause(); // Function MovieScene.MovieSceneSequencePlayer.Pause // Final|Native|Public|BlueprintCallable // @ game+0x2179a00
	bool IsPlaying(); // Function MovieScene.MovieSceneSequencePlayer.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x21799d0
	float GetPlayRate(); // Function MovieScene.MovieSceneSequencePlayer.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2179930
	float GetPlaybackStart(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackStart // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x21799b0
	float GetPlaybackPosition(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackPosition // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2179980
	float GetPlaybackEnd(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackEnd // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2179960
	float GetLength(); // Function MovieScene.MovieSceneSequencePlayer.GetLength // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2179900
	void ChangePlaybackDirection(); // Function MovieScene.MovieSceneSequencePlayer.ChangePlaybackDirection // Final|Native|Public|BlueprintCallable // @ game+0x21798e0
};
