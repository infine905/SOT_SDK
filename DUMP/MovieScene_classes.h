...
struct UMovieSceneSequencePlayer : UObject {
	...
	void Stop(); // Function MovieScene.MovieSceneSequencePlayer.Stop // Final|Native|Public|BlueprintCallable // @ game+0x2191fc0
	void StartPlayingNextTick(); // Function MovieScene.MovieSceneSequencePlayer.StartPlayingNextTick // Final|Native|Public|BlueprintCallable // @ game+0x2191fa0
	void SetPlayRate(float PlayRate); // Function MovieScene.MovieSceneSequencePlayer.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x2191de0
	void SetPlaybackRange(float NewStartTime, float NewEndTime); // Function MovieScene.MovieSceneSequencePlayer.SetPlaybackRange // Final|Native|Public|BlueprintCallable // @ game+0x2191ee0
	void SetPlaybackPosition(float NewPlaybackPosition); // Function MovieScene.MovieSceneSequencePlayer.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x2191e60
	void SetOverridePlaybackSettings(struct FMovieSceneSequencePlaybackSettings InSettings); // Function MovieScene.MovieSceneSequencePlayer.SetOverridePlaybackSettings // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x2191d20
	void PlayReverse(); // Function MovieScene.MovieSceneSequencePlayer.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x2191d00
	void PlayLooping(int32_t NumLoops); // Function MovieScene.MovieSceneSequencePlayer.PlayLooping // Final|Native|Public|BlueprintCallable // @ game+0x2191c80
	void Play(struct ACharacter* OptionalInteractingCharacter); // Function MovieScene.MovieSceneSequencePlayer.Play // Final|Native|Public|BlueprintCallable // @ game+0x2191c00
	void Pause(); // Function MovieScene.MovieSceneSequencePlayer.Pause // Final|Native|Public|BlueprintCallable // @ game+0x2191be0
	bool IsPlaying(); // Function MovieScene.MovieSceneSequencePlayer.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191bb0
	float GetPlayRate(); // Function MovieScene.MovieSceneSequencePlayer.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191b10
	float GetPlaybackStart(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackStart // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191b90
	float GetPlaybackPosition(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackPosition // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191b60
	float GetPlaybackEnd(); // Function MovieScene.MovieSceneSequencePlayer.GetPlaybackEnd // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191b40
	float GetLength(); // Function MovieScene.MovieSceneSequencePlayer.GetLength // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x2191ae0
	void ChangePlaybackDirection(); // Function MovieScene.MovieSceneSequencePlayer.ChangePlaybackDirection // Final|Native|Public|BlueprintCallable // @ game+0x2191ac0
};
