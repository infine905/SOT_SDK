...
struct ABP_SmallShipStorageBarrel_Cannonball_C : AStorageContainer {
	...
	void UserConstructionScript(); // Function BP_SmallShipStorageBarrel_Cannonball.BP_SmallShipStorageBarrel_Cannonball_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
