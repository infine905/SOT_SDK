...
struct FContextualTutorialPromptDesc {
	...
	int32_t MustBeUnderCount; // 0x34(0x04)
};
...
// ScriptStruct Tutorial.IntroductionToSOTIntroAnimatic
// Size: 0x38 (Inherited: 0x00)
struct FIntroductionToSOTIntroAnimatic {
	struct UClass* ShipSize; // 0x00(0x08)
	struct FFirstPersonAnimaticSettings IntroAnimationSettings; // 0x08(0x2c)
