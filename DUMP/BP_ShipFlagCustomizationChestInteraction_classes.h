...
struct ABP_ShipFlagCustomizationChestInteraction_C : AShipFlagCustomizationChestInteraction {
	...
	void UserConstructionScript(); // Function BP_ShipFlagCustomizationChestInteraction.BP_ShipFlagCustomizationChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
