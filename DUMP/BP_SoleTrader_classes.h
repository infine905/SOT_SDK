...
struct ABP_SoleTrader_C : ACompanyShopkeeper {
	...
	void UserConstructionScript(); // Function BP_SoleTrader.BP_SoleTrader_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
