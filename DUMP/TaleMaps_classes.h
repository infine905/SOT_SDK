...
// Class TaleMaps.RegionIslandWayfinderSelectionStrategy
// Size: 0x48 (Inherited: 0x28)
struct URegionIslandWayfinderSelectionStrategy : URegionIslandSelectionStrategyBase {
	struct TArray<char> IslandTypes; // 0x28(0x10)
	float StartingIslandMinDistanceFromKeyIsland; // 0x38(0x04)
	char UnknownData_3C[0x4]; // 0x3c(0x04)
	struct AActor* VaultActor; // 0x40(0x08)
};
...
// Class TaleMaps.SelectWayfinderIslandsFromRegionStep
// Size: 0x130 (Inherited: 0x98)
struct USelectWayfinderIslandsFromRegionStep : UTaleQuestStep {
	struct URegionMapDataAsset* RegionData; // 0x98(0x08)
	struct URegionIslandWayfinderSelectionStrategy* SelectionStrategy; // 0xa0(0x08)
	struct AActor* VaultActor; // 0xa8(0x08)
	char UnknownData_B0[0x80]; // 0xb0(0x80)
};

// Class TaleMaps.SelectWayfinderIslandsFromRegionStepDesc
// Size: 0x1b0 (Inherited: 0x80)
struct USelectWayfinderIslandsFromRegionStepDesc : UTaleQuestStepDesc {
	struct FQuestVariableDataAsset Region; // 0x80(0x30)
	struct FQuestVariableInt NumIslands; // 0xb0(0x30)
	struct FQuestVariableInt MaxDifferentIslands; // 0xe0(0x30)
	struct FQuestVariableActor VaultActor; // 0x110(0x30)
	struct FQuestVariableName KeyIslandName; // 0x140(0x30)
	struct FQuestVariableNameArray SelectedIslands; // 0x170(0x30)
	struct URegionIslandWayfinderSelectionStrategy* SelectionStrategy; // 0x1a0(0x08)
	int32_t DefaultNumIslands; // 0x1a8(0x04)
	int32_t DefaultMaxDifferentIslands; // 0x1ac(0x04)
};
...
struct UTaleQuestCustomMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void UpdateStrikeThoughTextElement(struct FGuid MapGuid, struct FGuid ElementGuid, bool StrikeThroughEnabled); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.UpdateStrikeThoughTextElement // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x479d3d0
	void AddCustomMap(struct UCustomMapData* Data, struct FGuid MapGuid); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.AddCustomMap // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x479cdf0
};
...
struct UTaleQuestTornMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void AddTornMap(struct FName IslandName, int32_t NumPieces, struct UTornMapParams* MapParams, float MaskRotation, struct FGuid OutMapId); // Function TaleMaps.TaleQuestTornMapFunctionLibrary.AddTornMap // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x479cf20
};
...
struct UTaleQuestTriggerNamedChecklistEventStepDesc : UTaleQuestStepDesc {
	...
	struct TArray<struct FString> EventsSource(); // Function TaleMaps.TaleQuestTriggerNamedChecklistEventStepDesc.EventsSource // Final|Native|Private|Const // @ game+0x479d160
};
