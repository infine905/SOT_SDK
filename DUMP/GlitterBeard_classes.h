...
struct UGlitterBeardFinaleCoordinatorComponent : UActorComponent {
	...
	void OnRep_ReplicationState(struct FFinaleReplicationState OldState); // Function GlitterBeard.GlitterBeardFinaleCoordinatorComponent.OnRep_ReplicationState // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x49aa310
};
...
struct AGlitterBeardTree : AActor {
	...
	void StopVocals(); // Function GlitterBeard.GlitterBeardTree.StopVocals // Final|Native|Public|BlueprintCallable // @ game+0x49aa450
	bool StopReaction(); // Function GlitterBeard.GlitterBeardTree.StopReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x49aa410
	void StartVocals(); // Function GlitterBeard.GlitterBeardTree.StartVocals // Final|Native|Public|BlueprintCallable // @ game+0x49aa3f0
	bool StartReaction(); // Function GlitterBeard.GlitterBeardTree.StartReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x49aa3b0
	void Reset_Impl(); // Function GlitterBeard.GlitterBeardTree.Reset_Impl // Event|Protected|BlueprintEvent // @ game+0x18f4c40
};
...
struct UGlitterBeardTreeVisualFeedbackComponent : UActorComponent {
	...
	void OnRep_NextStateEvent(struct TArray<char> OldStates); // Function GlitterBeard.GlitterBeardTreeVisualFeedbackComponent.OnRep_NextStateEvent // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x49aa260
};
