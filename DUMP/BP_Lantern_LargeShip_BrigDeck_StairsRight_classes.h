...
struct ABP_Lantern_LargeShip_BrigDeck_StairsRight_C : ABP_InteractableShipLantern_C {
	...
	void UserConstructionScript(); // Function BP_Lantern_LargeShip_BrigDeck_StairsRight.BP_Lantern_LargeShip_BrigDeck_StairsRight_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
