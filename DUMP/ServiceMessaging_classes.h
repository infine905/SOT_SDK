...
struct UServiceMessagingFunctions : UBlueprintFunctionLibrary {
	...
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcherFromActor(struct UObject* Object); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcherFromActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x337b1d0
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcher(TScriptInterface<struct UServiceMessagingDispatcherInterface> ServiceMessagingDispatcher); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcher // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x337b130
};
...
struct UServiceMessagingListenerTestObject : UObject {
	...
	void TestFunctionWithMessage(struct FServiceMessagingTestMessage InMessage); // Function ServiceMessaging.ServiceMessagingListenerTestObject.TestFunctionWithMessage // Final|Native|Public|HasOutParms // @ game+0x337b260
};
