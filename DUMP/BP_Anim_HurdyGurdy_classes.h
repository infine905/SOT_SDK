...
struct UBP_Anim_HurdyGurdy_C : UWieldableItemAnimationInstance {
	...
	void ExecuteUbergraph_BP_Anim_HurdyGurdy(int32_t EntryPoint); // Function BP_Anim_HurdyGurdy.BP_Anim_HurdyGurdy_C.ExecuteUbergraph_BP_Anim_HurdyGurdy //  // @ game+0x190d0a0
};
