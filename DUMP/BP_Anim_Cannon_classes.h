...
struct UBP_Anim_Cannon_C : UCannonAnimInstance {
	...
	void AnimNotify_FireEnd(); // Function BP_Anim_Cannon.BP_Anim_Cannon_C.AnimNotify_FireEnd // BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_Anim_Cannon(int32_t EntryPoint); // Function BP_Anim_Cannon.BP_Anim_Cannon_C.ExecuteUbergraph_BP_Anim_Cannon //  // @ game+0x190d0a0
};
