...
struct ABP_InteractableShipLantern_C : AShipInteractableLight {
	...
	void UserConstructionScript(); // Function BP_InteractableShipLantern.BP_InteractableShipLantern_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void ReceiveBeginPlay(); // Function BP_InteractableShipLantern.BP_InteractableShipLantern_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void LightStateChanged(); // Function BP_InteractableShipLantern.BP_InteractableShipLantern_C.LightStateChanged // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_InteractableShipLantern(int32_t EntryPoint); // Function BP_InteractableShipLantern.BP_InteractableShipLantern_C.ExecuteUbergraph_BP_InteractableShipLantern //  // @ game+0x190d0a0
};
