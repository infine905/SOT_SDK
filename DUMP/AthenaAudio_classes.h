...
struct UAudioPortalComponent : USceneComponent {
	...
	void SetParentShip(struct AActor* ParentShip); // Function AthenaAudio.AudioPortalComponent.SetParentShip // Native|Public|BlueprintCallable // @ game+0x373d060
};
...
struct UAudioPortalInterface : UInterface {
	...
	void UnregisterPortal(struct UAudioPortalComponent* AudioPortal); // Function AthenaAudio.AudioPortalInterface.UnregisterPortal // Native|Public|BlueprintCallable // @ game+0x373d0f0
	void RegisterPortal(struct UAudioPortalComponent* AudioPortal, struct AActor* OwningActor); // Function AthenaAudio.AudioPortalInterface.RegisterPortal // Native|Public|BlueprintCallable // @ game+0x373cf80
	struct TArray<struct UAudioPortalComponent*> GetAllRegisteredPortalsInSpecificSpace(struct UAudioSpaceDataAsset* AudioSpace, struct AActor* OwningActor); // Function AthenaAudio.AudioPortalInterface.GetAllRegisteredPortalsInSpecificSpace // Native|Public // @ game+0x373cb90
	struct TArray<struct UAudioPortalComponent*> GetAllRegisteredPortals(); // Function AthenaAudio.AudioPortalInterface.GetAllRegisteredPortals // Native|Public|Const // @ game+0x373cb30
};
...
struct UAudioSpaceComponent : UStaticMeshComponent {
	...
	void OnOverlapEnd(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function AthenaAudio.AudioSpaceComponent.OnOverlapEnd // Final|Native|Private // @ game+0x373ce80
	void OnOverlapBegin(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool FromSweep, struct FHitResult SweepResult); // Function AthenaAudio.AudioSpaceComponent.OnOverlapBegin // Final|Native|Private|HasOutParms // @ game+0x373ccb0
};
...
struct UAudioSpaceTrackerComponent : UActorComponent {
	...
	struct UAudioSpaceDataAsset* GetCurrentSpace(); // Function AthenaAudio.AudioSpaceTrackerComponent.GetCurrentSpace // Final|Native|Public|BlueprintCallable // @ game+0x373cc80
};
...
struct AMultiEmitter : AActor {
	...
	void ResetNamingCount(); // Function AthenaAudio.MultiEmitter.ResetNamingCount // Final|Native|Public|BlueprintCallable // @ game+0x373d040
	void CreateAndAddMergedEmitterComponentToRoot(struct FName InName, struct FVector InOffset, struct UWwiseEvent* InWwiseEvent, struct UWwiseObjectPoolWrapper* InPool); // Function AthenaAudio.MultiEmitter.CreateAndAddMergedEmitterComponentToRoot // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x373c9d0
};
