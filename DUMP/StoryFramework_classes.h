...
struct UStoryDrivenBlendedLightingZoneComponent : UBlendedLightingZoneComponent {
	...
	void OnRep_CurrentStoryResponse(); // Function StoryFramework.StoryDrivenBlendedLightingZoneComponent.OnRep_CurrentStoryResponse // Final|Native|Private // @ game+0x172e350
};
...
struct AStoryService : AActor {
	...
	void OnRep_ActiveStories(); // Function StoryFramework.StoryService.OnRep_ActiveStories // Final|Native|Private // @ game+0x374e670
};
