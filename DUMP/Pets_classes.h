...
// Size: 0xa58 (Inherited: 0x970)
struct APetAIController : AAthenaAIController {
	char UnknownData_970[0x20]; // 0x970(0x20)
	struct TArray<struct FAIStategyControllerMovementMod> StrategyControllerMovementMods; // 0x990(0x10)
	float DefaultControlRotationInterpSpeed; // 0x9a0(0x04)
	char UnknownData_9A4[0x4]; // 0x9a4(0x04)
	struct UClass* DefaultStrategy; // 0x9a8(0x08)
	struct UReactStateMappingsDataAsset* ReactMappings; // 0x9b0(0x08)
	char UnknownData_9B8[0x8]; // 0x9b8(0x08)
	struct UPetHangoutSpotSelectorComponent* HangoutSpotSelectorComponent; // 0x9c0(0x08)
	struct UPetHangoutSpotComponent* ForcedHangoutSpotComponent; // 0x9c8(0x08)
	struct UBlackboardData* DefaultBlackboardAsset; // 0x9d0(0x08)
	struct UBehaviorTree* DefaultTree; // 0x9d8(0x08)
	struct UBehaviorTree* HangoutTree; // 0x9e0(0x08)
	struct UBehaviorTree* IdleTree; // 0x9e8(0x08)
	float MaximumReactRange; // 0x9f0(0x04)
	char UnknownData_9F4[0x4]; // 0x9f4(0x04)
	struct UPetDangerComponent* DangerComponent; // 0x9f8(0x08)
	float MinAgentHalfHeightPctOverride; // 0xa00(0x04)
	char UnknownData_A04[0x54]; // 0xa04(0x54)

	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function Pets.PetAIController.OnPerceptionUpdated // Native|Public // @ game+0x467e1a0
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function Pets.PetAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x467e090
};
...
struct UPetHangoutSpotComponent : USceneComponent {
	...
	void OnRep_IsOwnerSinking(); // Function Pets.PetHangoutSpotComponent.OnRep_IsOwnerSinking // Final|Native|Private // @ game+0x467e360
};
...
struct APetItemInfo : ANonStorableItemInfo {
	...
	struct AActor* SpawnedForShip; // 0x550(0x08)
	float DropTraceDistance; // 0x558(0x04)
	float PointSearchRadius; // 0x55c(0x04)
	char DropChannel; // 0x560(0x01)
	char UnknownData_561[0x7]; // 0x561(0x07)
	struct AActor* PetOwner; // 0x568(0x08)
	struct FPetCustomisation PetCustomisation; // 0x570(0x28)
	struct UPetUGCNameComponent* PetUGCNameComponent; // 0x598(0x08)
	char UnknownData_5A0[0x10]; // 0x5a0(0x10)

	void OnRep_PetOwner(); // Function Pets.PetItemInfo.OnRep_PetOwner // Final|Native|Private // @ game+0x467e420
};
...
struct UPetOwnerComponent : UActorComponent {
	...
	void Server_RequestDismissal(); // Function Pets.PetOwnerComponent.Server_RequestDismissal // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x467e5b0
};
...
struct UPetPerchComponent : UInteractableComponent {
	...
	struct TArray<struct UClass*> AllowedPetTypes; // 0x150(0x10)
	int32_t HangoutSpotIndex; // 0x160(0x04)
	struct FName HangoutSpotName; // 0x164(0x08)
	struct FVector InteractionPointLocation; // 0x16c(0x0c)
	bool Enabled; // 0x178(0x01)
	bool BlocksPetEmoteReactions; // 0x179(0x01)
	bool IgnorePickupFromHangoutTooltipDisplayOffset; // 0x17a(0x01)
...
struct UPetsService : UObject {
	...
	void RemovePetFromActor(struct AActor* InOwner); // Function Pets.PetsService.RemovePetFromActor // Final|Native|Public|BlueprintCallable // @ game+0x467e520
	void AddPetForActorAndWield(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner, bool IsWielded); // Function Pets.PetsService.AddPetForActorAndWield // Native|Public|BlueprintCallable // @ game+0x467def0
	void AddPetForActor(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner); // Function Pets.PetsService.AddPetForActor // Final|Native|Public|BlueprintCallable // @ game+0x467dd80
};
...
struct UPetUGCNameComponent : UActorComponent {
	...
	char UnknownData_F0[0x78]; // 0xf0(0x78)
};
...
struct AWieldablePet : ASkeletalMeshWieldableItem {
	...
	void OnRep_HungerReactAnimationState(); // Function Pets.WieldablePet.OnRep_HungerReactAnimationState // Final|Native|Private // @ game+0x467e320
	void OnRep_DropRequest(char PriorDropRequest); // Function Pets.WieldablePet.OnRep_DropRequest // Final|Native|Private // @ game+0x467e2a0
};
