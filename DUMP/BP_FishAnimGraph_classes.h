...
struct UBP_FishAnimGraph_C : UFishAnimationInstance {
	...
	void AnimNotify_StartJump(); // Function BP_FishAnimGraph.BP_FishAnimGraph_C.AnimNotify_StartJump // BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void AnimNotify_EndJump(); // Function BP_FishAnimGraph.BP_FishAnimGraph_C.AnimNotify_EndJump // BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_FishAnimGraph(int32_t EntryPoint); // Function BP_FishAnimGraph.BP_FishAnimGraph_C.ExecuteUbergraph_BP_FishAnimGraph //  // @ game+0x190d0a0
};
