...
struct UMusicZoneInterface : UEmitterManipulatorInterface {
	...
	bool CanPlayForPlayer(struct AActor* Player); // Function Music.MusicZoneInterface.CanPlayForPlayer // RequiredAPI|Native|Event|Public|BlueprintEvent|Const // @ game+0x3c6c6e0
};
...
struct UMusicZoneComponent : USceneComponent {
	...
	bool SetPlaybackPositionRtpc(float OutTimeInSeconds); // Function Music.MusicZoneComponent.SetPlaybackPositionRtpc // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x3c6c920
	void OnRep_EmitterRemoteValues(); // Function Music.MusicZoneComponent.OnRep_EmitterRemoteValues // Final|Native|Private // @ game+0x3c6c8e0
	struct FWwiseEmitter GetEmitter(); // Function Music.MusicZoneComponent.GetEmitter // Native|Public|BlueprintCallable // @ game+0x3c6c860
	void DisableZone(); // Function Music.MusicZoneComponent.DisableZone // Final|Native|Public|BlueprintCallable // @ game+0x3c6c840
	void Client_StopMusicAndDisableZone(); // Function Music.MusicZoneComponent.Client_StopMusicAndDisableZone // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3c6c820
	void Client_PlayOneShot(int32_t Index); // Function Music.MusicZoneComponent.Client_PlayOneShot // Net|NetReliableNative|Event|NetMulticast|Public|BlueprintCallable // @ game+0x3c6c7a0
	void Client_ActivateZone(); // Function Music.MusicZoneComponent.Client_ActivateZone // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3c6c780
	void ActivateZone(); // Function Music.MusicZoneComponent.ActivateZone // Final|Native|Public|BlueprintCallable // @ game+0x3c6c6c0
};
...
struct UAISpawnerMusicZoneComponent : UMusicZoneComponent {
	...
	void OnRep_SpawnerState(); // Function Music.AISpawnerMusicZoneComponent.OnRep_SpawnerState // Final|Native|Private // @ game+0x3c6c900
};
