...
struct ACommodityDemandService : AActor {
	...
	void OnRep_ActiveCommodityDemands(); // Function CommodityDemandFramework.CommodityDemandService.OnRep_ActiveCommodityDemands // Final|RequiredAPI|Native|Private // @ game+0x42b6e40
};
