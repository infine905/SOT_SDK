...
struct UAbandonedNoteWeightedTextSourceComponent : UActorComponent {
	...
	void OnRep_TitleText(); // Function Mysteries.AbandonedNoteWeightedTextSourceComponent.OnRep_TitleText // Final|Native|Private // @ game+0x471b6f0
	void OnRep_ClueText(); // Function Mysteries.AbandonedNoteWeightedTextSourceComponent.OnRep_ClueText // Final|Native|Private // @ game+0x471b620
};
...
struct ASirenPuzzleContext : AActor {
	...
	void Unlock(struct FGuid LockId, struct FGuid CrewId); // Function Mysteries.SirenPuzzleContext.Unlock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x471b730
	void ResetUnlock(); // Function Mysteries.SirenPuzzleContext.ResetUnlock // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x471b710
	void OnRep_LockStates(struct TArray<char> OldStates); // Function Mysteries.SirenPuzzleContext.OnRep_LockStates // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x471b640
	void DeactivateLock(struct FGuid LockId); // Function Mysteries.SirenPuzzleContext.DeactivateLock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x471b580
	void ActivateLock(struct FGuid LockId); // Function Mysteries.SirenPuzzleContext.ActivateLock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x471b4e0
};
