...
struct UOceanCrawlerAnimationInstance : UAnimInstance {
	...
	void ClearActiveAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.ClearActiveAttack // Final|Native|Public|BlueprintCallable // @ game+0x15b37b0
	void BeginNewAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.BeginNewAttack // Final|Native|Public|BlueprintCallable // @ game+0x15b3790
};
