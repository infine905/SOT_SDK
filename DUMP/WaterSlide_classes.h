...
struct AWaterSlide : ARide {
	...
	void SetEntranceCollisionComponent(struct UPrimitiveComponent* InEntranceCollisionComponent); // Function WaterSlide.WaterSlide.SetEntranceCollisionComponent // Final|Native|Protected|BlueprintCallable // @ game+0x47a21c0
	void ComponentBeginOverlapCallBack(struct AActor* InOtherActor, struct UPrimitiveComponent* InOtherComp, int32_t InOtherBodyIndex, bool InFromSweep, struct FHitResult InSweepResult); // Function WaterSlide.WaterSlide.ComponentBeginOverlapCallBack // Final|Native|Private|HasOutParms // @ game+0x47a1ff0
};

// Class WaterSlide.Zipline
// Size: 0x768 (Inherited: 0x3e0)
struct AZipline : ARide {
	...
	float AttachPointSize; // 0x700(0x04)
	struct FVector2D ForwardsAttachDetachOffsets; // 0x704(0x08)
	struct FVector2D BackwardsAttachDetachOffsets; // 0x70c(0x08)
	char UnknownData_714[0x2c]; // 0x714(0x2c)
	struct UStaticMesh* ZiplineGeometry; // 0x740(0x08)
	struct UStaticMesh* ZiplineTrolleyGeometry; // 0x748(0x08)
	struct UMaterialInterface* ZiplineGeometryMaterialOverride; // 0x750(0x08)
	struct FName ZiplineGeometryMaterialScalerParameterName; // 0x758(0x08)
	char UnknownData_760[0x8]; // 0x760(0x08)
};

// Class WaterSlide.InteractableZipline
// Size: 0x798 (Inherited: 0x768)
struct AInteractableZipline : AZipline {
	struct UInteractableComponentWithActionRules* ZiplineStartInteractionPoint; // 0x768(0x08)
	struct UInteractableComponentWithActionRules* ZiplineEndInteractionPoint; // 0x770(0x08)
	struct UClass* PressedNotificationInputId; // 0x778(0x08)
	struct UClass* ReleasedNotificationInputId; // 0x780(0x08)
	struct FVector2D AttachPointLocationOffset; // 0x788(0x08)
	float HoldTime; // 0x790(0x04)
...
struct UZiplineFXParams : UDataAsset {
	...
	struct UWwiseEvent* AttachToZiplineAdditiveOneShotSFX; // 0x30(0x08)
	struct UWwiseEvent* DetachFromZiplineAdditiveOneShotSFX; // 0x38(0x08)
	struct UWwiseEvent* ZiplineLoopStartSFX; // 0x40(0x08)
	struct UWwiseEvent* ZiplineEndSFX; // 0x48(0x08)
	struct UWwiseEvent* ZiplineLoopEndSFX; // 0x50(0x08)
	struct FName PlayerSpeedOnZiplineRTPC; // 0x58(0x08)
	struct UParticleSystem* PlayerZiplineWindVFX; // 0x60(0x08)
	struct UParticleSystem* PlayerZiplineTrailVFX; // 0x68(0x08)
	struct FVector2D SpawnParticleSpeedThreshold; // 0x70(0x08)
};
