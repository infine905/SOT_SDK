...
struct UAbandonedNoteClueDestinationContainerComponent : UActorComponent {
	...
	void OnRep_CurrentTitleText(); // Function LostShipmentsClueVariants.AbandonedNoteClueDestinationContainerComponent.OnRep_CurrentTitleText // Final|Native|Private // @ game+0x156fa30
	void OnRep_CurrentClueDestination(); // Function LostShipmentsClueVariants.AbandonedNoteClueDestinationContainerComponent.OnRep_CurrentClueDestination // Final|Native|Private // @ game+0x156fa10
};
...
struct AClueSiteCircleMapWieldable : ARenderToTextureMapBase {
	...
	void OnRep_MapRadialIconData(); // Function LostShipmentsClueVariants.ClueSiteCircleMapWieldable.OnRep_MapRadialIconData // Final|Native|Private // @ game+0x156fa70
};
...
struct UClueVariantsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void GiveClueDescriptorToItem(struct AItemInfo* ItemInfo, struct UClueDescriptor* Clue); // Function LostShipmentsClueVariants.ClueVariantsBlueprintFunctionLibrary.GiveClueDescriptorToItem // Final|Native|Static|Public|BlueprintCallable // @ game+0x156f960
};
...
struct UCompositeClueDestinationDescriptor : UClueDestinationDescriptor {
	...
	void OnRep_DestinationInfo(); // Function LostShipmentsClueVariants.CompositeClueDestinationDescriptor.OnRep_DestinationInfo // Final|Native|Private // @ game+0x156fa50
};
...
struct UGooseChaseClueBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct UClueDescriptor* CreateEndOfGooseChaseClue(); // Function LostShipmentsClueVariants.GooseChaseClueBlueprintFunctionLibrary.CreateEndOfGooseChaseClue // Final|Native|Static|Public|BlueprintCallable // @ game+0x156f900
};
...
struct UTaleQuestClueInventoryService : UTaleQuestService {
	...
	void SetClueTitleText(struct FText InTitleText); // Function LostShipmentsClueVariants.TaleQuestClueInventoryService.SetClueTitleText // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x156fa90
	int32_t GetCollectedClueCount(); // Function LostShipmentsClueVariants.TaleQuestClueInventoryService.GetCollectedClueCount // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x156f930
};
