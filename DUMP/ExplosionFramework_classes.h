...
struct UFuseInterface : UInterface {
	...
	bool GetIsActive(); // Function ExplosionFramework.FuseInterface.GetIsActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x43b8a40
};
...
struct UTaleQuestFuseFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void TriggerFuse(struct AActor* InFuseActor); // Function ExplosionFramework.TaleQuestFuseFunctionLibrary.TriggerFuse // Final|Native|Static|Public // @ game+0x43b8a70
};
