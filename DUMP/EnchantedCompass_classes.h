...
struct ARotatingCompass : AEnchantedCompass {
	...
	void OnRep_StartRotationSequenceCurve(); // Function EnchantedCompass.RotatingCompass.OnRep_StartRotationSequenceCurve // Final|RequiredAPI|Native|Private // @ game+0x44e0900
	void OnRep_RotationSequenceCurve(); // Function EnchantedCompass.RotatingCompass.OnRep_RotationSequenceCurve // Final|RequiredAPI|Native|Private // @ game+0x44e08e0
};
...
struct APrototypeMultiTargetEnchantedCompass : AMultiTargetEnchantedCompass {
	...
	float GetFloatMax(); // Function EnchantedCompass.PrototypeMultiTargetEnchantedCompass.GetFloatMax // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x44e08b0
	float CalculateDesiredYaw(struct FRotator CompassRotation); // Function EnchantedCompass.PrototypeMultiTargetEnchantedCompass.CalculateDesiredYaw // Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const // @ game+0x190d0a0
	struct TArray<struct FVector> BP_GetTargetLocations(); // Function EnchantedCompass.PrototypeMultiTargetEnchantedCompass.BP_GetTargetLocations // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x44e0800
};
...
struct UTaleQuestRotatingCompassFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void WaitForRotatingCompassPickup(struct AActor* CurrentRotatingCompassWielder); // Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.WaitForRotatingCompassPickup // Final|RequiredAPI|Native|Public|HasOutParms // @ game+0x44e0b80
	void WaitForRotatingCompassDestroyed(struct AActor* InRotatingCompass); // Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.WaitForRotatingCompassDestroyed // Final|RequiredAPI|Native|Public // @ game+0x44e0b00
	void UpdateRotatingCompassSplinePath(struct AActor* InRotatingCompass); // Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.UpdateRotatingCompassSplinePath // Final|RequiredAPI|Native|Public // @ game+0x44e0a80
	void SetRotatingCompassCurveAndWaitForCompletion(struct UCurveFloat* RotationSequenceCurve); // Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.SetRotatingCompassCurveAndWaitForCompletion // Final|RequiredAPI|Native|Public // @ game+0x44e0a00
	void SetRotatingCompass(struct AActor* InRotatingCompass, struct AActor* InPickerUpper); // Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.SetRotatingCompass // Final|RequiredAPI|Native|Public // @ game+0x44e0940
};
