...
struct UAIShipContextDescDataAsset : UDataAsset {
	...
	struct UClass* EventType; // 0x30(0x08)
	struct UShipDescAsset* ShipDesc; // 0x38(0x08)
	struct UAthenaAIShipControllerParamsDataAsset* ControllerParams; // 0x40(0x08)
	struct TArray<struct FAIShipEncounterParamsSpawnerData> Spawners; // 0x48(0x10)
	struct FAIShipContextDescDamageParams DamageParams; // 0x58(0x14)
	struct FAIShipSailData SailsCustomisation; // 0x6c(0x10)
	struct FColor SailColour; // 0x7c(0x04)
	struct FAIShipCrewFormType FormType; // 0x80(0x20)
	struct FAIShipCrewAmmoType AmmoType; // 0xa0(0x18)
	struct UShortRangeMarkerDataAsset* RewardMarkerParams; // 0xb8(0x08)
};
...
struct UAIShipEncounterParamsDataAsset : UDataAsset {
	...
	float OuterRadiusMultiplier; // 0x5c(0x04)
	float MigrationRadiusMultiplier; // 0x60(0x04)
	float InitialEncounterEntryDelay; // 0x64(0x04)
	float MinEngagedDistanceFromPlayers; // 0x68(0x04)
	bool EnableMusicWhenShipsHaveNoTarget; // 0x6c(0x01)
	char UnknownData_6D[0x3]; // 0x6d(0x03)
	int32_t SecondsUntilEncounterEndsAfterLastCrewLeft; // 0x70(0x04)
	int32_t MaximumEncounterDuration; // 0x74(0x04)
};

// Class AIShips.AIShipServiceDataAsset
// Size: 0x258 (Inherited: 0x28)
struct UAIShipServiceDataAsset : UDataAsset {
	struct TArray<struct FEventTypeAIShipEncounterParams> BattleEncounterParams; // 0x28(0x10)
	struct FAIShipEncounterParams AggressiveEncounterParams; // 0x38(0x18)
	struct FAIShipEncounterParams PassiveEncounterParams; // 0x50(0x18)
	struct FIntPoint ObstacleBucketDimensions; // 0x68(0x08)
	float ShipwreckObstacleRadius; // 0x70(0x04)
	char UnknownData_74[0x4]; // 0x74(0x04)
	struct FAIShipContextDescGenerationParams ContextDescGenerationParams; // 0x78(0x80)
	struct FAIShipBattleEncounterDescGenerationParams EncounterGenerationParams; // 0xf8(0x80)
	struct FAIShipSingleWaveEncounterDescGenerationParams AggressiveEncounterGenerationParams; // 0x178(0x10)
	struct FAIShipSingleWaveEncounterDescGenerationParams PassiveEncounterGenerationParams; // 0x188(0x10)
	struct FWeightedProbabilityRangeOfRanges TimerBattleFirstRegenInterval; // 0x198(0x30)
	struct FWeightedProbabilityRangeOfRanges TimerBattleRegenInterval; // 0x1c8(0x30)
	float TimerBattleFinderThrottle; // 0x1f8(0x04)
	char UnknownData_1FC[0x4]; // 0x1fc(0x04)
	struct FWeightedProbabilityRangeOfRanges TimerBattleRetryRegenInterval; // 0x200(0x30)
	float TimerBattleMinActivationDistanceFromPlayers; // 0x230(0x04)
	char UnknownData_234[0x4]; // 0x234(0x04)
	struct UShortRangeMarkerDataAsset* RewardMarkerParams; // 0x238(0x08)
	struct TArray<struct FName> IslandsToAvoid; // 0x240(0x10)
	float AvoidanceRange; // 0x250(0x04)
...
struct UAIShipDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void RequestAIShipForCrew(struct UObject* WorldContextObject, struct FGuid CrewId); // Function AIShips.AIShipDebugFunctionLibrary.RequestAIShipForCrew // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x4203840
	struct FAIShipEncounterBattleDesc GenerateAIShipBattleDesc(struct UObject* WorldContextObject, struct UAIShipServiceDataAsset* ServiceParams); // Function AIShips.AIShipDebugFunctionLibrary.GenerateAIShipBattleDesc // Final|Native|Static|Public|BlueprintCallable // @ game+0x42036f0
};
...
// Size: 0x28 (Inherited: 0x28)
struct UAIShipsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {

	bool RequestPassiveAIShipForPlayerShip(struct UObject* WorldContext, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4203c90
	bool RequestPassiveAIShipAtLocation(struct UObject* WorldContext, struct FVector Location, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4203b40
	bool RequestAggressiveAIShipForPlayerShip(struct UObject* WorldContext, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4203a50
	bool RequestAggressiveAIShipAtLocation(struct UObject* WorldContext, struct FVector Location, struct AActor* PlayerShip, struct UClass* ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4203900
};
...
// Size: 0x758 (Inherited: 0x3c8)
struct AAIShipService : AActor {
	char UnknownData_3C8[0x10]; // 0x3c8(0x10)
	struct UGameEventOnDemandAvailabilityHandler* GameEventOnDemandAvailabilityHandler; // 0x3d8(0x08)
	struct UGameEventOnDemandAnnouncementComponent* GameEventOnDemandAnnouncementComponent; // 0x3e0(0x08)
	char UnknownData_3E8[0x18]; // 0x3e8(0x18)
	struct UAIShipServiceDataAsset* Params; // 0x400(0x08)
	char UnknownData_408[0x350]; // 0x408(0x350)
};
...
struct AAthenaAIShipController : AAthenaAIControllerBase {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AIShips.AthenaAIShipController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4203620
};
...
struct UBTService_UpdateTargetLocationForPassiveShip : UBTService {
	...
	float AngleOffsetFromForwardDegreesWhenNoIslands; // 0x98(0x04)
	float TargetLocationDistanceWhenNoIslands; // 0x9c(0x04)
...
struct UCursedCrewCustomisationInterface : UInterface {
	...
	void SetCursedCrewCustomisationProperties(struct FAIShipSailData SailData); // Function AIShips.CursedCrewCustomisationInterface.SetCursedCrewCustomisationProperties // Native|Event|Public|HasOutParms|BlueprintEvent // @ game+0x4203d80
};
