...
struct UBP_Seagull_AnimInst_C : UAnimInstance {
	...
	void BlueprintInitializeAnimation(); // Function BP_Seagull_AnimInst.BP_Seagull_AnimInst_C.BlueprintInitializeAnimation // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ExecuteUbergraph_BP_Seagull_AnimInst(int32_t EntryPoint); // Function BP_Seagull_AnimInst.BP_Seagull_AnimInst_C.ExecuteUbergraph_BP_Seagull_AnimInst //  // @ game+0x190d0a0
};
