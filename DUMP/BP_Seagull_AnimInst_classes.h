...
struct UBP_Seagull_AnimInst_C : UAnimInstance {
	...
	void BlueprintInitializeAnimation(); // Function BP_Seagull_AnimInst.BP_Seagull_AnimInst_C.BlueprintInitializeAnimation // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void ExecuteUbergraph_BP_Seagull_AnimInst(int32_t EntryPoint); // Function BP_Seagull_AnimInst.BP_Seagull_AnimInst_C.ExecuteUbergraph_BP_Seagull_AnimInst //  // @ game+0x18f4c40
};
