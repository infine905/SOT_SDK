...
struct ABP_EmissaryTable_Sov_01_a_C : ABP_EmissaryTable_01_C {
	...
	void UserConstructionScript(); // Function BP_EmissaryTable_Sov_01_a.BP_EmissaryTable_Sov_01_a_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
