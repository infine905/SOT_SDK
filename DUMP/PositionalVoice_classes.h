...
struct UVoiceChatEmitterInterface : UInterface {
	...
	struct FVector GetVoiceLocation(); // Function PositionalVoice.VoiceChatEmitterInterface.GetVoiceLocation // Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3a312e0
	void GetVoiceAudioEmitterProxy(struct FWwiseEmitter EmitterProxy); // Function PositionalVoice.VoiceChatEmitterInterface.GetVoiceAudioEmitterProxy // Native|Public|HasOutParms|BlueprintCallable // @ game+0x3a31210
	float GetVoiceAttenuationScaler(TScriptInterface<struct UVoiceChatEmitterInterface> RelativeToThisEmitter); // Function PositionalVoice.VoiceChatEmitterInterface.GetVoiceAttenuationScaler // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x3a31160
};
