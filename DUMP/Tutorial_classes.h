...
struct UCompanyTutorialVoyageProgress : UObject {
	...
	bool IsSameVoyage(struct FText VoyageName); // Function Tutorial.CompanyTutorialVoyageProgress.IsSameVoyage // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x42981b0
	void AssignVoyage(struct UClass* VoyageProposalDescClass, struct UClass* TaleRankDescClass); // Function Tutorial.CompanyTutorialVoyageProgress.AssignVoyage // Final|Native|Public|BlueprintCallable // @ game+0x4297e80
};
...
struct UTutorial2019Component : UActorComponent {
	...
	void ReceiveTutorial2019BeginPlayOnServer(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnServer // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void ReceiveTutorial2019BeginPlayOnClient(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnClient // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void OnRep_IsEnabledByServer(bool OldIsEnabled); // Function Tutorial.Tutorial2019Component.OnRep_IsEnabledByServer // Final|Native|Private // @ game+0x4298270
	void ForceDisableComponent_Blueprint(); // Function Tutorial.Tutorial2019Component.ForceDisableComponent_Blueprint // Event|Public|BlueprintEvent // @ game+0x190d0a0
	void BeginOnServer(); // Function Tutorial.Tutorial2019Component.BeginOnServer // Final|Native|Public|BlueprintCallable // @ game+0x4297f40
};
...
struct UTutorial2019FunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct FTeleportLocation GetNearestOnboardingSpawnPoint(struct AActor* CharacterToTeleport); // Function Tutorial.Tutorial2019FunctionLibrary.GetNearestOnboardingSpawnPoint // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4298010
};
...
struct UTutorialHelpersBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void FirePromptCompleted(struct UClass* AccessKey, struct UObject* WorldContextObject); // Function Tutorial.TutorialHelpersBlueprintLibrary.FirePromptCompleted // Final|Native|Static|Public|BlueprintCallable // @ game+0x4297f60
};
...
struct UTutorialManager : UActorComponent {
	...
	struct UClass* IntroductionToSOTFlowStarterClass; // 0xe8(0x08)
	struct UClass* CaptaincyStarterClass; // 0xf0(0x08)
	struct UClass* CaptaincyNewShipStarterClass; // 0xf8(0x08)
	struct UClass* CaptaincyWithBeachNPCSpawnStarterClass; // 0x100(0x08)
	struct UClass* SelectedTutorialClass; // 0x108(0x08)
	struct UTutorialStarter* SelectedTutorial; // 0x110(0x08)
	char TutorialType; // 0x118(0x01)
	bool HasEverPlayedFirstPersonAnimation; // 0x119(0x01)
	bool HasStartedTutorial; // 0x11a(0x01)
	bool HasReceivedEntitlements; // 0x11b(0x01)
	bool HasPosessedPawn; // 0x11c(0x01)
	bool HasPlayerFinshedSpawning; // 0x11d(0x01)
	bool IsPlayerWaitingForCaptaincySessionResponse; // 0x11e(0x01)
	bool HasPlayerPromptsServiceSetup; // 0x11f(0x01)
	char UnknownData_120[0x20]; // 0x120(0x20)

	void OnRep_TutorialType(); // Function Tutorial.TutorialManager.OnRep_TutorialType // Final|Native|Private // @ game+0x4298320
	void OnRep_SelectedTutorialClass(); // Function Tutorial.TutorialManager.OnRep_SelectedTutorialClass // Final|Native|Private // @ game+0x4298300
	char GetTutorialType(); // Function Tutorial.TutorialManager.GetTutorialType // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4298140
};
...
struct UCompanyOnboardingStarter : UTutorialStarter {
	...
	bool HasPrerequisites(); // Function Tutorial.CompanyOnboardingStarter.HasPrerequisites // Native|Event|Protected|BlueprintEvent // @ game+0x4298180
};

// Class Tutorial.IntroductionToSOTFlowStarter
// Size: 0xd8 (Inherited: 0x60)
struct UIntroductionToSOTFlowStarter : UTutorialStarter {
	struct UVoyageDescDataAsset* TutorialTale; // 0x60(0x08)
	struct TArray<struct FIntroductionToSOTIntroAnimatic> ShipSizeBasedIntroAnimatics; // 0x68(0x10)
