...
struct UCompanyTutorialVoyageProgress : UObject {
	...
	bool IsSameVoyage(struct FText VoyageName); // Function Tutorial.CompanyTutorialVoyageProgress.IsSameVoyage // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x426dee0
	void AssignVoyage(struct UClass* VoyageProposalDescClass, struct UClass* TaleRankDescClass); // Function Tutorial.CompanyTutorialVoyageProgress.AssignVoyage // Final|Native|Public|BlueprintCallable // @ game+0x426dbf0
};
...
struct UTutorial2019Component : UActorComponent {
	...
	void ReceiveTutorial2019BeginPlayOnServer(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnServer // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void ReceiveTutorial2019BeginPlayOnClient(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnClient // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void OnRep_IsEnabledByServer(bool OldIsEnabled); // Function Tutorial.Tutorial2019Component.OnRep_IsEnabledByServer // Final|Native|Private // @ game+0x426dfa0
	void ForceDisableComponent_Blueprint(); // Function Tutorial.Tutorial2019Component.ForceDisableComponent_Blueprint // Event|Public|BlueprintEvent // @ game+0x18f4c40
	void BeginOnServer(); // Function Tutorial.Tutorial2019Component.BeginOnServer // Final|Native|Public|BlueprintCallable // @ game+0x426dcb0
};
...
struct UTutorial2019FunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct FTeleportLocation GetNearestOnboardingSpawnPoint(struct AActor* CharacterToTeleport); // Function Tutorial.Tutorial2019FunctionLibrary.GetNearestOnboardingSpawnPoint // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x426dd80
};
...
struct UTutorialHelpersBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void FirePromptCompleted(struct UClass* AccessKey, struct UObject* WorldContextObject); // Function Tutorial.TutorialHelpersBlueprintLibrary.FirePromptCompleted // Final|Native|Static|Public|BlueprintCallable // @ game+0x426dcd0
};
...
struct UTutorialManager : UActorComponent {
	...
	void OnRep_TutorialType(); // Function Tutorial.TutorialManager.OnRep_TutorialType // Final|Native|Private // @ game+0x426e050
	void OnRep_SelectedTutorialClass(); // Function Tutorial.TutorialManager.OnRep_SelectedTutorialClass // Final|Native|Private // @ game+0x426e030
};
...
struct UCompanyOnboardingStarter : UTutorialStarter {
	...
	bool HasPrerequisites(); // Function Tutorial.CompanyOnboardingStarter.HasPrerequisites // Native|Event|Protected|BlueprintEvent // @ game+0x426deb0
};
