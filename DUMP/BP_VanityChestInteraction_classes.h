...
struct ABP_VanityChestInteraction_C : AClothingChestInteraction {
	...
	void UserConstructionScript(); // Function BP_VanityChestInteraction.BP_VanityChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18f4c40
};
