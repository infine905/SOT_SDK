...
struct ABP_ShipPetChest_C : APossessionsChest {
	...
	void UserConstructionScript(); // Function BP_ShipPetChest.BP_ShipPetChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
