...
struct UDamageablePartsInterface : UInterface {
	...
	void UnregisterDamageablePart(struct AActor* DamageableActor); // Function ShipDamage.DamageablePartsInterface.UnregisterDamageablePart // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4384ec0
	void RegisterDamageablePart(struct AActor* DamageableActor); // Function ShipDamage.DamageablePartsInterface.RegisterDamageablePart // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4384db0
	struct TArray<struct AActor*> GetDamageableParts(); // Function ShipDamage.DamageablePartsInterface.GetDamageableParts // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4384b80
};
