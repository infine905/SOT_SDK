...
struct UOceanCrawlerAudioBroadcaster : UActorComponent {
	...
	void Multicast_PlayBuffAudio(struct FEventOceanCrawlerAIBuffAudioRequest InRequest); // Function OceanCrawlers.OceanCrawlerAudioBroadcaster.Multicast_PlayBuffAudio // Final|Net|Native|Event|NetMulticast|Private // @ game+0x15adbd0
	void Multicast_PlayAudio(char InAudioKey, float InAudioDelay); // Function OceanCrawlers.OceanCrawlerAudioBroadcaster.Multicast_PlayAudio // Final|Net|Native|Event|NetMulticast|Private // @ game+0x15adb10
};
