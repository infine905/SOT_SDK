...
struct ABP_FishingFloat_C : AFishingFloat {
	...
	void UserConstructionScript(); // Function BP_FishingFloat.BP_FishingFloat_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x190d0a0
};
